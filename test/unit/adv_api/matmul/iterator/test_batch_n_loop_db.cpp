...
private:
    ...
    constexpr MatmulConfig static CFG_NORM_OUTER_PRODUCT = GetNormalConfig(false, false, false, BatchMode::BATCH_LESS_THAN_L1,
        true, IterateOrder::ORDER_N, ScheduleType::OUTER_PRODUCT);
