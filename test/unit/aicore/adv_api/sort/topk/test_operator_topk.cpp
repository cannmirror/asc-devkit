...
bool TopKTilingFunc(const int32_t inner, const int32_t outter, const int32_t k, const uint32_t dataTypeSize,
    const bool isInitIndex, enum TopKMode topkMode, TopkTiling& topKTiling, const bool isLargest = false)
{
    if (dataTypeSize == 0) {
        return false;
    }
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        TopK<T, isInitIndex, isHasfinish, isReuseSrc, topkMode>(dstLocalValue, dstLocalIndex, srcLocalValue,
            srcLocalIndex, srcLocalFinish, k, topKTiling, topKInfo, isLargest);
...
INSTANTIATE_TEST_CASE_P(TEST_PACKAGE_TopK, TopKTestSuite,
    ::testing::Values(TopKTestParams{1, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
                          main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{5, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{8, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{16, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{31, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{32, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{5, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{8, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 1>},
        TopKTestParams{5, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
        ...
        TopKTestParams{8, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, true, false, 1>},
        TopKTestParams{16, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, true, false, 1>},
        TopKTestParams{5, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, true, 1>},
        TopKTestParams{8, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
        ...
        TopKTestParams{16, {4, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, true, 1>},
        TopKTestParams{1, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
        ...
        TopKTestParams{32, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{8, {1, 32, 8}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{8, {1, 32, 16}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{8, {1, 32, 32}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{64, {1, 64, 64}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{64, {1, 96, 96}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{64, {1, 128, 128}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{64, {1, 160, 160}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{64, {1, 192, 192}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>},
        TopKTestParams{64, {1, 2048, 2048}, sizeof(half), sizeof(int32_t), true,
            main_TopK_test<half, int32_t, false, false, false, false, 0>}));
