...
public:
    ...
    __aicore__ inline void Init(GM_ADDR srcGmValue, GM_ADDR srcGmIndex, GM_ADDR finishGm, GM_ADDR dstGmValue,
        GM_ADDR dstGmIndex, int32_t kGm, uint32_t outter, uint32_t inner, int32_t n, bool isLargestGm)
    {
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::TopK<T, isInitIndex, false, isReuseSrc, topkMode, config>(dstValueLocal, dstIndexLocal, srcValueLocal,
            srcIndexLocal, srcFinishLocal, tmp, k, tiling, topKInfo, isLargest);
    ...
    __aicore__ inline void CopyOut()
    {
        ...
        for (int32_t i = count - remainIdx; i < count; i++) { dstIndexGlobal.SetValue(i, dstIndexLocal.GetValue(i)); }
...
template <typename T, bool isInitIndex, bool isHasfinish, bool isReuseSrc, AscendC::TopKMode topkMode,
    ...
    GM_ADDR dstGmIndex, int32_t kGm, AscendC::TopKInfo tkInfo, bool isLargest)
{
    ...
    op.Init(srcGmValue, srcGmIndex, finishGm, dstGmValue, dstGmIndex, kGm, tkInfo.outter, tkInfo.inner, tkInfo.n,
        isLargest);
    op.Process();
}
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_ADVANCE_API_TOPK, AdvanceTopKTestSuite,
    ::testing::Values(
        // uint8_t
        TopKTestParams{1, GetKPad<uint8_t>(1), {1, 32, 32}, sizeof(uint8_t), true,
            testRadixTopK<uint8_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<uint8_t>(2), {2, 32, 32}, sizeof(uint8_t), true,
            testRadixTopK<uint8_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<uint8_t>(20), {1, 128, 128}, sizeof(uint8_t), true,
            testRadixTopK<uint8_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{2, GetKPad<uint8_t>(2), {2, 256, 256}, sizeof(uint8_t), true,
            testRadixTopK<uint8_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{20, GetKPad<uint8_t>(20), {2, 512, 512}, sizeof(uint8_t), true,
            testRadixTopK<uint8_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{2, GetKPad<uint8_t>(2), {2, 1024, 1024}, sizeof(uint8_t), true,
            testRadixTopK<uint8_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // int8_t
        TopKTestParams{1, GetKPad<int8_t>(1), {1, 32, 32}, sizeof(int8_t), true,
            testRadixTopK<int8_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<int8_t>(2), {2, 32, 32}, sizeof(int8_t), true,
            testRadixTopK<int8_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<int8_t>(20), {1, 128, 128}, sizeof(int8_t), true,
            testRadixTopK<int8_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{255, GetKPad<int8_t>(255), {2, 256, 256}, sizeof(int8_t), true,
            testRadixTopK<int8_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{512, GetKPad<int8_t>(512), {1, 512, 512}, sizeof(int8_t), true,
            testRadixTopK<int8_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{1, GetKPad<int8_t>(1), {2, 4096, 4096}, sizeof(int8_t), true,
            testRadixTopK<int8_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // uint16_t
        TopKTestParams{1, GetKPad<uint16_t>(1), {1, 32, 32}, sizeof(uint16_t), true,
            testRadixTopK<uint16_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<uint16_t>(2), {2, 32, 32}, sizeof(uint16_t), true,
            testRadixTopK<uint16_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<uint16_t>(20), {1, 128, 128}, sizeof(uint16_t), true,
            testRadixTopK<uint16_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{2, GetKPad<uint16_t>(2), {2, 256, 256}, sizeof(uint16_t), true,
            testRadixTopK<uint16_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{20, GetKPad<uint16_t>(20), {2, 512, 512}, sizeof(uint16_t), true,
            testRadixTopK<uint16_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{2, GetKPad<uint16_t>(2), {2, 1024, 1024}, sizeof(uint16_t), true,
            testRadixTopK<uint16_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // int16_t
        TopKTestParams{1, GetKPad<int16_t>(1), {1, 32, 32}, sizeof(int16_t), true,
            testRadixTopK<int16_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<int16_t>(2), {2, 32, 32}, sizeof(int16_t), true,
            testRadixTopK<int16_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<int16_t>(20), {1, 128, 128}, sizeof(int16_t), true,
            testRadixTopK<int16_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{255, GetKPad<int16_t>(255), {2, 256, 256}, sizeof(int16_t), true,
            testRadixTopK<int16_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{512, GetKPad<int16_t>(512), {1, 512, 512}, sizeof(int16_t), true,
            testRadixTopK<int16_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{1, GetKPad<int16_t>(1), {2, 4096, 4096}, sizeof(int16_t), true,
            testRadixTopK<int16_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // uint32_t
        TopKTestParams{1, GetKPad<uint32_t>(1), {1, 32, 32}, sizeof(uint32_t), true,
            testRadixTopK<uint32_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<uint32_t>(2), {2, 32, 32}, sizeof(uint32_t), true,
            testRadixTopK<uint32_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<uint32_t>(20), {1, 128, 128}, sizeof(uint32_t), true,
            testRadixTopK<uint32_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{2, GetKPad<uint32_t>(2), {2, 256, 256}, sizeof(uint32_t), true,
            testRadixTopK<uint32_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{20, GetKPad<uint32_t>(20), {2, 512, 512}, sizeof(uint32_t), true,
            testRadixTopK<uint32_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{2, GetKPad<uint32_t>(2), {2, 1024, 1024}, sizeof(uint32_t), true,
            testRadixTopK<uint32_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // int32_t
        TopKTestParams{1, GetKPad<int32_t>(1), {1, 32, 32}, sizeof(int32_t), true,
            testRadixTopK<int32_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<int32_t>(2), {2, 32, 32}, sizeof(int32_t), true,
            testRadixTopK<int32_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<int32_t>(20), {1, 128, 128}, sizeof(int32_t), true,
            testRadixTopK<int32_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{255, GetKPad<int32_t>(255), {2, 256, 256}, sizeof(int32_t), true,
            testRadixTopK<int32_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{512, GetKPad<int32_t>(512), {1, 512, 512}, sizeof(int32_t), true,
            testRadixTopK<int32_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{1, GetKPad<int32_t>(1), {2, 4096, 4096}, sizeof(int32_t), true,
            testRadixTopK<int32_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // uint64_t
        TopKTestParams{1, GetKPad<uint64_t>(1), {1, 32, 32}, sizeof(uint64_t), true,
            testRadixTopK<uint64_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<uint64_t>(2), {2, 32, 32}, sizeof(uint64_t), true,
            testRadixTopK<uint64_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<uint64_t>(20), {1, 128, 128}, sizeof(uint64_t), true,
            testRadixTopK<uint64_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{2, GetKPad<uint64_t>(2), {2, 256, 256}, sizeof(uint64_t), true,
            testRadixTopK<uint64_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{20, GetKPad<uint64_t>(20), {2, 512, 512}, sizeof(uint64_t), true,
            testRadixTopK<uint64_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{2, GetKPad<uint64_t>(2), {2, 1024, 1024}, sizeof(uint64_t), true,
            testRadixTopK<uint64_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // int64_t
        TopKTestParams{1, GetKPad<int64_t>(1), {1, 32, 32}, sizeof(int64_t), true,
            testRadixTopK<int64_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<int64_t>(2), {2, 32, 32}, sizeof(int64_t), true,
            testRadixTopK<int64_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<int64_t>(20), {1, 128, 128}, sizeof(int64_t), true,
            testRadixTopK<int64_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{2, GetKPad<int64_t>(2), {2, 256, 256}, sizeof(int64_t), true,
            testRadixTopK<int64_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{20, GetKPad<int64_t>(20), {2, 512, 512}, sizeof(int64_t), true,
            testRadixTopK<int64_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{2, GetKPad<int64_t>(2), {2, 1024, 1024}, sizeof(int64_t), true,
            testRadixTopK<int64_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // half
        ...
        TopKTestParams{20, GetKPad<half>(20), {1, 128, 128}, sizeof(half), true,
            testRadixTopK<half, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        ...
        TopKTestParams{20, GetKPad<half>(20), {2, 512, 512}, sizeof(half), true,
            testRadixTopK<half, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{2, GetKPad<half>(2), {2, 1024, 1024}, sizeof(half), true,
            testRadixTopK<half, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // float
        TopKTestParams{1, GetKPad<float>(1), {1, 32, 32}, sizeof(float), true,
            testRadixTopK<float, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        ...
        TopKTestParams{20, GetKPad<float>(20), {1, 128, 128}, sizeof(float), true,
            testRadixTopK<float, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{255, GetKPad<float>(255), {2, 256, 256}, sizeof(float), true,
            testRadixTopK<float, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{512, GetKPad<float>(512), {1, 512, 512}, sizeof(float), true,
            testRadixTopK<float, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{1, GetKPad<float>(1), {2, 4096, 4096}, sizeof(float), true,
            testRadixTopK<float, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        // bfloat16_t
        TopKTestParams{1, GetKPad<bfloat16_t>(1), {1, 32, 32}, sizeof(bfloat16_t), true,
            testRadixTopK<bfloat16_t, false, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{2, GetKPad<bfloat16_t>(2), {2, 32, 32}, sizeof(bfloat16_t), true,
            testRadixTopK<bfloat16_t, true, false, false, AscendC::TopKMode::TOPK_NSMALL, AscendC::TopKOrder::UNSET,
                false>},
        TopKTestParams{20, GetKPad<bfloat16_t>(20), {1, 128, 128}, sizeof(bfloat16_t), true,
            testRadixTopK<bfloat16_t, false, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{255, GetKPad<bfloat16_t>(255), {2, 256, 256}, sizeof(bfloat16_t), true,
            testRadixTopK<bfloat16_t, true, true, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::LARGEST,
                false>},
        TopKTestParams{512, GetKPad<bfloat16_t>(512), {1, 512, 512}, sizeof(bfloat16_t), true,
            testRadixTopK<bfloat16_t, false, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>},
        TopKTestParams{1, GetKPad<bfloat16_t>(1), {2, 4096, 4096}, sizeof(bfloat16_t), true,
            testRadixTopK<bfloat16_t, true, false, false, AscendC::TopKMode::TOPK_NORMAL, AscendC::TopKOrder::SMALLEST,
                false>}));
...
TEST_P(AdvanceTopKTestSuite, testRadixTopK)
{
    ...
    for (int32_t i = 0; i < outDataSize; i++) { EXPECT_EQ(outputGmValue[i], 0x00); }
}
