...
void MainVecSelectWithBytesMaskDemo(__gm__ uint8_t* __restrict__ dstGm, __gm__ uint8_t* __restrict__ selMaskGm,
    __gm__ uint8_t* __restrict__ srcGm, uint32_t firstAxis, uint32_t srcLastAxis, uint32_t maskLastAxis, bool reverse,
    TestMode testMode)
{
