...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        if constexpr (WithOffset) {
            ...
            AscendAntiQuant<InputDataType, OutputDataType, false>(dstLocal, srcLocal, scaleLocal, sharedTmpBuffer,
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_ANTIQUANT, AntiquantTestsuite,
    ::testing::Values(antiquantParams{2048, 64, 1024, testAntiQuant<int8_t, half>},
