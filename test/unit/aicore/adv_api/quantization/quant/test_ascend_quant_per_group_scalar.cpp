...
public:
    ...
    __aicore__ inline void Init(GM_ADDR src_gm, GM_ADDR dst_gm, GM_ADDR scale_gm, uint32_t m_num, uint32_t n_num,
...
template <typename srcType, typename dstType, typename scaleType, bool has_offset, int kdim, bool has_workspace>
__global__ __aicore__ void Entry(__gm__ uint8_t* srcGm, __gm__ uint8_t* dstGm, __gm__ uint8_t* scaleGm, uint32_t m,
