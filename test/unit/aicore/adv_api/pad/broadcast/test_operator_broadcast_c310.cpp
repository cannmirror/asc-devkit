...
INSTANTIATE_TEST_CASE_P(TEST_Broadcast, BroadcastTestsuite_dim4,
    ::testing::Values(BroadcastTestParams<4>{MainKernelBroadcast<uint8_t, 4>, 1 * 2 * 1 * 2, 2 * 2 * 6 * 2,
                          {1, 2, 1, 2}, {1, 2, 6, 2}},
...
INSTANTIATE_TEST_CASE_P(TEST_Broadcast, BroadcastTestsuite_dim9,
    ::testing::Values(BroadcastTestParams<9>{MainKernelBroadcast<uint8_t, 9>, 2 * 1 * 2 * 1 * 2 * 1 * 2 * 1 * 2,
                          2 * 2 * 2 * 2 * 2 * 2 * 2 * 6 * 2, {2, 1, 2, 1, 2, 1, 2, 1, 2}, {2, 2, 2, 2, 2, 2, 2, 6, 2}},

        BroadcastTestParams<9>{MainKernelBroadcast<uint8_t, 9>, 1 * 2 * 1 * 2 * 1 * 2 * 1 * 2 * 1,
            2 * 2 * 2 * 2 * 2 * 2 * 2 * 2 * 29, {1, 2, 1, 2, 1, 2, 1, 2, 1}, {2, 2, 2, 2, 2, 2, 2, 2, 29}},

        BroadcastTestParams<9>{MainKernelBroadcast<half, 9>, 2 * 1 * 2 * 1 * 2 * 1 * 2 * 1 * 2,
            2 * 2 * 2 * 2 * 2 * 2 * 2 * 15 * 2, {2, 1, 2, 1, 2, 1, 2, 1, 2}, {2, 2, 2, 2, 2, 2, 2, 15, 2}},

        BroadcastTestParams<9>{MainKernelBroadcast<half, 9>, 1 * 2 * 1 * 2 * 1 * 2 * 1 * 2 * 1,
            2 * 2 * 2 * 2 * 2 * 2 * 2 * 2 * 15, {1, 2, 1, 2, 1, 2, 1, 2, 1}, {2, 2, 2, 2, 2, 2, 2, 2, 15}},

        BroadcastTestParams<9>{MainKernelBroadcast<float, 9>, 2 * 1 * 2 * 1 * 2 * 1 * 2 * 1 * 2,
            2 * 2 * 2 * 2 * 2 * 2 * 2 * 7 * 2, {2, 1, 2, 1, 2, 1, 2, 1, 2}, {2, 2, 2, 2, 2, 2, 2, 7, 2}},

        BroadcastTestParams<9>{MainKernelBroadcast<float, 9>, 1 * 2 * 1 * 2 * 1 * 2 * 1 * 8 * 1,
            2 * 2 * 2 * 2 * 2 * 2 * 2 * 8 * 8, {1, 2, 1, 2, 1, 2, 1, 8, 1}, {2, 2, 2, 2, 2, 2, 2, 8, 8}}));
