...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_ADVANCE_API_Isfinite, IsfiniteTestsuite,
    ::testing::Values(IsfiniteParams{RunCase<float, float, 1024, 1024>},
        IsfiniteParams{RunCase<float, float, 1023, 1024>}, IsfiniteParams{RunCase<float, float, 512, 1024>},
        IsfiniteParams{RunCase<float, float, 1, 1024>}, IsfiniteParams{RunCase<bool, float, 1024, 1024>},
        IsfiniteParams{RunCase<bool, float, 1023, 1024>}, IsfiniteParams{RunCase<bool, float, 512, 1024>},
        IsfiniteParams{RunCase<bool, float, 1, 1024>}, IsfiniteParams{RunCase<half, half, 1024, 1024>},
        IsfiniteParams{RunCase<half, half, 1023, 1024>}, IsfiniteParams{RunCase<half, half, 512, 1024>},
        IsfiniteParams{RunCase<half, half, 1, 1024>}, IsfiniteParams{RunCase<bool, half, 1024, 1024>},
        IsfiniteParams{RunCase<bool, half, 1023, 1024>}, IsfiniteParams{RunCase<bool, half, 512, 1024>},
        IsfiniteParams{RunCase<bool, half, 1, 1024>}, IsfiniteParams{RunCase<bfloat16_t, bfloat16_t, 1024, 1024>},
