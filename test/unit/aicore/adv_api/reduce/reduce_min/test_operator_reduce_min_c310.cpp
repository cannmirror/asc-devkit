...
template <typename T, int32_t xExent, int32_t yExent, uint32_t pattern, bool isReuseSource, uint32_t aLength,
...
INSTANTIATE_TEST_CASE_P(TEST_ReduceMin, ReduceMinTestsuite,
    ::testing::Values(ReduceMinTestParams{MainReduceMinTest<int8_t, 512, 2, 0, true, 2, 256, false>},
