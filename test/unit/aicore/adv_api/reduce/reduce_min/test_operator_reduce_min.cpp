...
INSTANTIATE_TEST_CASE_P(TEST_OPERATTION_MIN, MinTestsuite,
    ::testing::Values(MinTestParams{4, 8, 32, true, MainMin<float, true>},
        MinTestParams{4, 7, 35, true, MainMin<float, true>}, MinTestParams{4, 16, 128, true, MainMin<float, false>},
        MinTestParams{4, 1, 8, false, MainMin<float, true>}, MinTestParams{4, 8, 1, false, MainMin<float, false>},
        MinTestParams{4, 16, 7, false, MainMin<float, true>}, MinTestParams{4, 4, 8, true, MainMin<float, false>},
        MinTestParams{4, 7, 1, true, MainMin<float, false>}, MinTestParams{4, 4, 64, true, MainMin<float, true>},
        MinTestParams{2, 16, 128, true, MainMin<float, false>}, MinTestParams{2, 8, 16, true, MainMin<float, false>},
        MinTestParams{2, 7, 55, true, MainMin<float, true>}, MinTestParams{2, 7, 1, true, MainMin<float, false>},
        MinTestParams{2, 1, 8, false, MainMin<float, true>}, MinTestParams{2, 8, 1, false, MainMin<float, false>},
