...
public:
    ...
    __aicore__ inline void Init(GM_ADDR inputXGm, GM_ADDR inputGxGm, GM_ADDR betaGm, GM_ADDR gammGm, GM_ADDR outputGm,
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        DeepNorm<dataType, isReuseSrc, isBasicBlock>(outputLocal, meanLocal, varianceLocal, inputXLocal, inputGxLocal,
            betaLocal, gammaLocal, (dataType)alpha, (dataType)epsilon, tiling);
...
template <typename dataType, bool isReuseSrc = false, bool isBasicBlock = false>
__global__ __aicore__ void kernel_deepnorm_operator(GM_ADDR inputXGm, GM_ADDR inputGxGm, GM_ADDR betaGm, GM_ADDR gammGm,
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_DEEPNORM, DeepNormTestsuite,
    ::testing::Values(DeepNormTestParams{2, 32, 16, sizeof(half), kernel_deepnorm_operator<half, true, false>},
