...
__aicore__ inline void mainLayernormgradbetaTest(GM_ADDR outputPdGammaGm, GM_ADDR outputPdBetaGm, GM_ADDR resForGammaGm,
    GM_ADDR inputDyGm, uint32_t bLength, uint32_t sLength, uint32_t hLength)
{
