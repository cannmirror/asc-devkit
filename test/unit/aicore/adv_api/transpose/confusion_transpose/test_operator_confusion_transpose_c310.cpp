...
template <typename type, int32_t srcExtent, int32_t dstExtent, uint32_t dim0, uint32_t dim1, uint32_t dim2,
    uint32_t tranModeIn>
...
INSTANTIATE_TEST_CASE_P(TEST_ConfusionTranpose, ConfusionTranposeTestsuite,
    ::testing::Values(ConfusionTranposeParams{MainConfusionTranposeTest<float, 64, 64, 0, 2, 32, 13>},
...
TEST_P(ConfusionTranposeTestsuite, ConfusionTranposeTestCase)
{
    ...
    param.cal_func(x, y);
    for (int32_t i = 0; i < (sizeof(y) / sizeof(y[0])); i++) { EXPECT_EQ(y[i], 0x00); }
}
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t A1In, uint32_t A2In,
...
template <typename T>
__global__ __aicore__ void ConfusionTransposeFirst(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t A1In,
    uint32_t A2In, uint32_t A3In, TransposeType transposetypeIn)
{
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeFirstTestsuite,
    ::testing::Values(ConfusionTransposeFirstTestParams{2, ConfusionTransposeFirst<half>, 2, 64, 32,
                          TransposeType::TRANSPOSE_NZ2ND_0213},
...
TEST_P(ConfusionTransposeFirstTestsuite, ConfusionTransposeFirstTestCase)
{
    ...
    for (int32_t i = 0; i < (sizeof(dstGm) / sizeof(dstGm[0])); i++) { EXPECT_EQ(dstGm[i], 0x00); }
}
...
template <typename T>
__global__ __aicore__ void ConfusionTransposeSecond(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t A1In,
    uint32_t A2In, uint32_t A3In, TransposeType transposetypeIn)
{
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeSecondTestsuite,
    ::testing::Values(ConfusionTransposeSecondTestParams{2, ConfusionTransposeSecond<half>, 16, 80, 32,
...
template <typename T>
__global__ __aicore__ void ConfusionTransposeThird(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t NIn,
    uint32_t SIn, uint32_t HIn, uint32_t hnDivBlockNumIn, uint32_t hBlockNumIn, uint32_t sBlockNumIn,
    TransposeType transposetypeIn)
{
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeThirdTestsuite,
    ::testing::Values(ConfusionTransposeThirdTestParams{2, ConfusionTransposeThird<half>, 3, 16, 18, 1, 2, 1,
                          TransposeType::TRANSPOSE_NZ2NZ_012_WITH_N},
...
TEST_P(ConfusionTransposeThirdTestsuite, ConfusionTransposeThirdTestCase)
{
    ...
    param.cal_func(dstGm, srcGm, param.NIn, param.SIn, param.HIn, param.hnDivBlockNumIn, param.hBlockNumIn,
        param.sBlockNumIn, param.transposetypeIn);
    for (int32_t i = 0; i < (sizeof(dstGm) / sizeof(dstGm[0])); i++) { EXPECT_EQ(dstGm[i], 0x00); }
}
...
template <typename T>
__global__ __aicore__ void ConfusionTransposeFourth(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t NIn,
    uint32_t SIn, uint32_t HIn, uint32_t hnDivBlockNumIn, uint32_t hBlockNumIn, uint32_t sBlockNumIn,
    TransposeType transposetypeIn)
{
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeFourthTestsuite,
    ::testing::Values(ConfusionTransposeFourthTestParams{2, ConfusionTransposeFourth<half>, 3, 16, 18, 1, 2, 1,
                          TransposeType::TRANSPOSE_NZ2ND_012_WITH_N},
...
template <typename T>
__global__ __aicore__ void ConfusionTransposeFifth(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t NIn,
    uint32_t SIn, uint32_t HIn, uint32_t hnDivBlockNumIn, uint32_t hBlockNumIn, uint32_t sBlockNumIn,
    TransposeType transposetypeIn)
{
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeFifthTestsuite,
    ::testing::Values(ConfusionTransposeFifthTestParams{2, ConfusionTransposeFifth<half>, 3, 16, 18, 1, 2, 1,
                          TransposeType::TRANSPOSE_NZ2ND_012_WITH_N},
...
template <typename T>
__global__ __aicore__ void ConfusionTransposeSixth(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t NIn,
    uint32_t SIn, uint32_t HIn, uint32_t hnDivBlockNumIn, uint32_t hBlockNumIn, uint32_t sBlockNumIn,
    TransposeType transposetypeIn)
{
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeSixthTestsuite,
    ::testing::Values(ConfusionTransposeSixthTestParams{2, ConfusionTransposeSixth<half>, 3, 16, 18, 1, 2, 1,
                          TransposeType::TRANSPOSE_NZ2NZ_012_WITHOUT_N},
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t* dstGm, __gm__ uint8_t* srcGm, uint32_t widthIn, uint32_t heightIn,
        TransposeType transposetypeIn)
    {
        width = widthIn;
        height = heightIn;
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_CONFUSION_TRANSPOSE, ConfusionTransposeSeventhTestsuite,
    ::testing::Values(ConfusionTransposeSeventhTestParams{2, ConfusionTransposeSeventh<half>, 32, 32,
