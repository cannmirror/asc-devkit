...
INSTANTIATE_TEST_CASE_P(TEST_PACKAGE_Silu, SiluTestSuite,
    ::testing::Values(SiluTestParams{32, sizeof(half), main_Silu_test<half>},
        SiluTestParams{64, sizeof(half), main_Silu_test<half>}, SiluTestParams{256, sizeof(half), main_Silu_test<half>},
