 ...
 */
/*!
 * \file test_operator_softmax_v220.cpp
 * \brief
 */
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        if constexpr (std::is_same<T1, T2>::value) {
            SoftmaxFlashV2<T1, false, true, isBasicBlock, isDataFormatNZ, config>(dstLocal, outMaxLocal, insumLocal,
                inmaxLocal, srcLocal1, expMaxTensor, insumLocal, inmaxLocal, flashv2Tiling, srcShape);
            SoftmaxFlashV2<T1, true, true, isBasicBlock, isDataFormatNZ, config>(dstLocal, outMaxLocal, insumLocal,
                inmaxLocal, srcLocal2, expMaxTensor, insumLocal, inmaxLocal, flashv2Tiling, srcShape);
        }
...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_SOFTMAX, SoftMaxTestsuite,
    ::testing::Values(SoftMaxTestParams{2, 8, 880, MainSoftmax<half, half>},
        SoftMaxTestParams{2, 50, 144, MainSoftmax<half, half>}, SoftMaxTestParams{2, 50, 288, MainSoftmax<half, float>},
