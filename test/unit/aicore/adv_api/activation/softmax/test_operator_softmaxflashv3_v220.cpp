 ...
 */
/*!
 * \file test_operator_sofrmaxflashv3_v220.cpp
 * \brief
 */
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        SoftMaxTiling flashTiling = {height, width, height * width, height, 8, height * 8, height, width,
            height * width, height, 8, height * 8, 1, 0, 0, 0};
        SoftmaxFlashV3<T, U, isUpdate, false, false>(dstLocal, inmeanLocal, insumLocal, inmaxLocal, srcLocal1,
            expMaxTensor, inmeanLocal, insumLocal, inmaxLocal, flashTiling, params);
