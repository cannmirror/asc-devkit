...
#include "detail/matmul/scheduler/iterator/batch_loop/batch_loop_multi.h"
...
public:
    ...
    void SetSingleCoreParams(int32_t singleCoreM, int32_t singleCoreN, int32_t singleCoreK, int32_t aLayoutInfoB,
        int32_t bLayoutInfoB, int32_t batchNum)
    {
