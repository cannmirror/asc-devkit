...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case1_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 0, CFG_MDL, false, false); // MDL
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case2_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 1, 0, CFG_MDL, false, false); // MDL + A trans
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case2_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 1, CFG_MDL, false, false); // MDL + B trans
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case2_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 0, CFG_NORM, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case2_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 0, CFG_MDL, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case3_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 1, 1, CFG_MDL, false, false); // tail K + B trans
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case3_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 1, 0, CFG_MDL, false, false); // tail K + B not trans
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case4_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 0, CFG_MDL, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case5_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 0, CFG_MDL, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case6_310p, VECCALC, VECCALC, GM, GM, ND, ND, ND, ND, half,
    half, float, float, 0, 0, CFG_MDL, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case6_310p, VECCALC, VECCALC, GM, GM, NZ, NZ, ND, ND, half,
    half, float, float, 0, 0, CFG_NORM, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case7_310p, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float,
    float, 0, 0, MM_CFG_ENVEC, false, false);
