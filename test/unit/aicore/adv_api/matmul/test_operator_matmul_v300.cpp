...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, SHM, GM, ND, ND, ND, ND, half, half, float, float, 0,
    0, CFG_NORM, false);
...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, GM, GM, ND, ND, ND, ND, half, half, float, float, 0,
    0, CFG_NORM, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, GM, GM, NZ, NZ, ND, ND, half, half, float, float, 0,
    0, CFG_NORM, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, GM, GM, ND, ND, ND, ND, float, float, float, float,
    0, 0, CFG_NORM, false);
...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, VECCALC, VECCALC, GM, GM, NZ, NZ, ND, ND, half, half, float,
    float, 0, 0, CFG_NORM, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, A1, B1, GM, GM, NZ, NZ, ND, ND, half, half, float, float, 0,
    0, CFG_NORM, false);
...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, VECCALC, GM, ND, ND, NZ, ND, half, half, float,
    float, 0, 0, CFG_NORM, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, GM, GM, NZ, NZ, NZ, ND, half, half, float, float, 0,
    0, CFG_NORM, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, SHM, GM, ND, ND, ND, ND, half, half, float, float, 0,
    0, CFG_NORM, true);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, g_tilingParams, GM, GM, SHM, GM, ND, ND, ND, ND, int8_t, int8_t, int32_t,
