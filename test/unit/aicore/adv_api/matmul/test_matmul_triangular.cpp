...
#define KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tilingParams, A_Pos, B_Pos, C_Pos, BIAS_Pos, A_Format,                                                                                                                                                                        \
    B_Format, C_Format, BIAS_Format, A_DType, B_DType, C_DType, BIAS_DType, isTransposeA, isTransposeB, CFG_Mode,                                                                                                                                                                            \
    ...
    {                                                                                                                                                                                                                                                                                        \
        ...
        TEST_F(TEST_KERNEL_TRIAN_MATMUL,                                                                                                                                                                                                                                                     \
        ...
        {                                                                                                                                                                                                                                                                                    \
            ...
            main_kernel_matmul<aType, bType, cType, biasType, mmCFG>(left_global, right_global, output_global,                                                                                                                                                                               \
                bias_global, tilingParams, isTransposeA, isTransposeB, trianMode, enSequentialWrite);                                                                                                                                                                                        \
...
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case1_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    float, float, float, float, 0, 0, CFG_NORM, 0, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case2_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    float, float, float, float, 1, 0, CFG_NORM, 1, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case3_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    half, half, float, float, 0, 1, CFG_NORM, 1, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case4_910B1, GM, GM, GM, GM, NZ, NZ, ND, ND,
    half, half, float, float, 1, 1, CFG_NORM, 0, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case5_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    half, half, float, float, 0, 0, CFG_NORM, 0, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case6_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    half, half, float, float, 0, 0, CFG_NORM, 1, false);

// MDL
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case1_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    float, float, float, float, 0, 0, CFG_MDL, 0, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case2_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    float, float, float, float, 1, 0, CFG_MDL, 1, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case3_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    half, half, float, float, 0, 1, CFG_MDL, 1, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case4_910B1, GM, GM, GM, GM, NZ, NZ, ND, ND,
    half, half, float, float, 1, 1, CFG_MDL, 0, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case5_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    half, half, float, float, 0, 0, CFG_MDL, 0, false);
KERNEL_TRIAN_MATMUL_TESTCASE(TEST_KERNEL_TRIAN_MATMUL, tiling_params_trian_case6_910B1, GM, GM, GM, GM, ND, ND, ND, ND,
    half, half, float, float, 0, 0, CFG_MDL, 1, false);
