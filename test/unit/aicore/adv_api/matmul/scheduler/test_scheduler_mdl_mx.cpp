...
private:
    using A_TYPE = MatmulTypeWithScale<AscendC::TPosition::GM, AscendC::TPosition::GM, CubeFormat::ND, uint8_t, false,
        AscendC::TPosition::GM, CubeFormat::ND, false, AscendC::TPosition::GM>;
    using B_TYPE = MatmulTypeWithScale<AscendC::TPosition::GM, AscendC::TPosition::GM, CubeFormat::ND, uint8_t, true,
        AscendC::TPosition::GM, CubeFormat::ND, true, AscendC::TPosition::GM>;
