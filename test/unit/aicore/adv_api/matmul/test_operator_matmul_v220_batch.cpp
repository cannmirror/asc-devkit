    ...
    TilingParamsBatch& tilingParam, int32_t isTransposeAIn, int32_t isTransposeBIn, bool enSequentialWrite)
{
    ...
    gm_a.SetGlobalBuffer(const_cast<__gm__ A_T*>(aGlobal[offset_a].GetPhyAddr()),
        tiling.ALayoutInfoS * tiling.ALayoutInfoN * tiling.ALayoutInfoG * tiling.ALayoutInfoD);
    GlobalTensor<B_T> gm_b;
    gm_b.SetGlobalBuffer(const_cast<__gm__ B_T*>(bGlobal[offset_b].GetPhyAddr()),
        tiling.BLayoutInfoS * tiling.BLayoutInfoN * tiling.BLayoutInfoG * tiling.BLayoutInfoD);
    GlobalTensor<C_T> gm_c;
    gm_c.SetGlobalBuffer(const_cast<__gm__ C_T*>(cGlobal[offset_c].GetPhyAddr()),
...
#define KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tilingParams, M, N, K, baseM, baseN, baseK, A_Pos, B_Pos, C_Pos,                                                                                                                                                                                                               \
    BIAS_Pos, A_Format, B_Format, C_Format, BIAS_Format, A_DType, B_DType, C_DType, BIAS_DType, isTransposeA,                                                                                                                                                                                                                     \
    isTransposeB, CFG_Mode, enSequentialWrite, enTiling, enOuter, enOrderM)                                                                                                                                                                                                                                                       \
    ...
    {                                                                                                                                                                                                                                                                                                                             \
        typedef AscendC::MatmulType<AscendC::TPosition::A_Pos, CubeFormat::A_Format, A_DType, isTransposeA,                                                                                                                                                                                                                       \
            LayoutMode::NORMAL>                                                                                                                                                                                                                                                                                                   \
            aType;                                                                                                                                                                                                                                                                                                                \
        typedef AscendC::MatmulType<AscendC::TPosition::B_Pos, CubeFormat::B_Format, B_DType, isTransposeB,                                                                                                                                                                                                                       \
            LayoutMode::NORMAL>                                                                                                                                                                                                                                                                                                   \
            bType;                                                                                                                                                                                                                                                                                                                \
        typedef AscendC::MatmulType<AscendC::TPosition::C_Pos, CubeFormat::C_Format, C_DType, false,                                                                                                                                                                                                                              \
            LayoutMode::NORMAL>                                                                                                                                                                                                                                                                                                   \
            cType;                                                                                                                                                                                                                                                                                                                \
        ...
        {                                                                                                                                                                                                                                                                                                                         \
            ...
            if (enTiling) {                                                                                                                                                                                                                                                                                                       \
                constexpr MatmulConfig static CFG_NORM_NEED_PAD = {.doNorm = true,                                                                                                                                                                                                                                                \
                    .doBasicBlock = false,                                                                                                                                                                                                                                                                                        \
                ...
                main_kernel_matmul_batch<aType, bType, cType, biasType, mmTiling>(left_global, right_global,                                                                                                                                                                                                                      \
                    output_global, bias_global, tilingParams, isTransposeA, isTransposeB, enSequentialWrite);                                                                                                                                                                                                                     \
            } else {                                                                                                                                                                                                                                                                                                              \
                main_kernel_matmul_batch<aType, bType, cType, biasType, CFG_Mode>(left_global, right_global,                                                                                                                                                                                                                      \
                    output_global, bias_global, tilingParams, isTransposeA, isTransposeB, enSequentialWrite);                                                                                                                                                                                                                     \
            }                                                                                                                                                                                                                                                                                                                     \
        }                                                                                                                                                                                                                                                                                                                         \
    }
...
TilingParamsBatch tiling_params_case1_910B1_batch = {1, 144, 77, 64, 144, 77, 64, 48, 80, 64, 3, 1, 3, 1, 3, 1, 0, 0, 1,
    1, 1, 1, 144, 1, 1, 64, 1, 77, 1, 1, 64, 1, 144, 1, 1, 77};
TilingParamsBatch tiling_params_case2_910B1_batch = {1, 144, 64, 77, 144, 64, 77, 48, 32, 80, 3, 2, 1, 1, 3, 2, 0, 0, 1,
    1, 1, 1, 144, 1, 1, 77, 1, 77, 1, 1, 64, 1, 144, 1, 1, 64};
TilingParamsBatch tiling_params_case3_910B1_batch = {1, 32, 32, 32, 32, 32, 32, 16, 16, 32, 2, 2, 1, 1, 2, 2, 0, 0, 1,
    1, 1, 1, 32, 1, 2, 32, 1, 32, 1, 1, 32, 1, 32, 1, 2, 32};
TilingParamsBatch tiling_params_case4_910B1_batch = {1, 64, 256, 64, 64, 256, 64, 32, 64, 64, 2, 4, 1, 1, 2, 4, 0, 0, 1,
    1, 1, 1, 64, 2, 3, 64, 1, 256, 2, 1, 64, 1, 64, 2, 3, 256};
TilingParamsBatch tiling_params_case5_910B1_batch = {1, 32, 32, 32, 32, 32, 32, 16, 16, 32, 2, 2, 1, 1, 2, 2, 1, 0, 2,
    2, 2, 1, 32, 1, 2, 32, 1, 32, 1, 2, 32, 1, 32, 1, 1, 32};
TilingParamsBatch tiling_params_case6_910B1_batch = {1, 32, 256, 64, 32, 256, 64, 32, 32, 64, 1, 2, 1, 1, 1, 2, 1, 0, 3,
    3, 3, 1, 32, 2, 3, 64, 1, 256, 2, 3, 64, 1, 32, 2, 3, 256};
TilingParamsBatch tiling_params_case7_910B1_batch = {1, 32, 32, 32, 32, 32, 32, 32, 32, 32, 2, 2, 1, 1, 2, 2, 1, 0, 2,
    2, 2, 1, 32, 2, 1, 32, 1, 32, 2, 1, 32, 1, 32, 2, 1, 32};
TilingParamsBatch tiling_params_case8_910B1_batch = {1, 144, 77, 64, 144, 77, 64, 48, 80, 64, 3, 1, 3, 1, 3, 1, 0, 0, 1,
    1, 1, 1, 144, 1, 1, 64, 1, 77, 1, 1, 64, 1, 144, 1, 1, 77};
TilingParamsBatch tiling_params_case9_910B1_batch = {1, 32, 256, 64, 32, 256, 64, 32, 32, 64, 1, 2, 1, 1, 1, 2, 1, 0, 1,
    1, 1, 1, 32, 2, 3, 64, 1, 256, 2, 3, 64, 1, 32, 2, 3, 256};
...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case1_910B1_batch, 144, 77, 64, 48, 80, 64, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, half, float, 0, 0, mm_cfg, false, false, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case2_910B1_batch, 144, 64, 77, 48, 32, 80, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, half, float, 0, 0, mm_cfg, false, false, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case3_910B1_batch, 32, 32, 32, 16, 16, 32, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, float, float, 0, 1, mm_cfg, false, false, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case4_910B1_batch, 64, 256, 64, 32, 64, 64, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, float, float, 0, 1, mm_cfg, false, false, false, false);
// test batch split loop
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case5_910B1_batch, 32, 32, 32, 16, 16, 32, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, float, float, 0, 1, mm_cfg, false, true, false, false);
// test batch inner loop
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case6_910B1_batch, 32, 256, 64, 32, 32, 64, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, float, float, 0, 1, mm_cfg, false, true, false, false);
// test const
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case7_910B1_batch, 32, 32, 32, 32, 32, 32, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, half, float, 0, 0, mm_cfg, false, true, false, false);
...
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case8_910B1_batch, 144, 77, 64, 48, 80, 64, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, half, float, 0, 0, single_mm_cfg, false, false, false, false);
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case9_910B1_batch, 32, 256, 64, 32, 32, 64, GM, GM, GM, GM, ND,
    ND, ND, ND, half, half, float, float, 0, 1, single_mm_cfg, false, false, false, false);
...
TilingParamsBatch tiling_params_case10_910B1_batch = {1, 81, 256, 64, 81, 256, 64, 32, 32, 64, 1, 2, 1, 1, 1, 2, 0, 0,
    1, 1, 1, 1, 81, 1, 1, 64, 1, 256, 1, 1, 64, 1, 81, 1, 1, 256};
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case10_910B1_batch, 81, 256, 64, 32, 32, 64, GM, GM, GM, GM,
    ND, ND, ND, ND, half, half, float, float, 0, 0, CFG_NORM_OUTER_PRODUCT, false, false, false, false);
...
TilingParamsBatch tiling_params_case11_910B1_batch = {1, 81, 256, 64, 81, 256, 64, 32, 32, 64, 1, 2, 1, 1, 1, 2, 0, 0,
    1, 1, 1, 1, 81, 1, 1, 64, 1, 256, 1, 1, 64, 1, 81, 1, 1, 256};
KERNEL_MATMUL_TESTCASE(TEST_KERNEL_MATMUL, tiling_params_case11_910B1_batch, 81, 256, 64, 32, 32, 64, GM, GM, GM, GM,
    ND, ND, ND, ND, half, half, float, float, 0, 0, CFG_NORM_OUTER_PRODUCT_N, false, false, false, false);
