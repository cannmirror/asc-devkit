...
CASE_REL=05_simd_simt_hybrid/02_best_practices/simd_simt_hash_table_mte_queue
...
case_run() {
    mkdir -p "$BUILD_DIR"
    (cd "$BUILD_DIR" && SCENARIO_NUM=0 soc_version=$SOC_VERSION bash -lc './hash_table_mte_queue 128')
}
