...
expect_fixed "$SKILL_FILE" "docs/api/README.md" "API documentation root"
expect_fixed "$SKILL_FILE" "docs/api/Ascend-C-API列表.md" "API category index"
...
expect_fixed "${REFERENCES_DIR}/08_api_lookup.md" "docs/api/README.md" "API lookup documentation root"
expect_fixed "${REFERENCES_DIR}/08_api_lookup.md" "docs/api/Ascend-C-API列表.md" "API lookup category index"
