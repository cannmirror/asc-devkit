...
__aicore__ inline void main_Add(uint8_t* dstGm, uint8_t* src0Gm,
...
class AddTestsuite : public testing::Test,
                              public testing::WithParamInterface<AddTestParams> {
protected:
...
INSTANTIATE_TEST_CASE_P(TEST_ADD, AddTestsuite,
    ::testing::Values(
