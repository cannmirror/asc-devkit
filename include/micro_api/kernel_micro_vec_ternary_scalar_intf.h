...
/* !
 * \file kernel_micro_vec_ternary_scalar_intf.h
 */
...
#include "impl/micro_api/kernel_micro_vec_ternary_scalar_intf_impl.h"
#endif // ASCENDC_MODULE_MICRO_VEC_TERNARY_SCALAR_INTERFACE_H
