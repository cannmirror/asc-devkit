...
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_CONV3D_BP_FILTER_API_H
#endif
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_CONV3D_BP_FILTER_API_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_CONV3D_BP_FILTER_API_H
#endif