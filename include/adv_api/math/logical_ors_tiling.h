...
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LOGICAL_ORS_TILING_H
#endif
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LOGICAL_ORS_TILING_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LOGICAL_ORS_TILING_H
#endif