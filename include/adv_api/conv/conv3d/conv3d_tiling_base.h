...
struct Conv3DDesc {
    ConvType fMapType = {
        ConvCommonApi::ConvFormat::NDC1HWC0, ConvCommonApi::ConvDtype::FLOAT16,
        ConvCommonApi::TPosition::GM}; ///< Input feature map type
    ConvType weightType = {
        ConvCommonApi::ConvFormat::FRACTAL_Z_3D, ConvCommonApi::ConvDtype::FLOAT16,
        ConvCommonApi::TPosition::GM}; ///< Weight tensor type
    ConvType biasType = {
        ConvCommonApi::ConvFormat::ND, ConvCommonApi::ConvDtype::FLOAT16,
        ConvCommonApi::TPosition::GM}; ///< Bias tensor type
    ConvType outputType = {
        ConvCommonApi::ConvFormat::NDC1HWC0, ConvCommonApi::ConvDtype::FLOAT16,
        ConvCommonApi::TPosition::CO1}; ///< Output tensor type
    ConvType quantScaleType = {
        ConvCommonApi::ConvFormat::ND, ConvCommonApi::ConvDtype::INT64,
        ConvCommonApi::TPosition::GM}; ///< Quantization scale type
};
/**
...
public:
     ...
     */
    void SetWeightType(
        const ConvCommonApi::TPosition pos, const ConvCommonApi::ConvFormat format,
