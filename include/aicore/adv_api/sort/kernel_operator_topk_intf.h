 ...
 * \brief
 */
#ifndef AICORE_ADV_API_SORT_KERNEL_OPERATOR_TOPK_INTF_H
#define AICORE_ADV_API_SORT_KERNEL_OPERATOR_TOPK_INTF_H
#include "topk.h"
...
#endif // AICORE_ADV_API_SORT_KERNEL_OPERATOR_TOPK_INTF_H