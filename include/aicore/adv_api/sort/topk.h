 ...
 * \brief
 */
#ifndef AICORE_ADV_API_SORT_TOPK_H
#define AICORE_ADV_API_SORT_TOPK_H
...
#include "detail/sort/topk/topk_common_impl.h"
#endif

#if __CCE_AICORE__ == 220
#include "detail/sort/topk/topk_v220_impl.h"
#elif __CCE_AICORE__ == 200
#include "detail/sort/topk/topk_v200_impl.h"
#elif defined(__DAV_C310__) || defined(__DAV_310R6__)
#include "detail/sort/topk/topk_c310_impl.h"
#endif
    ...
    const int32_t k, const TopkTiling& tilling, const TopKInfo& topKInfo, const bool isLargest = true)
{
    ...
    ASCENDC_ASSERT(ans, {
        KERNEL_LOG(KERNEL_ERROR, "The pop stack buffer is insufficient, topk api need %d, but only %d exists.",
...
#endif // AICORE_ADV_API_SORT_TOPK_H
