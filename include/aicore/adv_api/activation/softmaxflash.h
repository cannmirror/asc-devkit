 ...
 */
#ifndef AICORE_ADV_API_ACTIVATION_SOFTMAXFLASH_H
#define AICORE_ADV_API_ACTIVATION_SOFTMAXFLASH_H

#include "kernel_tensor.h"
#include "kernel_tiling/kernel_tiling.h"
#if __CCE_AICORE__ >= 200
#include "detail/activation/softmax/softmax_common.h"
#include "detail/activation/softmax/softmax_flash_base_impl.h"
    ...
    bool isUpdate = false, const SoftMaxShapeInfo& softmaxShapeInfo = {})
{
    ...
    SoftmaxFlashImpl<T, isReuseSource, isBasicBlock>(dstTensor, sumTensor, maxTensor, srcTensor, expMaxTensor,
    ...
    const SoftMaxTiling& tiling, bool isUpdate = false, const SoftMaxShapeInfo& softmaxShapeInfo = {})
{
    ...
    TRACE_START(TraceId::SoftmaxFlash);
    SoftmaxFlashImpl<T, isReuseSource, isBasicBlock>(dstTensor, sumTensor, maxTensor, srcTensor, expMaxTensor,
        inSumTensor, inMaxTensor, sharedTmpBuffer, tiling, isUpdate, softmaxShapeInfo);
    TRACE_STOP(TraceId::SoftmaxFlash);
}
/*!
 * \ingroup SoftmaxFlash
