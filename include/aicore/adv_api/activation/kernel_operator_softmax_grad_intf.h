 ...
 * \brief
 */
#ifndef AICORE_ADV_API_ACTIVATION_KERNEL_OPERATOR_SOFTMAX_GRAD_INTF_H
#define AICORE_ADV_API_ACTIVATION_KERNEL_OPERATOR_SOFTMAX_GRAD_INTF_H
...
#endif // AICORE_ADV_API_ACTIVATION_KERNEL_OPERATOR_SOFTMAX_GRAD_INTF_H
