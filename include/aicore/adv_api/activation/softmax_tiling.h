...
#ifndef AICORE_ADV_API_ACTIVATION_SOFTMAX_TILING_H
#define AICORE_ADV_API_ACTIVATION_SOFTMAX_TILING_H
...
uint32_t GetSoftMaxMaxTmpSize(const platform_ascendc::PlatformAscendC& ascendcPlatform, const ge::Shape& srcShape,
    const uint32_t dataTypeSize, const bool isReuseSource);
/*
...
#endif // AICORE_ADV_API_ACTIVATION_SOFTMAX_TILING_H