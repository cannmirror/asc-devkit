 ...
 */
#ifndef AICORE_ADV_API_ACTIVATION_LOGSOFTMAX_H
#define AICORE_ADV_API_ACTIVATION_LOGSOFTMAX_H

#include "kernel_tensor.h"
#if __CCE_AICORE__ >= 200
#include "detail/activation/softmax/softmax_common.h"
#include "detail/activation/softmax/logsoftmax_base_impl.h"
#pragma begin_pipe(V)
...
__aicore__ inline void LogSoftMax(const LocalTensor<T>& dst, const LocalTensor<T>& sum, const LocalTensor<T>& max,
...
#pragma end_pipe
#endif
#endif // AICORE_ADV_API_ACTIVATION_LOGSOFTMAX_H
