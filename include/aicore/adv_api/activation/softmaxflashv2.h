 ...
 */
#ifndef AICORE_ADV_API_ACTIVATION_SOFTMAXFLASHV2_H
#define AICORE_ADV_API_ACTIVATION_SOFTMAXFLASHV2_H
...
#include "detail/activation/softmax/softmax_flashv2_base_impl.h"
    ...
    const SoftMaxShapeInfo& softmaxShapeInfo = {})
{
    ...
    TRACE_START(TraceId::SoftmaxFlashV2);
    SoftmaxFlashV2Impl<half, float, isUpdate, isReuseSource, isBasicBlock, isDataFormatNZ, config>(dstTensor,
        expSumTensor, maxTensor, srcTensor, expMaxTensor, inExpSumTensor, inMaxTensor, tiling, softmaxShapeInfo);
    TRACE_STOP(TraceId::SoftmaxFlashV2);
}
...
#pragma end_pipe
#endif
#endif // AICORE_ADV_API_ACTIVATION_SOFTMAXFLASHV2_H
