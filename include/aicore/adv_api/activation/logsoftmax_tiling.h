...
#ifndef AICORE_ADV_API_ACTIVATION_LOGSOFTMAX_TILING_H
#define AICORE_ADV_API_ACTIVATION_LOGSOFTMAX_TILING_H
...
#endif // AICORE_ADV_API_ACTIVATION_LOGSOFTMAX_TILING_H
