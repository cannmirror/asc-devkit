...
#ifndef AICORE_ADV_API_ACTIVATION_SWIGLU_H
#define AICORE_ADV_API_ACTIVATION_SWIGLU_H

#include "kernel_tensor.h"
#if defined(__DAV_C310__) || defined(__DAV_310R6__)
#include "detail/activation/swiglu/swiglu_c310_impl.h"
#else
#include "detail/activation/swiglu/swiglu_common_impl.h"
#endif
namespace AscendC {
#pragma begin_pipe(V)
/* !
