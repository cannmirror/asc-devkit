 ...
 * \brief
 */
#ifndef AICORE_ADV_API_ACTIVATION_KERNEL_OPERATOR_SIGMOID_INTF_H
#define AICORE_ADV_API_ACTIVATION_KERNEL_OPERATOR_SIGMOID_INTF_H
#include "sigmoid.h"
...
#endif // AICORE_ADV_API_ACTIVATION_KERNEL_OPERATOR_SIGMOID_INTF_H
