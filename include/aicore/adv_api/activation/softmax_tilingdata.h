...
#ifndef AICORE_ADV_API_ACTIVATION_SOFTMAX_TILINGDATA_H
#define AICORE_ADV_API_ACTIVATION_SOFTMAX_TILINGDATA_H
...
#endif // AICORE_ADV_API_ACTIVATION_SOFTMAX_TILINGDATA_H