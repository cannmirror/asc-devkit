 ...
 */
#ifndef AICORE_ADV_API_ACTIVATION_SIGMOID_H
#define AICORE_ADV_API_ACTIVATION_SIGMOID_H
#if __CCE_AICORE__ == 100 || __CCE_AICORE__ == 200 || __CCE_AICORE__ == 220 || defined(__DAV_C310__)                   \
    || defined(__DAV_310R6__)

#include "kernel_tensor.h"
#include "detail/activation/sigmoid/sigmoid_common_impl.h"
namespace AscendC {
#pragma begin_pipe(V)
/*!
 * \ingroup Sigmoid
...
#endif
#endif // AICORE_ADV_API_ACTIVATION_SIGMOID_H
