 ...
 * \brief
 */
#ifndef AICORE_ADV_API_CONV_BACKPROP_CONV3D_BP_INPUT_TILING_BASE_H
#define AICORE_ADV_API_CONV_BACKPROP_CONV3D_BP_INPUT_TILING_BASE_H
...
struct Conv3DBpDxDesc {
    ...
    ConvBpType fMapType = {
        ConvCommonApi::ConvFormat::NCDHW, ConvCommonApi::ConvDtype::FLOAT16, ConvCommonApi::TPosition::CO1};
};
