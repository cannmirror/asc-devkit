 ...
 * \brief
 */
#ifndef AICORE_ADV_API_REDUCE_REDUCE_XOR_SUM_TILING_H
#define AICORE_ADV_API_REDUCE_REDUCE_XOR_SUM_TILING_H
...
#endif // AICORE_ADV_API_REDUCE_REDUCE_XOR_SUM_TILING_H