 ...
 * \brief
 */
#ifndef AICORE_ADV_API_REDUCE_REDUCE_XOR_SUM_H
#define AICORE_ADV_API_REDUCE_REDUCE_XOR_SUM_H

#include "kernel_tensor.h"
#include "kernel_operator_intf.h"
#include "kernel_pop_stack_buffer.h"
#if defined(__DAV_C310__) || defined(__DAV_310R6__)
#include "detail/reduce/reduce_xor_sum/reduce_xor_sum_c310_impl.h"
#else
#include "detail/reduce/reduce_xor_sum/reduce_xor_sum_common_impl.h"
#endif
...
#if defined(__CCE_AICORE__) && (__CCE_AICORE__ >= 220 || __CCE_AICORE__ == 200) || defined(__DAV_C310__)               \
