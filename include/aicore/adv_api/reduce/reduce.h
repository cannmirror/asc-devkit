 ...
 */
#ifndef AICORE_ADV_API_REDUCE_REDUCE_H
#define AICORE_ADV_API_REDUCE_REDUCE_H
...
#include "detail/reduce/reduce_prod/reduce_prod_v220_impl.h"
#include "detail/reduce/reduce_max/reduce_max_v220_impl.h"
#include "detail/reduce/reduce_min/reduce_min_v220_impl.h"
#include "detail/reduce/reduce_sum/reduce_sum_v220_impl.h"
#include "detail/reduce/reduce_mean/reduce_mean_v220_impl.h"
#include "detail/reduce/reduce_any/reduce_any_v220_impl.h"
#include "detail/reduce/reduce_all/reduce_all_v220_impl.h"
#elif defined(__DAV_C310__) || defined(__DAV_310R6__)
#include "detail/reduce/reduce_max/reduce_max_c310_impl.h"
#include "detail/reduce/reduce_min/reduce_min_c310_impl.h"
#include "detail/reduce/reduce_sum/reduce_sum_c310_impl.h"
#endif
    ...
    const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor, const uint32_t srcShape[], bool srcInnerPad)
{
    ...
    ReduceSumCompute<T, pattern, isReuseSource>(dstTensor, srcTensor, srcShape, srcInnerPad);
}
    ...
    const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor, const uint32_t srcShape[], bool srcInnerPad)
{
    ...
    ReduceMaxCompute<T, pattern, isReuseSource>(dstTensor, srcTensor, srcShape, srcInnerPad);
}
    ...
    const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor, const uint32_t srcShape[], bool srcInnerPad)
{
    ...
    ReduceMinCompute<T, pattern, isReuseSource>(dstTensor, srcTensor, srcShape, srcInnerPad);
}
#else
/* !
...
#endif
#endif // AICORE_ADV_API_REDUCE_REDUCE_H
