 ...
 */
#ifndef AICORE_ADV_API_REDUCE_REDUCE_COMMON_H
#define AICORE_ADV_API_REDUCE_REDUCE_COMMON_H

#include "detail/reduce/reduce_common_util_impl.h"
...
#endif // AICORE_ADV_API_REDUCE_REDUCE_COMMON_H
