 ...
 * \brief
 */
#ifndef AICORE_ADV_API_MATMUL_BMM_TILING_H
#define AICORE_ADV_API_MATMUL_BMM_TILING_H
...
public:
    ...
    virtual int32_t SetSingleRange(int32_t maxM = -1, int32_t maxN = -1, int32_t maxK = -1, int32_t minM = -1,
...
#endif // AICORE_ADV_API_MATMUL_BMM_TILING_H
