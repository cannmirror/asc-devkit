 ...
 * \brief
 */
#ifndef AICORE_ADV_API_MATMUL_MATMUL_H
#define AICORE_ADV_API_MATMUL_MATMUL_H
...
public:
    ...
    __aicore__ inline void IterateBatch(const GlobalTensor<DstT>& gm, bool enPartialSum, uint8_t enAtomic,
        bool enSequentialWrite, const uint32_t matrixStrideA = 0, const uint32_t matrixStrideB = 0,
        const uint32_t matrixStrideC = 0)
    {}
    __aicore__ inline void IterateBatch(const LocalTensor<DstT>& ubCmatrix, bool enPartialSum, uint8_t enAtomic,
        bool enSequentialWrite, const uint32_t matrixStrideA = 0, const uint32_t matrixStrideB = 0,
        const uint32_t matrixStrideC = 0)
    {}
...
#include "detail/matmul/matmul_impl_base.h"
#include "detail/matmul/matmul_impl.h"
#include "detail/matmul/batch_matmul_impl.h"
#include "detail/matmul/mx_matmul_impl.h"
#endif
