 ...
 * \brief
 */
#ifndef AICORE_ADV_API_MATMUL_MATMUL_CONFIG_H
#define AICORE_ADV_API_MATMUL_MATMUL_CONFIG_H
...
enum class LayoutMode { NONE = 0, BSNGD, SBNGD, BNGS1S2, NORMAL };

enum class BatchMode { NONE = 0, BATCH_LESS_THAN_L1, BATCH_LARGE_THAN_L1, SINGLE_LARGE_THAN_L1 };
...
enum class MatmulConfigMode { CONFIG_NORM, CONFIG_MDL, CONFIG_SPECIALMDL, CONFIG_IBSHARE };
...
#endif // AICORE_ADV_API_MATMUL_MATMUL_CONFIG_H