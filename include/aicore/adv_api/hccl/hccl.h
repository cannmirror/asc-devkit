 ...
 * \brief
 */
#ifndef AICORE_ADV_API_HCCL_HCCL_H
#define AICORE_ADV_API_HCCL_HCCL_H

#include "hccl_common.h"
#include "detail/hccl/hccl_impl_def.h"
...
public:
     ...
     * identifier handleId. (task content: Each communication will send a segment of data to a specified memory address
     * on the designated rank, supporting multiple communications in batch.)
     ...
     *       2) The size of sendSizes is rankDim, the value of sendSizes[localRank] is not used, use localDataSize
...
public:
     ...
     */
    [[deprecated("It is obsoleted and use SetCcTilingV2 instead.")]] __aicore__ inline int32_t SetCcTiling(
     ...
     */
    [[deprecated("It is obsoleted and use InitV2 instead.")]] __aicore__ inline void Init(
        GM_ADDR context, __gm__ void* initTiling = nullptr);
...
#include "detail/hccl/hccl_impl.h"
#endif // AICORE_ADV_API_HCCL_HCCL_H
