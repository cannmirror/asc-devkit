 ...
 * \brief
 */
#ifndef AICORE_ADV_API_SELECT_SELECTWITHBYTESMASK_TILING_H
#define AICORE_ADV_API_SELECT_SELECTWITHBYTESMASK_TILING_H
#include <cstdint>
#include <algorithm>
...
#endif // AICORE_ADV_API_SELECT_SELECTWITHBYTESMASK_TILING_H