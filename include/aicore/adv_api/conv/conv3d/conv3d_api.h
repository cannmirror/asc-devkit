...
#ifndef AICORE_ADV_API_CONV_CONV3D_CONV3D_API_H
#define AICORE_ADV_API_CONV_CONV3D_CONV3D_API_H

#include "conv3d_intf.h"
#include "conv3d_config.h"
#include "conv/conv3d/conv3d_api_impl.h"
...
#define REGISTER_CONV3D_API(name, Config, Impl, Intf)                                                                  \
    template <class INPUT_TYPE, class WEIGHT_TYPE, class OUTPUT_TYPE, class BIAS_TYPE = biasType,                      \
        class CONV_CFG = Conv3dParam>                                                                                  \
    using name =                                                                                                       \
        Conv3dIntfExt<Config<ConvApi::ConvDataType<INPUT_TYPE, WEIGHT_TYPE, OUTPUT_TYPE, BIAS_TYPE, CONV_CFG>>, Impl,  \
            Intf>

REGISTER_CONV3D_API(Conv3D, Conv3dCfg, Conv3dApiImpl, Conv3dIntf);
} // namespace Conv3dApi
#endif // AICORE_ADV_API_CONV_CONV3D_CONV3D_API_H
