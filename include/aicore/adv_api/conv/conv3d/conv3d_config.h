...
#ifndef AICORE_ADV_API_CONV_CONV3D_CONV3D_CONFIG_H
#define AICORE_ADV_API_CONV_CONV3D_CONV3D_CONFIG_H

#include "conv/common/conv_forward_framework_util.h"
#include "../common/conv_forward_config.h"

namespace Conv3dApi {

enum class ConvL0PingPong : uint32_t { ALL_CLOSE = 0, L0A_OPEN, L0B_OPEN, ALL_OPEN };

enum class ConvBL1ByPass : uint32_t { BYPASS_OFF = 0, BYPASS_ON = 1 };
