...
#ifndef AICORE_ADV_API_CONV_CONV3D_CONV3D_TILING_BASE_H
#define AICORE_ADV_API_CONV_CONV3D_CONV3D_TILING_BASE_H

#include "conv3d_tilingdata.h"
#include "tiling/conv/conv3d_tiling_util.h"
...
struct Conv3DDesc {
    ...
    ConvType biasType = {
        ConvCommonApi::ConvFormat::ND, ConvCommonApi::ConvDtype::FLOAT16, ConvCommonApi::TPosition::GM};
    ConvType outputType = {
        ConvCommonApi::ConvFormat::NDC1HWC0, ConvCommonApi::ConvDtype::FLOAT16, ConvCommonApi::TPosition::CO1};
    ConvType quantScaleType = {
        ConvCommonApi::ConvFormat::ND, ConvCommonApi::ConvDtype::INT64, ConvCommonApi::TPosition::GM};
};
...
public:
    ...
    void SetInputType(const ConvCommonApi::TPosition pos, const ConvCommonApi::ConvFormat format,
        const ConvCommonApi::ConvDtype dtype);
    void SetBiasType(const ConvCommonApi::TPosition pos, const ConvCommonApi::ConvFormat format,
        const ConvCommonApi::ConvDtype dtype);
