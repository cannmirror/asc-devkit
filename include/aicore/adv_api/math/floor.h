...
#ifndef AICORE_ADV_API_MATH_FLOOR_H
#define AICORE_ADV_API_MATH_FLOOR_H

#include "kernel_tensor.h"
#include "detail/math/floor/floor_common_impl.h"

#if (defined(__CCE_AICORE__) && (__CCE_AICORE__ == 200 || __CCE_AICORE__ == 220 || __CCE_AICORE__ == 300))             \
    || defined(__DAV_C310__) || defined(__DAV_C310R6__)
...
#endif
#endif // AICORE_ADV_API_MATH_FLOOR_H
