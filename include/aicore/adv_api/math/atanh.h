...
#ifndef AICORE_ADV_API_MATH_ATANH_H
#define AICORE_ADV_API_MATH_ATANH_H
...
#include "detail/math/atanh/atanh_common_impl.h"
#else
#include "detail/math/atanh/atanh_c310_impl.h"
#endif
namespace AscendC {
#pragma begin_pipe(V)
