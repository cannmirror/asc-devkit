 ...
 * \brief
 */
#ifndef AICORE_ADV_API_MATH_KERNEL_OPERATOR_CLAMP_INTF_H
#define AICORE_ADV_API_MATH_KERNEL_OPERATOR_CLAMP_INTF_H
#include "clamp.h"
...
#endif // AICORE_ADV_API_MATH_KERNEL_OPERATOR_CLAMP_INTF_H