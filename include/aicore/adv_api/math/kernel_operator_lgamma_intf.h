 ...
 * \brief
 */
#ifndef AICORE_ADV_API_MATH_KERNEL_OPERATOR_LGAMMA_INTF_H
#define AICORE_ADV_API_MATH_KERNEL_OPERATOR_LGAMMA_INTF_H
#include "lgamma.h"
...
#endif // AICORE_ADV_API_MATH_KERNEL_OPERATOR_LGAMMA_INTF_H
