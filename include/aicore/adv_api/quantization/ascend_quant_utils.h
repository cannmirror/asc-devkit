 ...
 * \brief
 */
#ifndef AICORE_ADV_API_QUANTIZATION_ASCEND_QUANT_UTILS_H
#define AICORE_ADV_API_QUANTIZATION_ASCEND_QUANT_UTILS_H
...
struct AscendQuantConfig {
    __aicore__ constexpr AscendQuantConfig(
        ...
        calcCount(calcCount),
        offsetCount(offsetCount), scaleCount(scaleCount), workLocalSize(workLocalSize)
    {}
...
#endif // AICORE_ADV_API_QUANTIZATION_ASCEND_QUANT_UTILS_H