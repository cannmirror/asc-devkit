 ...
 */
#ifndef AICORE_ADV_API_QUANTIZATION_QUANTIZE_H
#define AICORE_ADV_API_QUANTIZATION_QUANTIZE_H

#if defined(__DAV_C310__) || defined(__DAV_310R6__)
#include "kernel_tensor.h"
#include "quantization/quantize_utils.h"
#include "detail/quantization/quantize/quantize_impl.h"
namespace AscendC {
#pragma begin_pipe(V)
...
template <const QuantizeConfig& config, typename DstT, typename SrcT, typename ScaleT, typename OffsetT>
__aicore__ inline void Quantize(const LocalTensor<DstT>& dstTensor, const LocalTensor<SrcT>& srcTensor,
    const LocalTensor<uint8_t>& sharedTmpBuffer, const ScaleT& scale, const OffsetT& offset,
...
#endif // AICORE_ADV_API_QUANTIZATION_QUANTIZE_H
