 ...
 * \brief
 */
#ifndef AICORE_ADV_API_NORMALIZATION_LAYERNORM_UTILS_H
#define AICORE_ADV_API_NORMALIZATION_LAYERNORM_UTILS_H
...
#endif // AICORE_ADV_API_NORMALIZATION_LAYERNORM_UTILS_H