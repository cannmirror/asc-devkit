 ...
 * \brief
 */
#ifndef AICORE_ADV_API_NORMALIZATION_NORMALIZE_UTILS_H
#define AICORE_ADV_API_NORMALIZATION_NORMALIZE_UTILS_H
...
#endif // AICORE_ADV_API_NORMALIZATION_NORMALIZE_UTILS_H