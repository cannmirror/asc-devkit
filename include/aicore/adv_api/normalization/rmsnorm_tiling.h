 ...
 */
#ifndef AICORE_ADV_API_NORMALIZATION_RMSNORM_TILING_H
#define AICORE_ADV_API_NORMALIZATION_RMSNORM_TILING_H
 ...
 */
bool GetRmsNormMaxMinTmpSize(const ge::Shape& srcShape, const uint32_t typeSize, uint32_t& maxValue, uint32_t& minValue,
...
#endif // AICORE_ADV_API_NORMALIZATION_RMSNORM_TILING_H
