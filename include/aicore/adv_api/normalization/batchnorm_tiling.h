 ...
 */
#ifndef AICORE_ADV_API_NORMALIZATION_BATCHNORM_TILING_H
#define AICORE_ADV_API_NORMALIZATION_BATCHNORM_TILING_H
...
#endif // AICORE_ADV_API_NORMALIZATION_BATCHNORM_TILING_H
