 ...
 * \brief
 */
#ifndef AICORE_ADV_API_NORMALIZATION_NORMALIZE_TILING_H
#define AICORE_ADV_API_NORMALIZATION_NORMALIZE_TILING_H
...
void GetNormalizeMaxMinTmpSize(const ge::Shape& srcShape, const uint32_t typeSizeU, const uint32_t typeSizeT,
    const bool isReuseSource, const bool isComputeRstd, const bool isOnlyOutput, uint32_t& maxValue,
    uint32_t& minValue);
...
#endif // AICORE_ADV_API_NORMALIZATION_NORMALIZE_TILING_H
