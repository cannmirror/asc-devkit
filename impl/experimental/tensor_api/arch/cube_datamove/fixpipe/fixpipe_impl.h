...
__aicore__ inline typename Std::enable_if<VerifyingFixpipeTemplate<T, U>, void>::type Fixpipe(
    const T& dst, const U& src, const FixpipeParams& params = FixpipeParams{})
{
...
__aicore__ inline typename Std::enable_if<VerifyingFixpipeQuantTemplate<T, U, S>, void>::type Fixpipe(
    const T& dst, const U& src, const S& quant, const FixpipeParams& params = FixpipeParams{})
{
    constexpr Hardware dstPos = GetHardPos<T>();
    constexpr Hardware srcPos = GetHardPos<U>();
...
__aicore__ inline typename Std::enable_if<VerifyingFixpipeTemplateWithCoord<T, U, Coord>, void>::type Fixpipe(
    const T& dst, const U& src, const Coord& coord, const FixpipeParams& params = FixpipeParams{})
{
...
__aicore__ inline typename Std::enable_if<VerifyingFixpipeQuantTemplateWithCoord<T, U, S, Coord>, void>::type Fixpipe(
    const T& dst, const U& src, const S& quant, const Coord& coord, const FixpipeParams& params = FixpipeParams{})
{
    auto sliceTensor = dst(coord, src);
