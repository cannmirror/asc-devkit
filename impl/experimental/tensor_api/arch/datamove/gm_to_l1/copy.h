...
#if !defined(ASCENDC_TENSOR_API_INCLUDE_INCLUDE_COMPILER_INTERNAL_HEADERS)
#warning                                                                                                               \
...
#include "impl/experimental/tensor_api/arch/datamove/gm_to_l1/routing.h"
...
private:
    ...
    __aicore__ inline static void DataCopyImpl(const T& dst, const U& src)
    {
        ...
        using Tensor2Tensor = typename CopyGM2L1Tensor2Tensor<dstTPos, srcTPos, CURRENT_ARCH_VERSION>::type;
