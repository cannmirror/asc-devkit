...
#include "impl/experimental/tensor_api/arch/datamove/gm_to_ub/routing.h"
...
private:
    ...
    template <const CopyGM2UBTrait& trait = DEFAULT_COPY_GM_TO_UB_TRAIT, typename T, typename U, typename Coord>
