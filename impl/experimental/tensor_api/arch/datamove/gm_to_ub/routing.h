...
#include "impl/experimental/tensor_api/arch/datamove/gm_to_ub/npu_arch_3510/data_copy.h"
...
template <>
struct CopyGM2UBTensor2Tensor<Hardware::UB, Hardware::GM, ArchVersion::V3510> {
