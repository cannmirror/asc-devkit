...
#warning                                                                                                               \
    "impl/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/instruction.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_DATAMOVE_INSTRUCTION_H
#define IMPL_TENSOR_API_ARCH_DATAMOVE_INSTRUCTION_H

#include "impl/experimental/tensor_api/arch/utils/arch_utils.h"
#include "impl/experimental/tensor_api/arch/datamove/l0c_to_out/utils.h"
...
private:
                                                   ...
                                                   bool nz2dnEn)
    {
        ...
        if constexpr (CURRENT_ARCH_VERSION == ArchVersion::V3510) {
            copy_matrix_cc_to_gm(dst, src, 0, nSize, mSize, dstStride, srcStride, cacheMode, 0, unitFlag,
...
private:
    ...
    __aicore__ inline static void CopyMatrixCcToUb(__ubuf__ T* dst, __cc__ U* src, uint32_t nSize, uint32_t mSize,
                                                   ...
                                                   bool reluEn, uint8_t unitFlag, bool subBlockId, bool nz2ndEn,
                                                   bool nz2dnEn)
    {
        if ASCEND_IS_AIV {
            return;
        ...
        if constexpr (CURRENT_ARCH_VERSION == ArchVersion::V3510) {
            copy_matrix_cc_to_ub(dst, src, 0, nSize, mSize, dstStride, srcStride, dualDstCtl, subBlockId, 0, unitFlag,
                                 static_cast<uint64_t>(quantPre), reluEn, false, nz2ndEn,
                                 static_cast<uint64_t>(QuantMode_post::NoConv), 0, false, false, 0, false, false, false,
                                 false, false, nz2dnEn);
        }
    }
...
private:
    ...
    template <typename T>
    __aicore__ inline static void SetParamsToRegister(uint32_t dnNum, uint32_t dstDNStride, uint32_t srcNZMatrixStride,
...
#endif // IMPL_TENSOR_API_ARCH_DATAMOVE_INSTRUCTION_H
