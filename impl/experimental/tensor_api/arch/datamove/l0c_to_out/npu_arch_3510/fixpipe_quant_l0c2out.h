...
#warning                                                                                                               \
    "impl/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/fixpipe_quant_l0c2out.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_DATAMOVE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2OUT_H
#define IMPL_TENSOR_API_ARCH_DATAMOVE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2OUT_H

#include "impl/experimental/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/fixpipe_quant_l0c2out/nz2dn.h"
#include "impl/experimental/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/fixpipe_quant_l0c2out/nz2nd.h"
#include "impl/experimental/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/fixpipe_quant_l0c2out/nz2nz.h"
...
private:
    ...
    __aicore__ inline static void Execute(const T& dst, const U& src, const V& quant, const Params&... params)
    {
        ...
        using FixpipeQuantL0C2Out = typename FormatRegistorFixpipe2Out3510<GetDataFormat<T>(), GetDataFormat<U>(),
                                                                           GetQuantMode<quantPre>()>::type;
...
#endif // IMPL_TENSOR_API_ARCH_DATAMOVE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2OUT_H
