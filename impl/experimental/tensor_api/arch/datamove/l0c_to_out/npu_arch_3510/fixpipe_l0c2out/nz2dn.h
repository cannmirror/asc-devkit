...
#warning                                                                                                               \
    "impl/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/fixpipe_l0c2out/nz2dn.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_L0C2OUT_NZ2DN_H
#define IMPL_TENSOR_API_ARCH_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_L0C2OUT_NZ2DN_H

#include "impl/experimental/tensor_api/arch/datamove/l0c_to_out/npu_arch_3510/instruction.h"
...
private:
    ...
    __aicore__ inline static void DataCopyImpl(const T& dst, const U& src, const FixpipeParams& params)
    {
        ...
        uint32_t nSize =
            Std::min(GetEleFromLayout<decltype(srcLayout), AttrInfo::SHAPE, AttrInfo::COLUMN, 0>(srcLayout)
        ...
        uint32_t mSize =
            Std::min(GetEleFromLayout<decltype(srcLayout), AttrInfo::SHAPE, AttrInfo::ROW, 0>(srcLayout)
        ...
        if constexpr (GetHardPos<T>() == Hardware::GM) {
            ...
            CopyMatrixCcToGm3510::DataCopy<quantPre, T, U>(dst, src, nSize, mSize, srcStride, dstStride, cacheMode,
                                                           reluEn, unitFlag, isChannelSplit, nz2ndEn, nz2dnEn);
        } else {
            uint8_t dualDstCtl = trait.dualDstCtl;
            bool subBlockId = false;
            CopyMatrixCcToUb3510::DataCopy<quantPre, T, U>(dst, src, nSize, mSize, srcStride, dstStride, dualDstCtl,
...
#endif // IMPL_TENSOR_API_ARCH_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_L0C2OUT_NZ2DN_H
