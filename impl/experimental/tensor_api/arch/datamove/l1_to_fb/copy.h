...
#include "impl/experimental/tensor_api/arch/datamove/l1_to_fb/routing.h"
...
private:
    ...
    template <const CopyL12FBTrait& trait = DEFAULT_COPY_L1_FB_TRAIT, typename T, typename U, typename Coord>
