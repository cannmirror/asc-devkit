...
#include "impl/experimental/tensor_api/arch/datamove/ub_to_gm/npu_arch_3510/data_copy.h"
...
template <>
struct CopyUB2GMTensor2Tensor<Hardware::GM, Hardware::UB, ArchVersion::V3510> {
