...
/*!
 * \file tensor_tile_data_copy_four_dim_2201_l1_bt.h
 * \brief
 */
#ifndef IMPL_EXPERIMENTAL_TENSOR_API_ARCH_TILE_API_DATA_COPY_TENSOR_TILE_DATA_COPY_FOUR_DIM_2201_GM_BT_H
#define IMPL_EXPERIMENTAL_TENSOR_API_ARCH_TILE_API_DATA_COPY_TENSOR_TILE_DATA_COPY_FOUR_DIM_2201_GM_BT_H
...
private:
    ...
    {
        constexpr auto L12BT_UNIT = TileInternal::C0_SIZE * 2;
        ...
        uint16_t srcStride = (srcRow - dstCol) * sizeof(srcType) / TileInternal::C0_SIZE;
...
#endif // IMPL_EXPERIMENTAL_TENSOR_API_ARCH_TILE_API_DATA_COPY_TENSOR_TILE_DATA_COPY_FOUR_DIM_2201_GM_BT_H