...
#warning                                                                                                               \
    "impl/tensor_api/arch/data_copy_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_DATA_COPY_IMPL_H
#define IMPL_TENSOR_API_ARCH_DATA_COPY_IMPL_H

#include "impl/experimental/tensor_api/arch/cube_datamove/data_copy/data_copy_routing.h"
#include "impl/experimental/tensor_api/arch/vector_datamove/data_copy/data_copy_routing.h"
...
#endif // IMPL_TENSOR_API_ARCH_DATA_COPY_IMPL_H
