...
#warning                                                                                                               \
    "impl/tensor_api/arch/vector_datamove/data_copy/npu_arch_3510/data_copy_ub2l1.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
#define ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

/*!
 * \file data_copy_ub2l1.h
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_VECTOR_DATAMOVE_DATA_COPY_NPU_ARCH_3510_DATA_COPY_UB2L1_H
#define IMPL_TENSOR_API_ARCH_VECTOR_DATAMOVE_DATA_COPY_NPU_ARCH_3510_DATA_COPY_UB2L1_H
...
private:
    ...
    __aicore__ inline static void Execute(const T& dst, const U& src)
    {
        ...
        if constexpr (IsNZFormat<U>::value && IsNZFormat<T>::value) {
            ...
            // Next three parameters are in unit of 32B
            uint32_t blockLen = Std::ceil_division(
                GetEleFromLayout<decltype(srcLayout), AttrInfo::SHAPE, AttrInfo::ROW, 1>(srcLayout), C0_ELEMENT<SRC_TYPE>);
...
#endif // IMPL_TENSOR_API_ARCH_VECTOR_DATAMOVE_DATA_COPY_NPU_ARCH_3510_DATA_COPY_UB2L1_H
