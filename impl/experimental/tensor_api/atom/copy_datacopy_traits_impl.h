...
#warning                                                                                                               \
    "impl/tensor_api/atom/copy_datacopy_traits_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
#define ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

/*!
* \file copy_datacopy_traits_impl.h
* \brief
*/
#ifndef IMPL_TENSOR_API_ATOM_COPY_DATACOPY_TRAITS_IMPL_H
#define IMPL_TENSOR_API_ATOM_COPY_DATACOPY_TRAITS_IMPL_H
...
using CopyUB2GM = DataCopyOp;
using CopyUB2L1 = DataCopyOp;

}
}

#endif // IMPL_TENSOR_API_ATOM_COPY_DATACOPY_TRAITS_IMPL_H
