...
* \brief
*/
#ifndef EXPERIMENTAL_TENSOR_API_DETAIL_UTILS_CONSTANT_IMPL_H
#define EXPERIMENTAL_TENSOR_API_DETAIL_UTILS_CONSTANT_IMPL_H
...
#endif // EXPERIMENTAL_TENSOR_API_DETAIL_UTILS_CONSTANT_IMPL_H