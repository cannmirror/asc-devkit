...
*/
/*!
 * \file mmad_with_bias_four_dim_3510.h
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_CUBE_COMPUTE_MMAD_NPU_ARCH_3510_MMAD_WITH_BIAS_FOUR_DIM_3510_H
#define IMPL_TENSOR_API_ARCH_CUBE_COMPUTE_MMAD_NPU_ARCH_3510_MMAD_WITH_BIAS_FOUR_DIM_3510_H
...
private:
    ...
    __aicore__ inline auto GenParamsImpl(const T& dst, const U& fm, const S& filter, const V& bias)
    {
        ...
        auto params = Std::make_tuple(m, k, n, trait.unitFlag, disableGemv, cmatrixSource, 
...
#endif // IMPL_TENSOR_API_ARCH_CUBE_COMPUTE_MMAD_NPU_ARCH_3510_MMAD_WITH_BIAS_FOUR_DIM_3510_H