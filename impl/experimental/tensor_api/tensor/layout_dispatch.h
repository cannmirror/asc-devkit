...
struct TupleDispatcher<LayoutFormat::NZ, TupleFormat::Shape, T> {
    ...
    {
        return GetTuple(
            Std::Int<FRACTAL_FIXED>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<C0_ELEMENT<T>>{},
            Std::ceil_division(column, C0_ELEMENT<T>));
    }
};
...
struct TupleDispatcher<LayoutFormat::NZ, TupleFormat::Shape, Std::ignore_t> {
    ...
    {
        return GetTuple(
            Std::Int<FRACTAL_FIXED>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<C0_ELEMENT<uint16_t>>{},
            Std::ceil_division(column, C0_ELEMENT<uint16_t>));
    }
};
...
struct TupleDispatcher<LayoutFormat::ZN, TupleFormat::Shape, T> {
    ...
    {
        return GetTuple(
            Std::Int<C0_ELEMENT<T>>{}, Std::ceil_division(row, C0_ELEMENT<T>), Std::Int<FRACTAL_FIXED>{},
            Std::ceil_division(column, FRACTAL_FIXED));
    }
};
...
struct TupleDispatcher<LayoutFormat::ZZ, TupleFormat::Shape, fp8_e8m0_t> {
    ...
    {
        return GetTuple(
            Std::Int<FRACTAL_FIXED>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<MX_SCALE_K0>{},
            column / MX_SCALE_K0);
    }
};
...
struct TupleDispatcher<LayoutFormat::NN, TupleFormat::Shape, fp8_e8m0_t> {
    ...
    { // (scaleK, n)
        return GetTuple(
            Std::Int<MX_SCALE_K0>{}, row / MX_SCALE_K0, Std::Int<FRACTAL_FIXED>{},
            Std::ceil_division(column, FRACTAL_FIXED));
    }
};
...
struct TupleDispatcher<LayoutFormat::NZ, TupleFormat::Coord, T> {
    ...
    {
        return GetTuple(
            Std::Int<0>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<0>{},
            Std::ceil_division(column, C0_ELEMENT<T>));
    }
};
...
struct TupleDispatcher<LayoutFormat::ZN, TupleFormat::Coord, T> {
    ...
    {
        return GetTuple(
            Std::Int<0>{}, Std::ceil_division(row, C0_ELEMENT<T>), Std::Int<0>{},
            Std::ceil_division(column, FRACTAL_FIXED));
    }
};
...
struct TupleDispatcher<LayoutFormat::ZZ, TupleFormat::Coord, fp8_e8m0_t> {
    ...
    __aicore__ inline static decltype(auto) apply(U row, S column)
    {
        return GetTuple(Std::Int<0>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<0>{}, column / MX_SCALE_K0);
    }
};
...
struct TupleDispatcher<LayoutFormat::NN, TupleFormat::Coord, fp8_e8m0_t> {
    ...
    __aicore__ inline static decltype(auto) apply(U row, S column)
    { // (scaleK, n)
        return GetTuple(Std::Int<0>{}, row / MX_SCALE_K0, Std::Int<0>{}, Std::ceil_division(column, FRACTAL_FIXED));
    }
};
...
struct LayoutDispatcher<LayoutFormat::NZ, T> {
    ...
    __aicore__ inline static decltype(auto) apply(U row, S column)
    {
        ...
        return LayoutConstructor(
            Std::Int<FRACTAL_FIXED>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<c0Ele>{},
            Std::ceil_division(column, c0Ele), Std::Int<c0Ele>{}, Std::Int<c0Ele * FRACTAL_FIXED>{}, Std::Int<1>{},
            c0Ele * Std::ceil_align(row, FRACTAL_FIXED));
    }
};
...
struct LayoutDispatcher<LayoutFormat::ZN, T> {
    ...
    __aicore__ inline static decltype(auto) apply(U row, S column)
    {
        constexpr auto c0Ele = C0_ELEMENT<T>;
        return LayoutConstructor(
            Std::Int<c0Ele>{}, Std::ceil_division(row, c0Ele), Std::Int<FRACTAL_FIXED>{},
            Std::ceil_division(column, FRACTAL_FIXED), Std::Int<1>{}, c0Ele * Std::ceil_align(column, FRACTAL_FIXED),
...
struct LayoutDispatcher<LayoutFormat::DN, T> {
    ...
    {
        return LayoutConstructor(
            Std::Int<1>{}, row, Std::Int<1>{}, column, Std::Int<0>{}, Std::Int<1>{}, Std::Int<0>{}, row);
    }
};
...
struct LayoutDispatcher<LayoutFormat::DN, fp8_e8m0_t> {
    ...
    {
        return LayoutConstructor(
            Std::Int<1>{}, row, Std::Int<2>{}, column / MX_SCALE_K0, Std::Int<0>{}, Std::Int<MX_SCALE_K0>{},
            Std::Int<1>{}, MX_SCALE_K0 * row);
    }
};
...
struct LayoutDispatcher<LayoutFormat::ND, T> {
    ...
    {
        return LayoutConstructor(
            Std::Int<1>{}, row, Std::Int<1>{}, column, Std::Int<0>{}, column, Std::Int<0>{}, Std::Int<1>{});
    }
};
...
struct LayoutDispatcher<LayoutFormat::ND, fp8_e8m0_t> {
    ...
    {
        return LayoutConstructor(
            Std::Int<2>{}, row / MX_SCALE_K0, Std::Int<1>{}, column, Std::Int<1>{}, MX_SCALE_K0 * column, Std::Int<0>{},
            Std::Int<MX_SCALE_K0>{});
    }
};
...
struct LayoutDispatcher<LayoutFormat::ZZ, T> {
    ...
    __aicore__ inline static decltype(auto) apply(U row, S column)
    {
        ...
        return LayoutConstructor(
            Std::Int<FRACTAL_FIXED>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<c0Ele>{},
            Std::ceil_division(column, c0Ele), Std::Int<c0Ele>{}, FRACTAL_FIXED * Std::ceil_align(column, c0Ele),
...
struct LayoutDispatcher<LayoutFormat::ZZ, fp8_e8m0_t> {
    ...
    __aicore__ inline static decltype(auto) apply(U row, S column)
    {
        return LayoutConstructor(
            Std::Int<FRACTAL_FIXED>{}, Std::ceil_division(row, FRACTAL_FIXED), Std::Int<MX_SCALE_K0>{},
            column / MX_SCALE_K0, Std::Int<MX_SCALE_K0>{}, column * FRACTAL_FIXED, Std::Int<1>{},
            Std::Int<C0_SIZE<>>{});
    }
};
...
struct LayoutDispatcher<LayoutFormat::NN, fp8_e8m0_t> {
    ...
    { // (scaleK, n)
        return LayoutConstructor(
            Std::Int<MX_SCALE_K0>{}, row / MX_SCALE_K0, Std::Int<FRACTAL_FIXED>{},
            Std::ceil_division(column, FRACTAL_FIXED), Std::Int<1>{}, Std::Int<C0_SIZE<>>{}, Std::Int<MX_SCALE_K0>{},
            row * FRACTAL_FIXED);
    }
};
