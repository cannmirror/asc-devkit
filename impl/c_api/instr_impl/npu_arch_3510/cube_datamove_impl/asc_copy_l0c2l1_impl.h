...
__aicore__ inline void asc_copy_l0c2l1_impl(__cbuf__ void *dst, __cc__ float *src, uint16_t n_size,
            ...
            uint8_t unit_flag_mode, uint64_t quant_pre, uint8_t relu_pre, bool split_en, bool NZ2ND_en, uint64_t quant_post,
...
{
    if ASC_IS_AIC {
        copy_matrix_cc_to_cbuf_s4(dst, src, 0, n_size, m_size, loop_dst_stride, loop_src_stride, l2_cache_ctl, clip_relu_pre,
            unit_flag_mode, static_cast<QuantMode_t>(quant_pre), relu_pre, split_en, NZ2ND_en, static_cast<QuantMode_post>(quant_post),
...
__aicore__ inline void asc_copy_l0c2l1_sync_impl(__cbuf__ void *dst, __cc__ float *src, uint16_t n_size,
            ...
            bool C0_pad_en, bool broadcast_en, bool NZ2DN_en)
{
    asc_copy_l0c2l1_impl(dst, src, n_size, m_size, loop_dst_stride, loop_src_stride, l2_cache_ctl, clip_relu_pre,
        unit_flag_mode, quant_pre, relu_pre, split_en, NZ2ND_en, quant_post, relu_post, clip_relu_post,
