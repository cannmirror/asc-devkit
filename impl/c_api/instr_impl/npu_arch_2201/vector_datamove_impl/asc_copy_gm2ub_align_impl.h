...
// uint8_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ uint8_t* dst, __gm__ uint8_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b8((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
    }
}

__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ uint8_t* dst, __gm__ uint8_t* src, uint32_t size)
{
    asc_copy_gm2ub_align_impl(dst, src, ASC_C_API_DEFAULT_ZERO_VALUE, ASC_C_API_DEFAULT_NBURST, size, ASC_C_API_DEFAULT_ZERO_VALUE,
...
// int8_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ int8_t* dst, __gm__ int8_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b8((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
...
// half
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ half* dst, __gm__ half* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b16((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
    }
}
...
// bfloat16_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ bfloat16_t* dst, __gm__ bfloat16_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b16((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
...
// int16_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ int16_t* dst, __gm__ int16_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b16((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
...
// uint16_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ uint16_t* dst, __gm__ uint16_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b16((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
...
// uint32_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ uint32_t* dst, __gm__ uint32_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b32((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
    }
}
...
// int32_t
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ int32_t* dst, __gm__ int32_t* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b32((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
...
// float
__aicore__ inline void asc_copy_gm2ub_align_impl(__ubuf__ float* dst, __gm__ float* src, uint8_t sid, uint16_t n_burst, uint32_t len_burst,
            uint8_t left_padding_num, uint8_t right_padding_num, uint32_t src_gap, uint32_t dst_gap)
{
    if ASC_IS_AIV {
        copy_gm_to_ubuf_align_b32((__ubuf__ void*)dst, (__gm__ void*)src, sid, n_burst, len_burst, left_padding_num, right_padding_num, src_gap, dst_gap);
