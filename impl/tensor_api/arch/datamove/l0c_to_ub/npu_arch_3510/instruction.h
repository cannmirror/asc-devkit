...
public:
                                           ...
                                           uint8_t unitFlag, bool subBlockId, bool isChannelSplit, bool nz2ndEn, bool nz2dnEn)
    {
        ...
        if constexpr (CURRENT_ARCH_VERSION == ArchVersion::V3510) {
            asc_copy_l0c2ub(dst.Data().Get(), src.Data().Get(), static_cast<uint16_t>(nSize), static_cast<uint16_t>(mSize),
                                 dstStride, static_cast<uint16_t>(srcStride), dualDstCtl, subBlockId, 0, unitFlag,
