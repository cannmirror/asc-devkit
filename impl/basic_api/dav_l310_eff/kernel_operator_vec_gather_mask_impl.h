...
{
    ASCENDC_ASSERT(false, { KERNEL_LOG(KERNEL_ERROR, "unsupported Gather in this version"); });
}
...
{
    ASCENDC_ASSERT((false), "unsupported GetGatherMaskRemainCount in this version");
    return 0;
}
