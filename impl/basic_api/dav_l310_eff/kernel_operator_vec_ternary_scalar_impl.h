 ...
 * \brief AscendC l310 eff support vector ternary scalar api.
 */
...
{
    ASCENDC_ASSERT(false, { KERNEL_LOG(KERNEL_ERROR, "vector calculate is not supported on this version"); });
}
