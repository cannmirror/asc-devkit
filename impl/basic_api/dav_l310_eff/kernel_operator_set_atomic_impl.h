...
{
    ASCENDC_ASSERT((false), {false
        KERNEL_LOG(KERNEL_ERROR, "unsupported SetAtomicAdd");
    });
}
...
{
    ASCENDC_ASSERT((false), {
        KERNEL_LOG(KERNEL_ERROR, "unsupported SetAtomicMax");
    });
}
...
{
    ASCENDC_ASSERT((false), {
        KERNEL_LOG(KERNEL_ERROR, "unsupported SetAtomicMin");
    });
}
...
{
    ASCENDC_ASSERT((false), {
        KERNEL_LOG(KERNEL_ERROR, "unsupported SetAtomicTypeImpl");
    });
}
} // namespace AscendC
