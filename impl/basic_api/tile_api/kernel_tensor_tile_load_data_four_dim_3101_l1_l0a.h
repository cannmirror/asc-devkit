/**
 * Copyright (c) Huawei Technologies Co., Ltd. 2025. All rights reserved it.
...
/*!
 * \file kernel_acte_load_data_two_dim_3101_l1_l0a.h
 * \brief
 */
#ifndef IMPL_TILE_API_KERNEL_TENSOR_TILE_LOAD_DATA_FOUR_DIM_3101_L1_L0A_H
#define IMPL_TILE_API_KERNEL_TENSOR_TILE_LOAD_DATA_FOUR_DIM_3101_L1_L0A_H

#include "kernel_tensor_tile_utils.h"

namespace AscendC {
namespace TileInternal {
class LoadDataFourDim3101L12L0A {
public:
...
private:
    ...
    __aicore__ inline constexpr void CheckNZTemplate()
    {
        ...
        static_assert(Std::is_same_v<StrideRow0, Std::Int<C0_SIZE / sizeof(type)>>,
            "LoadDataFourDim3101L12L0A Layout->Stride->Row-ZeroDim is not Std::Int<C0Size/Type> type!");
        static_assert(Std::is_same_v<StrideColumn0, Std::Int<1>>,
            "LoadDataFourDim3101L12L0A Layout->Stride->Column->ZeroDim is not Std::Int<1> type!");
    }
    ...
    __aicore__ inline void LoadDataAlignV2Impl(const T& dst, const U& src, const V& tupleParams, Std::index_sequence<Is...>)
    {
        ...
        // MTE2
        LoadL1ToL0AAlignV2<srcType, trait.transposed>((__ca__ srcType*)dst.GetPhyAddr(), (__cbuf__ srcType*)src.GetPhyAddr(),
...
#endif // IMPL_TILE_API_KERNEL_TENSOR_TILE_LOAD_DATA_FOUR_DIM_3101_L1_L0A_H