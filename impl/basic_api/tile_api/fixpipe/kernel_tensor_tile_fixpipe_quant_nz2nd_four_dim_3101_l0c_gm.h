...
/*!
 * \file kernel_tensor_tile_fixpipe_quant_nz2nd_four_dim_3101_l0c_gm.h
 * \brief
 */
#ifndef IMPL_TENSOR_TILE_API_KERNEL_TENSOR_TILE_FIXPIPE_QUANT_NZ2ND_FOUR_DIM_3101_L0C_GM_H
#define IMPL_TENSOR_TILE_API_KERNEL_TENSOR_TILE_FIXPIPE_QUANT_NZ2ND_FOUR_DIM_3101_L0C_GM_H
...
class FixpipeNZ2NDSimpleQuant : public CopyMatrixCcToGmBase, public SetRegisterBase {
public:
...
class FixpipeNZ2NDVectorBase : public CopyMatrixCcToGmBase, public CopyDeqTensorToFbuf {
public:
...
class FixpipeNZ2NDVectorQuant : public FixpipeNZ2NDVectorBase, public SetRegisterBase {
public:
    template <typename T, typename U, typename V, const FixpipeTrait& trait>
    __aicore__ inline void Run(const T& dst, const U& src, const V& quant)
    {
...
#endif  // IMPL_TENSOR_TILE_API_KERNEL_TENSOR_TILE_FIXPIPE_QUANT_NZ2ND_FOUR_DIM_3101_L0C_GM_H
