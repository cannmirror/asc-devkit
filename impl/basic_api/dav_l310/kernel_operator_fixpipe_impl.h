...
{
    uint64_t config = 0;
    config |= ((((static_cast<uint64_t>(params.offset0) >> 9) & 0x7F) | (((static_cast<uint64_t>(params.offset0) >> 31) & 0x1) << 7)) |
        (static_cast<uint64_t>(GetScalarBitcodeValue(params.f16Multiplier)) & 0xFFFF) |
...
{
    uint64_t config = 0;
    config |= static_cast<uint64_t>(params.c0ChannelStride) & 0xFFFF;
...
{
    copy_matrix_cc_to_ub((__ubuf__ T*)dst, (__cc__ U*)src, 0,
        intriParams.nSize, intriParams.mSize, intriParams.dstStride,
        intriParams.srcStride, intriParams.preClipReluMode, intriParams.unitFlag,
        intriParams.quantParams.preQuantMode, intriParams.preReluMode, intriParams.channelSplitEnable,
        intriParams.nz2ndEnable, intriParams.quantParams.postQuantMode, intriParams.postReluMode,
