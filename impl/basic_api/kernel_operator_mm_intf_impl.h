    ...
    const LocalTensor<T>& dst, const LocalTensor<T>& src, const LoadData3DParamsV1<U>& loadDataParams)
{
    ...
    ASCENDC_CHECK_VALUE_RANGE(
        loadDataParams.c1Index, MIN_LOAD3D_C1_IDX, MAX_LOAD3D_C1_IDX, "c1Index", "LoadData with LoadData3DParamsV1");
    ASCENDC_CHECK_VALUE_RANGE(
        loadDataParams.fetchFilterW, MIN_LOAD3D_FETCH_FILTER, MAX_LOAD3D_FETCH_FILTER, "fetchFilterW",
        "LoadData with LoadData3DParamsV1");
    ASCENDC_CHECK_VALUE_RANGE(
        loadDataParams.fetchFilterH, MIN_LOAD3D_FETCH_FILTER, MAX_LOAD3D_FETCH_FILTER, "fetchFilterH",
        "LoadData with LoadData3DParamsV1");
    ASCENDC_CHECK_VALUE_RANGE(
        loadDataParams.leftTopW, MIN_LOAD3D_LEFT_TOP, MAX_LOAD3D_LEFT_TOP, "leftTopW",
        "LoadData with LoadData3DParamsV1");
    ASCENDC_CHECK_VALUE_RANGE(
        loadDataParams.leftTopH, MIN_LOAD3D_LEFT_TOP, MAX_LOAD3D_LEFT_TOP, "leftTopH",
        "LoadData with LoadData3DParamsV1");
    ASCENDC_CHECK_VALUE_RANGE(
        loadDataParams.jumpStride, MIN_LOAD3D_JUMP_STRIDE, MAX_LOAD3D_JUMP_STRIDE, "jumpStride",
        "LoadData with LoadData3DParamsV1");
