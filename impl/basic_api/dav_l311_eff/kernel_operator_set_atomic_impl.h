...
{
    ASCENDC_ASSERT(false, { KERNEL_LOG(KERNEL_ERROR, "SetAtomicNone is not supported on this device!"); });
}
// set_atomic_add
template <typename T>
...
{
    ASCENDC_ASSERT(false, { KERNEL_LOG(KERNEL_ERROR, "SetAtomicAdd is not supported on this device!"); });
}
...
{
    ASCENDC_ASSERT(false, { KERNEL_LOG(KERNEL_ERROR, "SetAtomicMax is not supported on this device!"); });
}
...
{
    ASCENDC_ASSERT(false, { KERNEL_LOG(KERNEL_ERROR, "SetAtomicMin is not supported on this device!"); });
}
