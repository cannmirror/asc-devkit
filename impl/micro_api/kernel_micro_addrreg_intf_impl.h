...
#include "micro_api/dav_l210/kernel_micro_addrreg_impl.h"
#elif __NPU_ARCH__ == 3003
#include "micro_api/dav_l300/kernel_micro_addrreg_impl.h"
#elif __NPU_ARCH__ == 3103
#include "micro_api/dav_l310/kernel_micro_addrreg_impl.h"
...
template <typename T>
__aicore__ inline AddrReg CreateAddrReg(uint16_t index0, uint16_t stride0, uint16_t index1, uint16_t stride1, uint16_t index2, uint16_t stride2)
{
...
template <typename T>
__aicore__ inline AddrReg CreateAddrReg(uint16_t index0, uint16_t stride0, uint16_t index1, uint16_t stride1, uint16_t index2, uint16_t stride2,
    uint16_t index3, uint16_t stride3)
{
