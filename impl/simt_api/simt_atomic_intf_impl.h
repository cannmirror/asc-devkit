...
#ifndef ASCENDC_MODULE_SIMT_C_ATOMIC_INTERFACE_IMPL_H
#define ASCENDC_MODULE_SIMT_C_ATOMIC_INTERFACE_IMPL_H
...
{
    return AscendC::Simt::AtomicAddImpl(address, val);
}
...
{
    return AscendC::Simt::AtomicSubImpl(address, val);
}
...
{
    return AscendC::Simt::AtomicExchImpl(address, val);
}
...
{
    return AscendC::Simt::AtomicMaxImpl(address, val);
}
...
{
    return AscendC::Simt::AtomicMinImpl(address, val);
}
...
{
    return AscendC::Simt::AtomicIncImpl(address, val);
}
#endif
...
{
    return AscendC::Simt::AtomicDecImpl(address, val);
}
#endif
...
{
    return AscendC::Simt::AtomicCasImpl(address, compare, val);
}
...
{
    return AscendC::Simt::AtomicAndImpl(address, val);
}
...
{
    return AscendC::Simt::AtomicOrImpl(address, val);
}
