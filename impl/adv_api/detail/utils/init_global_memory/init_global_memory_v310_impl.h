...
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_UTILS_INIT_GLOBAL_MEMORY_INIT_GLOBAL_MEMORY_V310_IMPL_H
#endif
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_UTILS_INIT_GLOBAL_MEMORY_INIT_GLOBAL_MEMORY_V310_IMPL_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_UTILS_INIT_GLOBAL_MEMORY_INIT_GLOBAL_MEMORY_V310_IMPL_H
#endif
