...
/*!
 * \file arithprogression_l300_impl.h
 * \brief
 */
#ifndef IMPL_INDEX_ARITHPROGRESSION_ARITHPROGRESSION_L300_IMPL_H
#define IMPL_INDEX_ARITHPROGRESSION_ARITHPROGRESSION_L300_IMPL_H
