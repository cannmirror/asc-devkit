...
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LGAMMA_CHECK_COMMON_H
#endif
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LGAMMA_CHECK_COMMON_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LGAMMA_CHECK_COMMON_H
#endif
