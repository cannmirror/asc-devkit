...
template <HcclServerType serverType, const auto &config>
template <bool commit>
__aicore__ inline HcclHandle Hccl<serverType, config>::AlltoAllvWrite(GM_ADDR usrIn, GM_ADDR sendOffsets,
...
template <HcclServerType serverType, const auto &config>
template <bool sync>
__aicore__ inline int32_t Hccl<serverType, config>::Iterate(HcclHandle handleId, uint16_t *seqSlices,
