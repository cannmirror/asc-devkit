...
static const std::set<uint32_t> SUPPORT_TYPESIZE = { LOGICAL_AND_UINT8_SIZE, LOGICAL_AND_UINT16_SIZE, LOGICAL_AND_UINT32_SIZE, LOGICAL_AND_UINT64_SIZE};
    ...
    const uint32_t typeSize, const bool isReuseSource, uint32_t& maxValue, uint32_t& minValue)
{
    ...
    ASCENDC_HOST_ASSERT((socVersion == platform_ascendc::SocVersion::ASCEND910_95 ||
        ...
        return, "Unsupported SocVersion of LogicalAnd API.");
    maxValue = 0u;
    minValue = 0u;
}
