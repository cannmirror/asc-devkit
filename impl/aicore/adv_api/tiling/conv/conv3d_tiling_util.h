...
#ifndef AICORE_ADV_API_TILING_CONV_CONV3D_TILING_UTIL_H
#define AICORE_ADV_API_TILING_CONV_CONV3D_TILING_UTIL_H
...
const std::map<ConvCommonApi::ConvDtype, std::string> g_dtypeToStr = {{ConvCommonApi::ConvDtype::FLOAT16, "float16"},
    {ConvCommonApi::ConvDtype::FLOAT32, "float32"}, {ConvCommonApi::ConvDtype::BF16, "bfloat16"},
    {ConvCommonApi::ConvDtype::INT4, "int4"}, {ConvCommonApi::ConvDtype::INT8, "int8"},
    {ConvCommonApi::ConvDtype::UINT8, "uint8"}, {ConvCommonApi::ConvDtype::INT64, "int64"},
    {ConvCommonApi::ConvDtype::UINT64, "uint64"}, {ConvCommonApi::ConvDtype::INT32, "int32"},
    {ConvCommonApi::ConvDtype::CONVDTYPEMAX, "UNKNOWN_DTYPE"}};

const std::map<ConvCommonApi::ConvFormat, std::string> g_formatToStr = {{ConvCommonApi::ConvFormat::NCHW, "NCHW"},
    {ConvCommonApi::ConvFormat::NHWC, "NHWC"}, {ConvCommonApi::ConvFormat::HWCN, "HWCN"},
    {ConvCommonApi::ConvFormat::DHWNC, "DHWNC"}, {ConvCommonApi::ConvFormat::DHWCN, "DHWCN"},
    {ConvCommonApi::ConvFormat::NDHWC, "NDHWC"}, {ConvCommonApi::ConvFormat::NCDHW, "NCDHW"},
    {ConvCommonApi::ConvFormat::NC1HWC0, "NC1HWC0"}, {ConvCommonApi::ConvFormat::ND, "ND"},
    {ConvCommonApi::ConvFormat::NDC1HWC0, "NDC1HWC0"}, {ConvCommonApi::ConvFormat::FRACTAL_Z_3D, "FRACTAL_Z_3D"},
    {ConvCommonApi::ConvFormat::MAX, "UNKNOWN_FORMAT"}};

const std::map<ConvCommonApi::ConvDtype, uint32_t> g_dtypeSizeTab = {{ConvCommonApi::ConvDtype::FLOAT16, 2},
    {ConvCommonApi::ConvDtype::FLOAT32, 4}, {ConvCommonApi::ConvDtype::BF16, 2}, {ConvCommonApi::ConvDtype::INT8, 1},
    {ConvCommonApi::ConvDtype::UINT8, 1}, {ConvCommonApi::ConvDtype::INT64, 8}, {ConvCommonApi::ConvDtype::UINT64, 8},
...
const std::map<platform_ascendc::SocVersion, std::string> SOC_NAME_TAB = {
    {platform_ascendc::SocVersion::ASCEND910, "ASCEND910"}, {platform_ascendc::SocVersion::ASCEND910B, "ASCEND910B"},
    {platform_ascendc::SocVersion::ASCEND910_93, "ASCEND910_93"},
    {platform_ascendc::SocVersion::ASCEND310P, "ASCEND310P"}, {platform_ascendc::SocVersion::ASCEND310B, "ASCEND310B"},
...
bool IsArrayEqual(const std::vector<ConvCommonApi::ConvDtype>& arr1, const std::vector<ConvCommonApi::ConvDtype>& arr2,
    uint32_t size);
