...
bool Conv3dBpFilterTiling::IsCurBlockL1L0Invalid()
{
    ...
    // 再判断L1合法性
    uint64_t al1LoadSize = blockTiling_.stepKa * blockTiling_.blockBaseK * blockTiling_.stepM * blockTiling_.blockBaseM
                           * dtypeByte_ * blockTiling_.dbL1A;
...
bool Conv3dBpFilterTiling::ShrinkBlockBaseK()
{
    ...
    uint64_t deltaBl1PerC0 =
        CeilDiv(bL1Cin1CopyLen * fractalSize0 * shapeInfo.orgWi * attrInfo.strideH * fractalSize0 * dtypeByte_,
...
void Conv3dBpFilterTiling::ShrinkBaseBlock()
{
    ...
    // M方向回调
    uint64_t fractalSize0 = shapeCalc.channelSize;
    uint32_t al1LoadSize = blockTiling_.stepKa * blockTiling_.blockBaseK * blockTiling_.stepM * blockTiling_.blockBaseM
                           * dtypeByte_ * blockTiling_.dbL1A;
