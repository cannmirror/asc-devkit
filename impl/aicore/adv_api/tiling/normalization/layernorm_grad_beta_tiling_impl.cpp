...
{
    ASCENDC_HOST_ASSERT(typeSize == LAYERNORM_GRAD_BETA_HALF_SIZE || typeSize == LAYERNORM_GRAD_BETA_FLOAT_SIZE, return,
    ...
    const bool isReuseSource, optiling::LayerNormGradBetaTiling& tiling)
{
    ...
    ASCENDC_HOST_ASSERT((tilingTmp.stackBufferSize >= (tilingTmp.hLength + tilingTmp.hLength)), return,
