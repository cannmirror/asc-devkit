 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_NORMALIZATION_LAYERNORMGRAD_LAYERNORMGRADBETA_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_NORMALIZATION_LAYERNORMGRAD_LAYERNORMGRADBETA_C310_IMPL_H
...
__aicore__ inline void LayerNormGradBetaCheckParams(const LocalTensor<T>& outputPdGamma,
    ...
    const LayerNormGradBetaTiling& tiling)
{
    ...
    VF_CALL<LayerNormGradBetaAPI::ReduceSumN<T>>(
...
#endif // AICORE_ADV_API_DETAIL_NORMALIZATION_LAYERNORMGRAD_LAYERNORMGRADBETA_C310_IMPL_H
