 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_NORMALIZATION_LAYERNORMGRAD_LAYERNORMGRADBETA_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_NORMALIZATION_LAYERNORMGRAD_LAYERNORMGRADBETA_COMMON_IMPL_H
    ...
    const LayerNormGradBetaTiling& tiling)
{
    ...
    CHECK_FUNC_HIGHLEVEL_API(LayerNormGradBeta, (T, isReuseSource),
...
#endif // AICORE_ADV_API_DETAIL_NORMALIZATION_LAYERNORMGRAD_LAYERNORMGRADBETA_COMMON_IMPL_H