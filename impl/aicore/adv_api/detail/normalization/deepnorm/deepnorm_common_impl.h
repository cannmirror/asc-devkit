 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_NORMALIZATION_DEEPNORM_DEEPNORM_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_NORMALIZATION_DEEPNORM_DEEPNORM_COMMON_IMPL_H
...
template <bool isBasicBlock = false>
__aicore__ inline void GetDeepNormOutputPre(const LocalTensor<float>& xSubMean, const LocalTensor<float>& inputVariance,
...
{
    CHECK_FUNC_HIGHLEVEL_API(DeepNorm, (T, isReuseSrc, isBasicBlock),
    ...
    DeepNormTiling& tiling)
{
    ...
    DeepNormImpl<T, isReuseSrc, isBasicBlock>(dstLocal, meanLocal, rstdLocal, srcLocal, gxLocal, betaLocal, gammaLocal,
        sharedTmpBuffer, alpha, epsilon, tiling);
}

} // namespace DeepNormAPI
} // namespace AscendC
#endif // AICORE_ADV_API_DETAIL_NORMALIZATION_DEEPNORM_DEEPNORM_COMMON_IMPL_H
