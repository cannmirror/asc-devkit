 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_COMMON_PRE_IMPL_H
#define AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_COMMON_PRE_IMPL_H
...
__aicore__ inline void GetBatchNormOutputPreProcess(const LocalTensor<float>& addSrc, const LocalTensor<float>& addDst,
    const LocalTensor<float>& tmpDst, const float epsilon, const BatchNormTiling& tiling)
{
...
#endif // AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_COMMON_PRE_IMPL_H
