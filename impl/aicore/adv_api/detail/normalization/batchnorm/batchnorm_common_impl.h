 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_COMMON_IMPL_H
...
__aicore__ inline void BatchNormCompute(const LocalTensor<T>& inputX, const LocalTensor<T>& gamm,
    ...
    const LocalTensor<T>& outputVariance, const T epsilon, BatchNormTiling& tiling, BatchNormParams<float>& params)
{
...
#endif // AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_COMMON_IMPL_H
