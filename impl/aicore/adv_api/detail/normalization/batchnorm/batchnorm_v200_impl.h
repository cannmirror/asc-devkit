 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_V200_IMPL_H
#define AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_V200_IMPL_H
    ...
    const BatchNormTiling& tiling, const BatchNormParams<float>& batchnormParams)
{
    ...
    for (int32_t n = 0; n < NCHW_ADDR_LIST_SIZE; n++) { srcLocalList[n] = (uint64_t)src.GetPhyAddr(); }
...
#endif // AICORE_ADV_API_DETAIL_NORMALIZATION_BATCHNORM_BATCHNORM_V200_IMPL_H
