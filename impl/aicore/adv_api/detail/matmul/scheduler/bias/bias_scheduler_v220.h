...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BIAS_BIAS_SCHEDULER_V220_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BIAS_BIAS_SCHEDULER_V220_H
...
class BiasScheduler<IMPL, A_TYPE, B_TYPE, BIAS_TYPE, MM_CFG,
