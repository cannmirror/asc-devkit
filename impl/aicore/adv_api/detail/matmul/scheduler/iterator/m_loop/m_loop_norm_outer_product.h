...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_NORM_OUTER_PRODUCT_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_NORM_OUTER_PRODUCT_H
...
class MLoop<IMPL, A_TYPE, MM_CFG,
    enable_if_t<(
        isNormEnableScheduler<A_TYPE, MM_CFG> || IsBmmSingleScheduler<A_TYPE, MM_CFG>)&&MatmulFeatureTrait<MM_CFG>()
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_NORM_OUTER_PRODUCT_H
