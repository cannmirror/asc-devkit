...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_MDL_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_MDL_H
...
class MLoop<IMPL, A_TYPE, MM_CFG,
    enable_if_t<(DoMatmulMDL(MM_CFG) && !MatmulFeatureTrait<MM_CFG>().IsSupportMNL0DB()) || DoMatmulSpecialMDL(MM_CFG)>>
