...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_MDL_BASE_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_M_LOOP_M_LOOP_MDL_BASE_H
...
private:
        ...
        AscendC::Std::integral_constant<PolicyType, P>)
    {
        ...
        outerIter_ =
            Ceil(ToMatmulConfig(MM_CFG).singleCoreM, ToMatmulConfig(MM_CFG).basicM * ToMatmulConfig(MM_CFG).stepM);
