 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_REORDER_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_REORDER_H
...
class KLoop<IMPL, TRANS_T, A_TYPE, MM_CFG,
    enable_if_t<!MatmulFeatureTrait<MM_CFG>::IsNeedUB() && DoMatmulMDL(MM_CFG)
                && IsKdimReorderLoad<MM_CFG> && !HasScalePosition<A_TYPE>::value>>
