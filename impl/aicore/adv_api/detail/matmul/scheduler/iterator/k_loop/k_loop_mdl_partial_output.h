 ...
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_PARTIAL_OUTPUT_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_PARTIAL_OUTPUT_H
...
class KLoop<IMPL, TRANS_T, A_TYPE, MM_CFG, enable_if_t<DoMatmulMDL(MM_CFG) && ToMatmulConfig(MM_CFG).isPartialOutput>>
