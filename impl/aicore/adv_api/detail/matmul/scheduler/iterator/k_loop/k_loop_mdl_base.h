 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_BASE_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_BASE_H
...
protected:
        ...
        int32_t singleShape, AscendC::Std::integral_constant<PolicyType, P>)
    {
        ...
        ASCENDC_ASSERT((kaStepFactor_ >= 1 && kbStepFactor_ >= 1), {
            KERNEL_LOG(KERNEL_ERROR, "kaStepFactor_ %d and kbStepFactor_ %d should be no less than 1", kaStepFactor_,
                kbStepFactor_);
        });
