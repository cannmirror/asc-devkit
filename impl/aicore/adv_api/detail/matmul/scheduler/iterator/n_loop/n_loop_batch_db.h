...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_BATCH_DB_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_BATCH_DB_H
...
class NLoop<IMPL, INPUT_TYPE, MM_CFG,
    enable_if_t<(IsBmmBatchScheduler<INPUT_TYPE,
                     MM_CFG> && (ToMatmulConfig(MM_CFG).scheduleType == ScheduleType::OUTER_PRODUCT))>> {
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_BATCH_DB_H