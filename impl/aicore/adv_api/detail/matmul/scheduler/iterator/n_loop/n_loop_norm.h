...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_NORM_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_NORM_H
...
class NLoop<IMPL, A_TYPE, MM_CFG,
    enable_if_t<(isNormEnableScheduler<A_TYPE, MM_CFG> || DoMatmulIBShareNorm(MM_CFG))
