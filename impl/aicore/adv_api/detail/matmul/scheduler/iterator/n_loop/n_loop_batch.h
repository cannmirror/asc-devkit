...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_BATCH_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_BATCH_H
...
class NLoop<IMPL, INPUT_TYPE, MM_CFG,
    enable_if_t<IsBmmEnableScheduler<INPUT_TYPE,
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_BATCH_H
