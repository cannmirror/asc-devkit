...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_MDL_BASE_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_MDL_BASE_H
...
private:
    __aicore__ inline void SetSingleShapeFromCFG()
    {
        ...
        outerIter_ =
            Ceil(ToMatmulConfig(MM_CFG).singleCoreN, ToMatmulConfig(MM_CFG).basicN * ToMatmulConfig(MM_CFG).stepN);
