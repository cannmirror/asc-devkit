 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BATCH_BATCH_SCHEDULER_INTF_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BATCH_BATCH_SCHEDULER_INTF_H
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BATCH_BATCH_SCHEDULER_INTF_H