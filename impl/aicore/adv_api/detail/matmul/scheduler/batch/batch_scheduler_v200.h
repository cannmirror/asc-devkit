 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BATCH_BATCH_SCHEDULER_V200_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BATCH_BATCH_SCHEDULER_V200_H
...
class BatchScheduler<IMPL, A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, MM_CFG,
    enable_if_t<MatmulFeatureTrait<MM_CFG>::IsNeedUB() && !MatmulFeatureTrait<MM_CFG>::IsSupportCmatrixInitVal()
                && DoMatmulNorm(MM_CFG)
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BATCH_BATCH_SCHEDULER_V200_H