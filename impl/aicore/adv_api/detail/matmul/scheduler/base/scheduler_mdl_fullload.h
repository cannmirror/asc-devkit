 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_MDL_FULLLOAD_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_MDL_FULLLOAD_H
...
class MatmulScheduler<IMPL, A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, MM_CFG, POLICY_TYPE,
    enable_if_t<DoMatmulMDL(MM_CFG) && POLICY_TYPE != PolicyType::MATMUL_NBUFFER_33
                && !isMxMatmul<A_TYPE, B_TYPE> && !ToMatmulConfig(MM_CFG).isPartialOutput
                && (IsAFullLoad(MM_CFG) || IsBFullLoad(MM_CFG))>>
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_MDL_FULLLOAD_H
