 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_N_BUFFER_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_N_BUFFER_H
...
class MatmulScheduler<IMPL, A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, MM_CFG, POLICY_TYPE,
    enable_if_t<!MatmulFeatureTrait<MM_CFG>::IsNeedUB() && DoMatmulMDL(MM_CFG)
                && POLICY_TYPE == PolicyType::MATMUL_NBUFFER_33>>
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_N_BUFFER_H
