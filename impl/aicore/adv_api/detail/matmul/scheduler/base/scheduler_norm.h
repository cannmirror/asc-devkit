 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_NORM_H
#define AICORE_ADV_API_DETAIL_MATMUL_SCHEDULER_BASE_SCHEDULER_NORM_H
    ...
    enable_if_t<
        (DoMatmulIBShareNorm(MM_CFG)
            || isNormEnableScheduler<A_TYPE,
                MM_CFG> || isSingleLargeBMM<A_TYPE, MM_CFG> || IsBasicBlockEnable<MM_CFG>)&&!MatmulFeatureTrait<MM_CFG>()
            .IsSupportMNL0DB()
