 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_L0_BUFFER_TBUF_POOL_L0_CACHE_H
#define AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_L0_BUFFER_TBUF_POOL_L0_CACHE_H
...
class TBufPoolL0<IMPL, A_TYPE, B_TYPE, MM_CFG,
    enable_if_t<!MatmulFeatureTrait<MM_CFG>::IsNeedUB()
                && (DoMatmulMDL(MM_CFG) || isNormEnableScheduler<A_TYPE, MM_CFG>)&&IsL0Cache<A_TYPE, MM_CFG>()>>
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_L0_BUFFER_TBUF_POOL_L0_CACHE_H
