 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_L0_BUFFER_TBUF_POOL_L0_BASE_H
#define AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_L0_BUFFER_TBUF_POOL_L0_BASE_H
    ...
    __aicore__ inline void Init()
    {
        ...
        if constexpr (NormInitScene<MM_CFG> && Impl::Detail::MatmulFeatureTrait<MM_CFG>().IsSupportMNL0DB()) {
            isL0Db = true;
                             ...
                             && NormInitScene<
                                 MM_CFG> && Impl::Detail::MatmulFeatureTrait<MM_CFG>().IsSupportLoad2dV2()) {
            isL0Db = false;
        } else {
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_L0_BUFFER_TBUF_POOL_L0_BASE_H
