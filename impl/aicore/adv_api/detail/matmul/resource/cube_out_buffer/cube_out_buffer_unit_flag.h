 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_CUBE_OUT_BUFFER_CUBE_OUT_BUFFER_UNIT_FLAG_H
#define AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_CUBE_OUT_BUFFER_CUBE_OUT_BUFFER_UNIT_FLAG_H
...
class CubeOutBuffer<IMPL, A_TYPE, B_TYPE, L0cT, C_TYPE, MM_CFG,
    enable_if_t<MatmulFeatureTrait<MM_CFG>::IsUnitFlagEnabled() && !ToMatmulConfig(MM_CFG).isCO1Shared
                && !PhyPosIsL0C(C_TYPE::pos) && !IsMxEnableUnitFlag<A_TYPE, B_TYPE>>> {
public:
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_CUBE_OUT_BUFFER_CUBE_OUT_BUFFER_UNIT_FLAG_H
