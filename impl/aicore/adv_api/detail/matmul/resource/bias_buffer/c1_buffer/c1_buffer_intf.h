 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_BIAS_BUFFER_C1_BUFFER_C1_BUFFER_INTF_H
#define AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_BIAS_BUFFER_C1_BUFFER_C1_BUFFER_INTF_H
