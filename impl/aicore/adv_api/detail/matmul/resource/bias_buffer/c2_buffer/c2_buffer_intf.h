 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_BIAS_BUFFER_C2_BUFFER_C2_BUFFER_INTF_H
#define AICORE_ADV_API_DETAIL_MATMUL_RESOURCE_BIAS_BUFFER_C2_BUFFER_C2_BUFFER_INTF_H
