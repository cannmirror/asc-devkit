 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_KFC_MATMUL_SERVER_IMPL_C310_H
#define AICORE_ADV_API_DETAIL_MATMUL_KFC_MATMUL_SERVER_IMPL_C310_H
    ...
    MSG_POS KfcMsg* msg)
{
    ...
    if constexpr (!ToMatmulConfig(MM_CFG).enableInit) {
        ...
        for (int i = 0; i < sizeof(TCubeTiling) / sizeof(uint64_t); i++, temp1++, temp2++) { *temp2 = *temp1; }
