...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_SHAPE_INFO_H
#define AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_SHAPE_INFO_H
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_SHAPE_INFO_H
