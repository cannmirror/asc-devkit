 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_USR_DEFINE_INFO_H
#define AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_USR_DEFINE_INFO_H
...
class MatmulUserDefineInfo<IMPL, MM_CFG, USER_DEF_DATA_TYPE,
    enable_if_t<MatmulFeatureTrait<MM_CFG>::IsSupportUserDefine()>> {
public:
    __aicore__ inline void SetSelfDefineData(USER_DEF_DATA_TYPE dataPtr)
    {
        dataPtr_ = dataPtr;
