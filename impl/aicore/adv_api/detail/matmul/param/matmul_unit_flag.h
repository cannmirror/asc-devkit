...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_UNIT_FLAG_H
#define AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_UNIT_FLAG_H
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_PARAM_MATMUL_UNIT_FLAG_H
