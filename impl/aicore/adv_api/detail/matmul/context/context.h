...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_CONTEXT_CONTEXT_H
#define AICORE_ADV_API_DETAIL_MATMUL_CONTEXT_CONTEXT_H
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_CONTEXT_CONTEXT_H