 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_POLICY_MATMUL_PRIVATE_MODULES_H
#define AICORE_ADV_API_DETAIL_MATMUL_POLICY_MATMUL_PRIVATE_MODULES_H
...
struct MatmulPrivateModules {
    ...
    using UserDefDataType = typename Conditional<MatmulFeatureTrait<MM_CFG>::IsSupportUBToL1Singleshape(),
        UserDefDataTypeFromPolicy, uint64_t>::type;
    ...
    using MmadCompute = AscendC::Impl::Detail::MmadCompute<IMPL, L0cT, L0aT, L0bT, MM_CFG>;
