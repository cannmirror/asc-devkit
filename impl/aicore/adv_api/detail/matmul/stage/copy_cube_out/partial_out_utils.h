...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_PARTIAL_OUT_UTILS_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_PARTIAL_OUT_UTILS_H
...
public:
    ...
    __aicore__ inline void CopyOut()
    {
        ...
        cacheWorkspace.SetGlobalBuffer(reinterpret_cast<__gm__ DstT*>(cacheWorkspaceAddr_));
        ...
        MATMUL_MODULE(CopyCubeOut)
            ->template Copy<true>(cacheWorkspace[l0cOffsetSize_], co1Local, MATMUL_MODULE(MLoop)->GetInnerIdx(),
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_PARTIAL_OUT_UTILS_H
