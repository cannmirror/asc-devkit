...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_COPY_CUBE_OUT_INTF_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_COPY_CUBE_OUT_INTF_H
...
template <typename IMPL, class A_TYPE, class B_TYPE, class C_TYPE, const auto& MM_CFG,
    McgShfMode FIXPIPE_MODE = McgShfMode::SINGLE_DST_MODE, typename = void,
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_COPY_CUBE_OUT_INTF_H
