...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_COPY_CUBE_OUT_ATOP_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_OUT_COPY_CUBE_OUT_ATOP_H
...
class CopyCubeOut<IMPL, A_TYPE, B_TYPE, C_TYPE, MM_CFG, FIXPIPE_MODE,
    enable_if_t<!AscendC::Impl::Detail::IsQuantSenario<typename C_TYPE::T, typename A_TYPE::T>()>, CopyOut> {
