...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_PARAMS_MX_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_PARAMS_MX_H
...
public:
    ...
    {
        return MATMUL_MODULE(MatmulShapeTiling)->GetTiling().GetScaleFactorA();
    }
...
public:
    ...
    __aicore__ inline int GetScaleFactor() const
    {
        return MATMUL_MODULE(MatmulShapeTiling)->GetTiling().GetScaleFactorB();
    }
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_PARAMS_MX_H
