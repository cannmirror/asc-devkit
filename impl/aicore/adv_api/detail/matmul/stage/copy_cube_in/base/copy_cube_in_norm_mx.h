...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_NORM_MX_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_NORM_MX_H
...
class CopyCubeIn<IMPL, INPUT_TYPE, MM_CFG,
    enable_if_t<!MatmulFeatureTrait<MM_CFG>::IsNeedUB()
                && GetCopyCubeInType<INPUT_TYPE, MM_CFG>() == CopyCubeInType::MX_NORM>>
