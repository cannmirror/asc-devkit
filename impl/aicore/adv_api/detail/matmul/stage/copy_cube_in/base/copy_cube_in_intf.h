...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_INTF_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_INTF_H
...
public:
    ...
    __aicore__ inline LocalTensor<TransT> LoadData(
        int curRow, int curCol, int tileHeight, int tileWidth, const ScheduleContext& context = {})
    {
