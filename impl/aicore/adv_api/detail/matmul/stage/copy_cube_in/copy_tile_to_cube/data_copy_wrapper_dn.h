...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_COPY_TILE_TO_CUBE_DATA_COPY_WRAPPER_DN_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_COPY_TILE_TO_CUBE_DATA_COPY_WRAPPER_DN_H
...
public:
        ...
        const int32_t srcDnMatrixStride = 0, const int32_t dstNzMatrixStride = 0, const bool kAlignToC0Size = false)
    {
        ...
        static_assert(!IsStaticPaddingEnable(MM_CFG), "Unsupported Static Padding for DN2NZ.");
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_COPY_TILE_TO_CUBE_DATA_COPY_WRAPPER_DN_H
