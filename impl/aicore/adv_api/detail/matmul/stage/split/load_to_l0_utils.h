...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0_UTILS_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0_UTILS_H
...
__aicore__ inline constexpr LoadInstrType GetLoadInstrType()
{
    ...
    if constexpr (MatmulFeatureTrait<MM_CFG>::IsSupportLoad2dTranspose() && IsSameTypeV<A_T, int8_t>) {
...
{
    return (A_TYPE::format == CubeFormat::VECTOR) ?
               GemvMode::VECTOR :
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0_UTILS_H
