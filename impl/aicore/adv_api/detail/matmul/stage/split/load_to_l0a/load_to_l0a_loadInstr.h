...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0A_LOAD_TO_L0A_LOADINSTR_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0A_LOAD_TO_L0A_LOADINSTR_H
...
class LoadToL0A<IMPL, A_TYPE, MM_CFG,
    enable_if_t<
        GetGemvMode<A_TYPE>() == GemvMode::MATRIX && !(DoMatmulBasicBlock(MM_CFG) || DoMatmulSpecialBasicBlock(MM_CFG))
...
public:
    ...
    __aicore__ inline void Load(const LocalTensor<A_T>& l0A, const LocalTensor<A_T>& l1A, uint16_t aL1M, uint16_t aL1K,
        uint16_t madM, uint16_t madK, uint16_t aL1MOffset, uint16_t aL1KOffset, bool isATranspose,
...
private:
    ...
    __aicore__ inline void TransLoadDataToL0(const LocalTensor<A_T>& l0A, const LocalTensor<A_T>& l1A, uint16_t aL1M,
    ...
    __aicore__ inline void LoadDataToL0(const LocalTensor<A_T>& l0A, const LocalTensor<A_T>& l1A, uint16_t aL1K,
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0A_LOAD_TO_L0A_LOADINSTR_H