...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0A_LOAD_TO_L0A_LOAD2D_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0A_LOAD_TO_L0A_LOAD2D_H
...
private:
    ...
    __aicore__ inline void LoadDataToL0(const LocalTensor<A_T>& dst, const LocalTensor<A_T>& aMatrix, uint16_t aL1M,
        bool isATranspose, uint16_t blockUseM, uint16_t blockUseK, int srcL1Offset) const
    {
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0A_LOAD_TO_L0A_LOAD2D_H