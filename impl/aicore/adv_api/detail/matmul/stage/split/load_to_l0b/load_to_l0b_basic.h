...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0B_LOAD_TO_L0B_BASIC_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0B_LOAD_TO_L0B_BASIC_H
...
public:
    ...
    __aicore__ inline void Load(const LocalTensor<TransT>& l0B, const LocalTensor<TransT>& l1B, uint16_t bL1N,
        ...
        const LocalTensor<AuxDtype>& l1BAuxMatrix = NULL_TENSOR<AuxDtype>, uint16_t bAuxL1K = 0,
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0B_LOAD_TO_L0B_BASIC_H