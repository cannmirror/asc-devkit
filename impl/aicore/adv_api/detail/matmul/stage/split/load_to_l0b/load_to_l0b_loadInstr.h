...
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0B_LOAD_TO_L0B_LOADINSTR_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0B_LOAD_TO_L0B_LOADINSTR_H
...
public:
    ...
    __aicore__ inline void Load(const LocalTensor<TransT>& l0B, const LocalTensor<TransT>& l1B, uint16_t bL1N,
...
private:
    ...
    __aicore__ inline void TransLoadDataToL0(const LocalTensor<TransT>& l0B, const LocalTensor<TransT>& l1B,
        ...
        const LocalTensor<AuxDtype>& l1BAuxMatrix = {}) const
    {
    ...
    __aicore__ inline void LoadDataToL0(const LocalTensor<TransT>& l0B, const LocalTensor<TransT>& l1B, uint16_t bL1N,
        uint16_t bL1K, uint16_t madN, uint16_t madK, uint16_t bL1NOffset, uint16_t bL1KOffset, bool isBTranspose) const
    {
        if constexpr (GetLoadL0bInstrType<TransT, MM_CFG>() == LoadL0bInstrType::LOAD2DTRANSPOSE) {
            ...
            LoadData2dTransposeParams loadData2dTransposeParams{
                0, static_cast<uint8_t>(l0bRepeat), l0bSrcstride, 1, 0, inc};
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_SPLIT_LOAD_TO_L0B_LOAD_TO_L0B_LOADINSTR_H