 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_STAGE_COMPUTE_MMAD_COMPUTE_H
#define AICORE_ADV_API_DETAIL_MATMUL_STAGE_COMPUTE_MMAD_COMPUTE_H
...
#endif // AICORE_ADV_API_DETAIL_MATMUL_STAGE_COMPUTE_MMAD_COMPUTE_H
