 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_UTILS_MATMUL_CONFIG_IMPL_H
#define AICORE_ADV_API_DETAIL_MATMUL_UTILS_MATMUL_CONFIG_IMPL_H
...
__aicore__ inline constexpr void GetMMConfigImpl(MatmulConfig& cfg, ArgType arg)
{
    if constexpr (AscendC::IsSameType<ArgType, MatmulShapeParams>::value) {
        ...
        cfg.isNBatchOut = arg.isNBatchOut;
