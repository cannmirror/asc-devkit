 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_UTILS_MATMUL_MODULE_H
#define AICORE_ADV_API_DETAIL_MATMUL_UTILS_MATMUL_MODULE_H
...
#define MATMUL_CAST_TO_IMPL_OF(...) (static_cast<typename MATMUL_IMPL__::__VA_ARGS__*>(MATMUL_CAST_TO_IMPL()))
...
#define MATMUL_CAST_TO_CONST_PROXY_OF(NAME)                                                                            \
    typename AscendC::Impl::Detail::DfxProxy<const MATMUL_IMPL__, typename MATMUL_IMPL__::NAME>(                       \
        *MATMUL_CAST_TO_CONST_IMPL_OF(NAME))
...
#define MATMUL_IMPL_TYPE MatmulImpl<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, MM_CFG, MM_CB, MATMUL_POLICY_TEMPLATE>

#define MATMUL_MODULE_IN_POLICY(...)                                                                                   \
    MATMUL_POLICY_TEMPLATE<MM_CFG, MATMUL_IMPL_TYPE, A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE>::__VA_ARGS__

#define MATMUL_IMPORT_MODULE(...)                                                                                      \
protected                                                                                                              \
    MATMUL_MODULE_IN_POLICY(__VA_ARGS__)
...
#define MATMUL_ALLOW_USING_TEMPLATE(NAME, ...) using NAME = typename MATMUL_MODULE_IN_POLICY(template NAME<__VA_ARGS__>)
...
#define MATMUL_MODULE_IN_PRIVATE(...)                                                                                  \
    MATMUL_PRIVATE_TEMPLATE<MM_CFG, MATMUL_IMPL_TYPE, A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE,                               \
        MATMUL_POLICY_TEMPLATE>::__VA_ARGS__

#define MATMUL_IMPORT_MODULE_PRIVATE(...)                                                                              \
protected                                                                                                              \
    MATMUL_MODULE_IN_PRIVATE(__VA_ARGS__)
