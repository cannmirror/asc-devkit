 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATMUL_UTILS_MATMUL_CALL_BACK_H
#define AICORE_ADV_API_DETAIL_MATMUL_UTILS_MATMUL_CALL_BACK_H

namespace AscendC {

template <void (*DataCopyOut)(const __gm__ void* gm, const LocalTensor<int8_t>& co1Local, const void* dataCopyOutParams,
