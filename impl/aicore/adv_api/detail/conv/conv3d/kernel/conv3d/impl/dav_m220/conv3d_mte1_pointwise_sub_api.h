...
#ifndef AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_MTE1_POINTWISE_SUB_API_H
#define AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_MTE1_POINTWISE_SUB_API_H
...
private:
    __aicore__ inline void LoadAL0ByLoad2dTranspose()
    {
        ...
        for (uint32_t copy_part = 0; copy_part < numKL0Block; ++copy_part) {
            AscendC::LoadDataWithTranspose<typename Intf::InputT>(self_->ctx.al0[copy_part * tmp1],
                self_->ctx.al1[load2dSrcOffset + copy_part * tmp2], loadData2dTransposeParams);
        }
    }
    ...
    __aicore__ inline void LoadAL0ByLoad2d()
    {
        ...
        KERNEL_LOG(KERNEL_DEBUG,
            "[LoadAL0WithPointWise LoadAL0ByLoad2d] load2dSrcOffset: %u currentKAL1: %u currentKL0: %u\n",
        ...
        AscendC::LoadData2dTransposeParams& loadData2dTransposeParams, const uint64_t& repeatTimes)
    {
        ...
        KERNEL_LOG(KERNEL_DEBUG,
            "[LoadAL0WithPointWise] LoadData2dTransposeParams repeatTimes %d dstFracGap %d dstGap %d.\n",
