...
public:
    ...
    struct ContextData : public Config::ContextData {
        ...
        using LoadBL1Tools = typename AscendC::Conditional<groupConvType, Conv3dApiFunc::LoadBL1WithGroupOptTools<Intf>,
            LoadBL1ToolsTmp>::type;
        ...
        using LoadBL0Tools = typename AscendC::Conditional<groupConvType, Conv3dApiFunc::LoadBL0WithGroupOptTools<Intf>,
            LoadBL0ToolsTmp>::type;

        using LoadAL0Tools = typename AscendC::Conditional<Config::formatA == ConvCommonApi::ConvFormat::NCDHW,
            Conv3dApiFunc::LoadAL0WithPointWiseTools<Intf>, Conv3dApiFunc::LoadAL0Tools<Intf>>::type;
        using LoadChannelWiseL1Tools =
            typename AscendC::Conditional<Config::formatA == ConvCommonApi::ConvFormat::NCDHW,
        ...
        using LoadBiasL0Tools = typename AscendC::Conditional<Config::formatA == ConvCommonApi::ConvFormat::NCDHW,
            Conv3dApiFunc::LoadBiasL0WithBroadcastTools<Intf>, Conv3dApiFunc::LoadBiasBtTools<Intf>>::type;
        using CopyOutTools = typename AscendC::Conditional<Config::formatA == ConvCommonApi::ConvFormat::NCDHW,
        ...
        // Buffers
        using L0aBufType = typename AscendC::Conditional<Config::formatA == ConvCommonApi::ConvFormat::NCDHW,
            AscendC::TBuf<AscendC::TPosition::B2>, AscendC::TBuf<AscendC::TPosition::A2>>::type;
        using L0bBufType = typename AscendC::Conditional<Config::formatA == ConvCommonApi::ConvFormat::NCDHW,
