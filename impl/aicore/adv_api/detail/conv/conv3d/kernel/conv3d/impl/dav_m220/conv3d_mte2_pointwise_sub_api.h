...
#ifndef AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_MTE2_POINTWISE_SUB_API_H
#define AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_MTE2_POINTWISE_SUB_API_H
        ...
        for (uint64_t copyIdx = 0; copyIdx < upperLimits; ++copyIdx) {
            ...
            if (dihiwi > ConvApi::MAX_UINT16) {
                ...
                AscendC::DataCopy<typename Intf::InputT>(self_->ctx.al1[singleDataCopyOffset],
                    self_->ctx.agm[aL1GmOffset + dihiwi * currentDataCopyLines], nd2NzParams);
            }
        }
...
#endif // __AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_MTE2_POINTWISE_SUB_API_H__
