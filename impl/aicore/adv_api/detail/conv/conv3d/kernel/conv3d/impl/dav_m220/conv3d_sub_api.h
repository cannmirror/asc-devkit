...
#ifndef AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_SUB_API_H
#define AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_SUB_API_H
...
private:
    ...
    __aicore__ inline void SetNd2NzParams(uint64_t dValue, uint64_t srcDValue)
    {
        ...
        KERNEL_LOG(KERNEL_DEBUG, "[LoadChannelWiseL1] nd2NzParams.dValue %d nd2NzParams.srcDValue %d.\n",
            nd2NzParams.dValue, nd2NzParams.srcDValue);
    }
...
#endif // __AICORE_ADV_API_DETAIL_CONV_CONV3D_KERNEL_CONV3D_IMPL_DAV_M220_CONV3D_SUB_API_H__
