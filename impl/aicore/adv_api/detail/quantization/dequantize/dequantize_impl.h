 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_QUANTIZATION_DEQUANTIZE_DEQUANTIZE_IMPL_H
#define AICORE_ADV_API_DETAIL_QUANTIZATION_DEQUANTIZE_DEQUANTIZE_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_QUANTIZATION_DEQUANTIZE_DEQUANTIZE_IMPL_H