 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_QUANTIZATION_ANTIQUANT_ASCEND_ANTIQUANT_M200_IMPL_H
#define AICORE_ADV_API_DETAIL_QUANTIZATION_ANTIQUANT_ASCEND_ANTIQUANT_M200_IMPL_H
...
__aicore__ inline void CheckApiDtypeValid()
{
    ...
    ASCENDC_ASSERT((inputValid && outputValid), {
        KERNEL_LOG(KERNEL_ERROR, "Failed to check dtype in AscendAntiQuant, "
...
#endif // AICORE_ADV_API_DETAIL_QUANTIZATION_ANTIQUANT_ASCEND_ANTIQUANT_M200_IMPL_H
