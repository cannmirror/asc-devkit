 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_QUANTIZATION_ANTIQUANTIZE_ANTIQUANTIZE_IMPL_H
#define AICORE_ADV_API_DETAIL_QUANTIZATION_ANTIQUANTIZE_ANTIQUANTIZE_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_QUANTIZATION_ANTIQUANTIZE_ANTIQUANTIZE_IMPL_H
