 ...
 */
#ifndef AICORE_ADV_API_DETAIL_SELECT_SELECTWITHBYTESMASK_SELECTWITHBYTESMASK_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_SELECT_SELECTWITHBYTESMASK_SELECTWITHBYTESMASK_C310_IMPL_H
    ...
    MicroAPI::MaskReg& localMask0, MicroAPI::MaskReg& maskReg0)
{
    ...
    if constexpr (sizeof(U) == 1) {
        MicroAPI::CompareScalar<uint8_t, cmpMode>(
            localMask0, (MicroAPI::RegTensor<uint8_t>&)vMaskReg0, static_cast<uint8_t>(0), maskReg0);
    ...
    const LocalTensor<U>& mask, const SelectWithBytesMaskShapeInfo& info)
{
    ...
    VF_CALL<SelectWithBytesMaskPerAxisImpl<T, U, reverse>>(
        dstUb, src0Ub, src1, maskUb, firstAxis, srcLastAxis, maskLastAxis);
}
    ...
    const SelectWithBytesMaskShapeInfo& info)
{
    ...
    CheckTensorPos<uint8_t>(
        sharedTmpBuffer, Hardware::UB, "sharedTmpBuffer", "VECIN / VECCALC / VECOUT", "SelectWithBytesMask");
...
#endif // AICORE_ADV_API_DETAIL_SELECT_SELECTWITHBYTESMASK_SELECTWITHBYTESMASK_C310_IMPL_H
