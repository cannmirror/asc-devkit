 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_TRANSPOSE_CONFUSION_TRANSPOSE_CONFUSION_TRANSPOSE_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_TRANSPOSE_CONFUSION_TRANSPOSE_CONFUSION_TRANSPOSE_COMMON_IMPL_H
    ...
    const LocalTensor<uint8_t>& sharedTmpBuffer, TransposeType transposeType, ConfusionTransposeTiling& tiling)
{
    ...
    CheckTensorPos<uint8_t>(
        sharedTmpBuffer, Hardware::UB, "sharedTmpBuffer", "VECIN / VECCALC / VECOUT", "ConfusionTranspose");
    ...
    if (transposeType == TransposeType::TRANSPOSE_NZ2ND_0213 || transposeType == TransposeType::TRANSPOSE_NZ2NZ_0213) {
        ...
        ASCENDC_ASSERT(false, {
            KERNEL_LOG(KERNEL_ERROR, "ConfusionTranspose do not support current TransposeType on current device!");
        });
    }
}
#else
...
#endif // AICORE_ADV_API_DETAIL_TRANSPOSE_CONFUSION_TRANSPOSE_CONFUSION_TRANSPOSE_COMMON_IMPL_H