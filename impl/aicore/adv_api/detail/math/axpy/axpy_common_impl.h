 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_AXPY_AXPY_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_AXPY_AXPY_COMMON_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_MATH_AXPY_AXPY_COMMON_IMPL_H