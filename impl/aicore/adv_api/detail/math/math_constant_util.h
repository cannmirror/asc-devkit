 ...
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_MATH_CONSTANT_UTIL_H
#define AICORE_ADV_API_DETAIL_MATH_MATH_CONSTANT_UTIL_H
namespace AscendC {
...
#endif // AICORE_ADV_API_DETAIL_MATH_MATH_CONSTANT_UTIL_H
