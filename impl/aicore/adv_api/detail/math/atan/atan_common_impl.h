 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_ATAN_ATAN_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_ATAN_ATAN_COMMON_IMPL_H
    ...
    const LocalTensor<float>& tmpTensor, const uint32_t splitSize)
{
    ...
    Cast<float, half, false>(tempTensorConv, srcTensor, RoundMode::CAST_NONE, MASK_PLACEHOLDER, 1,
...
#endif // AICORE_ADV_API_DETAIL_MATH_ATAN_ATAN_COMMON_IMPL_H