 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_CEIL_CEIL_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_CEIL_CEIL_C310_IMPL_H
#include "kernel_tensor.h"

namespace AscendC {
template <typename T, bool isReuseSource = false>
__aicore__ inline void CeilCompute(
...
#endif // AICORE_ADV_API_DETAIL_MATH_CEIL_CEIL_C310_IMPL_H
