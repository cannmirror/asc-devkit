 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_CEIL_CEIL_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_CEIL_CEIL_COMMON_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_MATH_CEIL_CEIL_COMMON_IMPL_H