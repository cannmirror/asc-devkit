 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_XOR_XOR_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_XOR_XOR_C310_IMPL_H

namespace AscendC {
namespace XorAPI {
template <typename T>
__aicore__ inline void XorCompute(
    __local_mem__ T* dst, __local_mem__ T* src0, __local_mem__ T* src1, uint32_t calCount, uint16_t repeatTimes)
{
...
#endif // AICORE_ADV_API_DETAIL_MATH_XOR_XOR_C310_IMPL_H
