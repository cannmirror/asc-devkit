 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_ROUND_ROUND_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_ROUND_ROUND_C310_IMPL_H
#include "kernel_tensor.h"
#include "../../common/check.h"

namespace AscendC {
template <typename T, bool isReuseSource = false>
__aicore__ inline void RoundCompute(
    __local_mem__ T* dstUb, __local_mem__ T* srcUb, uint32_t calCount, const uint16_t repeatTimes)
{
...
#endif // AICORE_ADV_API_DETAIL_MATH_ROUND_ROUND_C310_IMPL_H