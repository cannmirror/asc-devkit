 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_ERFC_ERFC_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_ERFC_ERFC_C310_IMPL_H
...
__aicore__ inline void ErfcComputeR(
    MicroAPI::RegTensor<float>& dstReg, MicroAPI::RegTensor<float>& srcReg, MicroAPI::MaskReg mask)
{
...
__aicore__ inline void ErfcComputeS(
    MicroAPI::RegTensor<float>& dstReg, MicroAPI::RegTensor<float>& srcReg, MicroAPI::MaskReg mask)
{
    // Specific value used for approximate calculation.
...
__aicore__ inline void ErfcPublicSteps(
    MicroAPI::RegTensor<float>& dstReg, MicroAPI::RegTensor<float>& srcReg, MicroAPI::MaskReg mask)
{
...
#endif // AICORE_ADV_API_DETAIL_MATH_ERFC_ERFC_C310_IMPL_H
