...
#ifndef AICORE_ADV_API_DETAIL_MATH_ATANH_ATANH_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_ATANH_ATANH_COMMON_IMPL_H
...
template <typename T>
__aicore__ inline void AtanhCompute(const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor,
...
template <>
__aicore__ inline void AtanhCompute(const LocalTensor<half>& dstTensor, const LocalTensor<half>& srcTensor,
    const LocalTensor<float>& tmpBuffer, uint32_t calSize)
{
    const UnaryRepeatParams unaryParams;
    const BinaryRepeatParams binaryParams;
    ...
    // half -> float
    Cast<float, half, false>(tmpFloatBuffer1, srcTensor, RoundMode::CAST_NONE, MASK_PLACEHOLDER, 1,
    ...
    // float -> half
    Cast<half, float, false>(dstTensor, tmpFloatBuffer1, RoundMode::CAST_NONE, MASK_PLACEHOLDER, 1,
...
#endif // AICORE_ADV_API_DETAIL_MATH_ATANH_ATANH_COMMON_IMPL_H