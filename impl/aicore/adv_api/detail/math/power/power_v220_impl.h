 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_POWER_POWER_V220_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_POWER_POWER_V220_IMPL_H
    ...
    const BinaryRepeatParams& binaryParam, const uint32_t calCount)
{
    ...
    ShiftRight<uint32_t, false>(tmpTensor1.ReinterpretCast<uint32_t>(), src.ReinterpretCast<uint32_t>(), signBit,
        MASK_PLACEHOLDER, 1, unaryParam, false);
    PipeBarrier<PIPE_V>();
    CompareScalar<int32_t, uint8_t, false>(dst, tmpTensor1.ReinterpretCast<int32_t>(), static_cast<int32_t>(1),
...
#endif // AICORE_ADV_API_DETAIL_MATH_POWER_POWER_V220_IMPL_H
