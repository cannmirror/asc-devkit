 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_POWER_POWER_COMMON_UTILS_H
#define AICORE_ADV_API_DETAIL_MATH_POWER_POWER_COMMON_UTILS_H
...
__aicore__ inline void VselPowerTensorScalar(const LocalTensor<float>& dst, const LocalTensor<uint8_t>& sel,
    const LocalTensor<float>& src0, const LocalTensor<float>& tmpScalar, SELMODE selMode, int32_t repeat,
...
#endif // AICORE_ADV_API_DETAIL_MATH_POWER_POWER_COMMON_UTILS_H