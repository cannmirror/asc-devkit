 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_POWER_POWER_INT_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_POWER_POWER_INT_IMPL_H
...
{
    Cast<float, int32_t, false>(param.tmpTensor1.ReinterpretCast<float>(), param.recordExpNode, RoundMode::CAST_NONE,
...
{
    Cast<float, int32_t, false>(param.tmpTensor1.ReinterpretCast<float>(), param.expUBIterate, RoundMode::CAST_NONE,
        MASK_PLACEHOLDER, 1, unaryParam);
    PipeBarrier<PIPE_V>();
    // ReduceSum is ended with a scalar operate on dst[0]
    ReduceSumCount(param.tmpScalar.ReinterpretCast<float>(), param.tmpTensor1.ReinterpretCast<float>(),
...
#endif // AICORE_ADV_API_DETAIL_MATH_POWER_POWER_INT_IMPL_H