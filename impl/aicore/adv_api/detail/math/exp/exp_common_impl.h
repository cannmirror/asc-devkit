 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_EXP_EXP_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_EXP_EXP_COMMON_IMPL_H
...
__aicore__ inline void UpdataExpParams(
...
#endif // AICORE_ADV_API_DETAIL_MATH_EXP_EXP_COMMON_IMPL_H
