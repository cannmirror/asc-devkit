 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_SIN_SIN_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_SIN_SIN_C310_IMPL_H
...
constexpr MicroAPI::CastTrait sinCastTraitF16F32 = {
    MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::UNKNOWN, MicroAPI::MaskMergeMode::ZEROING};
constexpr MicroAPI::CastTrait sinCastTraitF32F16 = {
    ...
    const LocalTensor<uint8_t>& sharedTmpBuffer, const uint32_t calCount)
{
    ...
    if constexpr (config.algo == SinAlgo::POLYNOMIAL_APPROXIMATION) {
        MicroAPI::Sin::SinPolynomialImpl(
...
#endif // AICORE_ADV_API_DETAIL_MATH_SIN_SIN_C310_IMPL_H
