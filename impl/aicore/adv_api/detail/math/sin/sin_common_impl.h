 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_SIN_SIN_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_SIN_SIN_COMMON_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_MATH_SIN_SIN_COMMON_IMPL_H
