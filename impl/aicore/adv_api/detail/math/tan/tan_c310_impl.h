 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_TAN_TAN_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_TAN_TAN_C310_IMPL_H
...
__aicore__ inline void TanPolynomialApproximation(MicroAPI::RegTensor<float>& dstReg,
    MicroAPI::RegTensor<float>& tmpReg, MicroAPI::RegTensor<float>& roundReg, MicroAPI::RegTensor<float>& resReg,
    MicroAPI::RegTensor<float>& downReg1, MicroAPI::RegTensor<float>& downReg2, MicroAPI::MaskReg mask)
{
    /*
...
#endif // AICORE_ADV_API_DETAIL_MATH_TAN_TAN_C310_IMPL_H