 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_TAN_TAN_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_TAN_TAN_COMMON_IMPL_H
...
__aicore__ inline void TanPolynomialApproximation(const LocalTensor<float>& dstTensor,
    const LocalTensor<float>& srcTensor, const LocalTensor<float>& roundTensor, const LocalTensor<float>& resTensor1,
    const LocalTensor<float>& resTensor2)
{
    /*
    ...
    const LocalTensor<uint8_t>& tmpBuffer, uint32_t calSize)
{
    ...
    Cast<float, half, false>(tmpTensor1, srcTensor, RoundMode::CAST_NONE, MASK_PLACEHOLDER, 1,
    ...
    Cast<half, float, false>(dstTensor, tempTensorConv, RoundMode::CAST_NONE, MASK_PLACEHOLDER, 1,
...
#endif // AICORE_ADV_API_DETAIL_MATH_TAN_TAN_COMMON_IMPL_H