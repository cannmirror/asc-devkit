 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_TANH_TANH_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_TANH_TANH_C310_IMPL_H
    ...
    const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor, const uint32_t calCount)
{
    ...
    ASCENDC_ASSERT(ret, {
        KERNEL_LOG(KERNEL_ERROR, "calCount must be no less than 0 and smaller than or equal to src & dst tensor.");
    });
...
#endif // AICORE_ADV_API_DETAIL_MATH_TANH_TANH_C310_IMPL_H