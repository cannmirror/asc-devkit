 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_SIGN_SIGN_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_SIGN_SIGN_COMMON_IMPL_H
#include <type_traits>
    ...
    const LocalTensor<uint8_t>& sharedTmpBuffer, const uint32_t calCount)
{
    ...
    for (uint32_t i = 0; i < loopCount; ++i) {
        SignComputeImpl(dstTensor[offset], srcTensor[offset], sharedTmpBuffer, sharedTmpBuffer[tmpLen], stackTensor,
...
#pragma end_pipe
#endif // AICORE_ADV_API_DETAIL_MATH_SIGN_SIGN_COMMON_IMPL_H