 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_SINH_SINH_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_SINH_SINH_C310_IMPL_H
...
__aicore__ inline void SinhCompute(__ubuf__ T* dstUb, __ubuf__ T* srcUb, uint32_t calCount, uint16_t repeatTimes)
{
    ...
    static constexpr MicroAPI::CastTrait sinhCastTraitUpper = {
        MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::UNKNOWN, MicroAPI::MaskMergeMode::ZEROING, RoundMode::UNKNOWN};
    static constexpr MicroAPI::CastTrait sinhCastTraitLower = {
...
#endif // AICORE_ADV_API_DETAIL_MATH_SINH_SINH_C310_IMPL_H