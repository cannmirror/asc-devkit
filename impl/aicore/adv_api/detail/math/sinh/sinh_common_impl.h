 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_MATH_SINH_SINH_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_SINH_SINH_COMMON_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_MATH_SINH_SINH_COMMON_IMPL_H
