...
#ifndef AICORE_ADV_API_DETAIL_MATH_HYPOT_HYPOT_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_MATH_HYPOT_HYPOT_COMMON_IMPL_H
...
constexpr MicroAPI::CastTrait HYPOT_CAST_TRAIT_RINT = {
...
__aicore__ inline void HypotCommonProcess(MicroAPI::RegTensor<float>& vSrcTmpReg0,
    MicroAPI::RegTensor<float>& vSrcTmpReg1, MicroAPI::RegTensor<float>& vDstReg0, MicroAPI::MaskReg maskReg)
{
    ...
    MicroAPI::Min(
        vMinReg, (MicroAPI::RegTensor<int32_t>&)vSrcTmpReg0, (MicroAPI::RegTensor<int32_t>&)vSrcTmpReg1, maskReg);
    MicroAPI::Max(
        vMaxReg, (MicroAPI::RegTensor<int32_t>&)vSrcTmpReg0, (MicroAPI::RegTensor<int32_t>&)vSrcTmpReg1, maskReg);
...
template <typename T>
__aicore__ inline void VfHypotImpl(
    __local_mem__ T* dstUb, __local_mem__ T* src0Ub, __local_mem__ T* src1Ub, const uint32_t calCount)
{
