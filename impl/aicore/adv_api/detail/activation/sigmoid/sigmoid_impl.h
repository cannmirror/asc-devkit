 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SIGMOID_SIGMOID_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SIGMOID_SIGMOID_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SIGMOID_SIGMOID_IMPL_H
