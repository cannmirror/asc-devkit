 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SIGMOID_SIGMOID_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SIGMOID_SIGMOID_C310_IMPL_H

#include "kernel_tensor.h"
#include "kernel_pop_stack_buffer.h"

namespace AscendC {
namespace SigmoidInternal {
constexpr MicroAPI::CastTrait sigmoidCastTraitF162F32 = {
    MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::UNKNOWN, MicroAPI::MaskMergeMode::ZEROING, RoundMode::UNKNOWN};
constexpr MicroAPI::CastTrait sigmoidCastTraitF322F16 = {
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t i = 0; i < repeatTimes; ++i) {
            ...
            if constexpr (sizeof(T) == sizeof(half)) {
                ...
                MicroAPI::Cast<float, T, SigmoidInternal::sigmoidCastTraitF162F32>(castReg, srcReg, preg);
            } else {
            ...
            if constexpr (sizeof(T) == sizeof(half)) {
                MicroAPI::Cast<T, float, SigmoidInternal::sigmoidCastTraitF322F16>(srcReg, dstReg, preg);
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SIGMOID_SIGMOID_C310_IMPL_H
