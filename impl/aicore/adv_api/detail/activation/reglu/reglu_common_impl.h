 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_REGLU_REGLU_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_REGLU_REGLU_COMMON_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_REGLU_REGLU_COMMON_IMPL_H