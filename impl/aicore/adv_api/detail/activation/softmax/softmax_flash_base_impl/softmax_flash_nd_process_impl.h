 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_SOFTMAX_FLASH_BASE_IMPL_SOFTMAX_FLASH_ND_PROCESS_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_SOFTMAX_FLASH_BASE_IMPL_SOFTMAX_FLASH_ND_PROCESS_IMPL_H
    ...
    const LastAxisShapeND& originalSrcShape, const SoftMaxTiling& tiling)
{
    ...
    const ReduceLastND reduceMainParam = {
        tiling.splitM, originalSrcShape.k, tiling.splitM, tiling.splitK, tiling.reduceM, tiling.reduceK};
    const ReduceLastND reduceTailParam = {
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_SOFTMAX_FLASH_BASE_IMPL_SOFTMAX_FLASH_ND_PROCESS_IMPL_H