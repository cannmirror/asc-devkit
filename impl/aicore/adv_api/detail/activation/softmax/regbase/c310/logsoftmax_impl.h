 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_REGBASE_C310_LOGSOFTMAX_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_REGBASE_C310_LOGSOFTMAX_IMPL_H

#include "softmax_impl.h"

namespace AscendC {
template <typename T, bool isReuseSource = false>
__aicore__ inline void LogSoftMaxNZImpl(const LocalTensor<T>& dst, const LocalTensor<T>& sum, const LocalTensor<T>& max,
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_REGBASE_C310_LOGSOFTMAX_IMPL_H
