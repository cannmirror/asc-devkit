 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_V220_SOFTMAX_COMMON_IMPL_SOFTMAX_COMMON_ND_REDUCE_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_V220_SOFTMAX_COMMON_IMPL_SOFTMAX_COMMON_ND_REDUCE_H
...
#else
    for (uint32_t i = 0; i < srcM; i++) { DataCopy(dst[i * FLOAT_REPEAT_SIZE], src[i * srcK], FLOAT_REPEAT_SIZE); }
#endif
}
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_V220_SOFTMAX_COMMON_IMPL_SOFTMAX_COMMON_ND_REDUCE_H