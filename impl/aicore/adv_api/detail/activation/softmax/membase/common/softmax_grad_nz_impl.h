 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_GRAD_NZ_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_GRAD_NZ_IMPL_H
    ...
    const SoftMaxTiling& tiling)
{
    const ReduceLastND& mainReduceParam = {
        tiling.splitM, tiling.splitK, tiling.splitM, tiling.splitK, tiling.splitM, SOFTMAX_SHAPE_NZ_BASIC_COUNT};
    const ReduceLastND& tailReduceParam = {
        tiling.tailM, tiling.splitK, tiling.splitM, tiling.splitK, tiling.splitM, SOFTMAX_SHAPE_NZ_BASIC_COUNT};
    ...
    const SoftMaxTiling& tiling, bool isFront = false)
{
    if (isFront) {
        ...
        const ReduceLastND& mainReduceParam = {tiling.splitM, originalSrcShape.k, tiling.splitM, tiling.splitK,
            tiling.splitM, SOFTMAX_SHAPE_NZ_BASIC_COUNT};
        const ReduceLastND& tailReduceParam = {tiling.tailM, originalSrcShape.k, tiling.splitM, tiling.splitK,
            tiling.splitM, SOFTMAX_SHAPE_NZ_BASIC_COUNT};
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_GRAD_NZ_IMPL_H