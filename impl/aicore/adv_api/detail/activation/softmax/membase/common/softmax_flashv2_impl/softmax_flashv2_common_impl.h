 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_FLASHV2_IMPL_SOFTMAX_FLASHV2_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_FLASHV2_IMPL_SOFTMAX_FLASHV2_COMMON_IMPL_H
    ...
    if constexpr (config.oriSrcM == 0 || config.oriSrcK == 0) {
        ...
        if constexpr (localIsBasicBlock) {
            ...
            if constexpr (SupportType<T1, half>()) {
                ...
                reduceParam = {
                    tiling.splitM, config.oriSrcK, tiling.splitM, splitK, tiling.reduceM, DEFAULT_REPEAT_STRIDE};
            }
            SoftmaxFlashV2NoUpdateExtImpl<T1>(
                dst, expSumTensor, maxTensor, src, workLocal, originalSrcShape, tiling, reduceParam);
        }
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_FLASHV2_IMPL_SOFTMAX_FLASHV2_COMMON_IMPL_H