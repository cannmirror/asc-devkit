 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_GRAD_ND_IMPL_H
#define AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_GRAD_ND_IMPL_H
...
{
    const ReduceLastND reduceSumParam = {
    ...
    if (tiling.tailM != 0) {
        const ReduceLastND tailReduceSumParam = {
...
#endif // AICORE_ADV_API_DETAIL_ACTIVATION_SOFTMAX_MEMBASE_COMMON_SOFTMAX_GRAD_ND_IMPL_H