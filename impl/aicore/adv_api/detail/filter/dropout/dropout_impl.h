 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_FILTER_DROPOUT_DROPOUT_IMPL_H
#define AICORE_ADV_API_DETAIL_FILTER_DROPOUT_DROPOUT_IMPL_H
    ...
    const DropOutShapeInfo& info)
{
    ...
    static_assert(
        SupportType<T, half, float, bfloat16_t>(), "Dropout Only Supportes half, float, bfloat16_t on current device.");
#endif
...
#endif // AICORE_ADV_API_DETAIL_FILTER_DROPOUT_DROPOUT_IMPL_H
