 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_HCCL_HCCL_TILING_MSG_H
#define AICORE_ADV_API_DETAIL_HCCL_HCCL_TILING_MSG_H
...
enum HcclTilingStatus { TILING_SUCCESS = 0, TILING_FAILED = 1, HCCL_TILING_STATUS_RESERVED };
} // namespace AscendC

#endif // AICORE_ADV_API_DETAIL_HCCL_HCCL_TILING_MSG_H