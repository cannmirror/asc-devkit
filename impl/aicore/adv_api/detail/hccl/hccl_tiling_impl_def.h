 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_HCCL_HCCL_TILING_IMPL_DEF_H
#define AICORE_ADV_API_DETAIL_HCCL_HCCL_TILING_IMPL_DEF_H
...
#endif // AICORE_ADV_API_DETAIL_HCCL_HCCL_TILING_IMPL_DEF_H
