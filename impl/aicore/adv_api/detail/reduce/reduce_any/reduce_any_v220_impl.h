 ...
 */
#ifndef AICORE_ADV_API_DETAIL_REDUCE_REDUCE_ANY_REDUCE_ANY_V220_IMPL_H
#define AICORE_ADV_API_DETAIL_REDUCE_REDUCE_ANY_REDUCE_ANY_V220_IMPL_H
    ...
    const LocalTensor<uint8_t>& sharedTmpBuffer, const uint32_t srcShape[], bool srcInnerPad)
{
    ...
    static_assert(SupportType<T, float, uint8_t>(),
...
#endif // AICORE_ADV_API_DETAIL_REDUCE_REDUCE_ANY_REDUCE_ANY_V220_IMPL_H
