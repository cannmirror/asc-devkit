 ...
 */
#ifndef AICORE_ADV_API_DETAIL_REDUCE_REDUCE_PROD_REDUCE_PROD_V220_IMPL_H
#define AICORE_ADV_API_DETAIL_REDUCE_REDUCE_PROD_REDUCE_PROD_V220_IMPL_H
...
__aicore__ inline void PreProcessReduceForAR(const LocalTensor<T>& src, const LocalTensor<T>& currBuff, uint32_t row,
    uint32_t last, uint32_t padLast, uint32_t remain, uint32_t& splitK)
{
...
#endif // AICORE_ADV_API_DETAIL_REDUCE_REDUCE_PROD_REDUCE_PROD_V220_IMPL_H
