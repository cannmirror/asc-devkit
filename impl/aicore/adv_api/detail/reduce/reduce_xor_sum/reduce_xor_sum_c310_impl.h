 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_REDUCE_REDUCE_XOR_SUM_REDUCE_XOR_SUM_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_REDUCE_REDUCE_XOR_SUM_REDUCE_XOR_SUM_C310_IMPL_H
...
template <typename T>
__aicore__ inline void LoadSrcDataAndXor(
    MicroAPI::RegTensor<float>& srcReg, __ubuf__ T* src0, __ubuf__ T* src1, uint16_t index, MicroAPI::MaskReg& mask)
{
...
template <typename T>
__aicore__ inline void ReduceXorSumCoreImpl(
...
#endif // AICORE_ADV_API_DETAIL_REDUCE_REDUCE_XOR_SUM_REDUCE_XOR_SUM_C310_IMPL_H