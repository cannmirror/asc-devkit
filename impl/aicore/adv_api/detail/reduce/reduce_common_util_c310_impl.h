 ...
 */
#ifndef AICORE_ADV_API_DETAIL_REDUCE_REDUCE_COMMON_UTIL_C310_IMPL_H
#define AICORE_ADV_API_DETAIL_REDUCE_REDUCE_COMMON_UTIL_C310_IMPL_H
...
static constexpr uint16_t BASE_FOLD = 4;
static constexpr uint16_t BASE_FOLD_B64 = 3;
static constexpr uint16_t FLOD_THREE = 3;
static constexpr uint16_t FLOD_TWO = 2;
static constexpr uint16_t FLOD_ONE = 1;
constexpr uint16_t NO_REUSE_FOLD_NUM = 2;

static constexpr MicroAPI::CastTrait CastTraitBF16F32 = {
    MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::UNKNOWN, MicroAPI::MaskMergeMode::ZEROING};
static constexpr MicroAPI::CastTrait CastTraitF32BF16 = {
    MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::NO_SAT, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT};
static constexpr MicroAPI::CastTrait CastTraitB8F16 = {
    MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::UNKNOWN, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT};
static constexpr MicroAPI::CastTrait CastTraitF16B8 = {
    MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::NO_SAT, MicroAPI::MaskMergeMode::ZEROING, RoundMode::CAST_RINT};
...
__aicore__ inline void ReduceARCastfoldOneToThree(
    MicroAPI::RegTensor<T, Trait>& vreg0, MicroAPI::RegTensor<T, Trait>& vreg1, MicroAPI::MaskReg& fullMask)
{
...
#endif // AICORE_ADV_API_DETAIL_REDUCE_REDUCE_COMMON_UTIL_C310_IMPL_H