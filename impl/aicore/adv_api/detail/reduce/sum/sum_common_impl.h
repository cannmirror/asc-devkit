 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_REDUCE_SUM_SUM_COMMON_IMPL_H
#define AICORE_ADV_API_DETAIL_REDUCE_SUM_SUM_COMMON_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_REDUCE_SUM_SUM_COMMON_IMPL_H
