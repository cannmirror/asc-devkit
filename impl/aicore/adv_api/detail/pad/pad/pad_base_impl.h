 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_PAD_PAD_PAD_BASE_IMPL_H
#define AICORE_ADV_API_DETAIL_PAD_PAD_PAD_BASE_IMPL_H
...
#endif // AICORE_ADV_API_DETAIL_PAD_PAD_PAD_BASE_IMPL_H
