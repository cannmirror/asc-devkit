 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_PAD_PAD_PAD_V200_IMPL_H
#define AICORE_ADV_API_DETAIL_PAD_PAD_PAD_V200_IMPL_H
        ...
        for (uint32_t i = 0; i < (widthFractal); i++) {
            ...
            if (i == (widthFractal - 1)) {
                DuplicateLastDimImpl(
                    tmp1, srcTensor[j * width + i * widthTiling], widthFractalTail, ONE_BLK_SIZE / sizeof(T));
            } else {
                DuplicateLastDimImpl(
                    tmp1, srcTensor[j * width + i * widthTiling], widthTiling, ONE_BLK_SIZE / sizeof(T));
            }
...
#endif // AICORE_ADV_API_DETAIL_PAD_PAD_PAD_V200_IMPL_H
