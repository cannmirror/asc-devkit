 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_API_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_API_CHECK_H
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_API_CHECK_H
