 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_TRANSPOSE_CONFUSION_TRANSPOSE_CONFUSION_TRANSPOSE_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_TRANSPOSE_CONFUSION_TRANSPOSE_CONFUSION_TRANSPOSE_CHECK_COMMON_H
...
private:
        ...
        const TransposeType checkType, U posTuple, __gm__ const char* posString, Std::index_sequence<Is...>)
    {
        ...
        auto typeTuple = MakeParameters2Tuple(TransposeType::TRANSPOSE_TYPE_NONE, TransposeType::TRANSPOSE_NZ2ND_0213,
        ...
        auto typeStringTuple = MakeString2Tuple("TransposeType::TRANSPOSE_TYPE_NONE",
            ...
            "TransposeType::TRANSPOSE_NZ2ND_012_WITHOUT_N", "TransposeType::TRANSPOSE_NZ2NZ_012_WITHOUT_N",
            "TransposeType::TRANSPOSE_ND2ND_ONLY", "TransposeType::TRANSPOSE_ND_UB_GM",
            "TransposeType::TRANSPOSE_GRAD_ND_UB_GM", "TransposeType::TRANSPOSE_ND2ND_B16",
            "TransposeType::TRANSPOSE_NCHW2NHWC", "TransposeType::TRANSPOSE_NHWC2NCHW");
    ...
    {
        KERNEL_LOG(KERNEL_INFO, "[%s] The transpose type is %s.", apiName,
            FindStringFromTuple(checkType, typeTuple, typeStringTuple, tuple_sequence<decltype(typeTuple)>{}));
    }
...
public:
    ...
    __aicore__ inline CheckFuncClassConfusionTranspose(__gm__ const char* apiName) :
        ...
        MultipleTensorCheckFuncBasicClass(apiName), TransposeTypeCheckFuncBasicClass(apiName){};
...
public:
        ...
        const LocalTensor<uint8_t>& sharedTmpBuffer, TransposeType transposeType, ConfusionTransposeTiling& tiling)
    {
        ...
        TransposeTypeCheckFuncBasicClass::TransposeTypeCheck(
            transposeType, VA_ARGS_TO_MAKE_TUPLE_STRING(TransposeType::TRANSPOSE_NZ2ND_0213,
                               TransposeType::TRANSPOSE_NZ2NZ_0213, TransposeType::TRANSPOSE_NZ2NZ_012_WITH_N,
                               TransposeType::TRANSPOSE_NZ2ND_012_WITH_N, TransposeType::TRANSPOSE_NZ2ND_012_WITHOUT_N,
                               TransposeType::TRANSPOSE_NZ2NZ_012_WITHOUT_N, TransposeType::TRANSPOSE_ND2ND_ONLY));
    };
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_TRANSPOSE_CONFUSION_TRANSPOSE_CONFUSION_TRANSPOSE_CHECK_COMMON_H
