 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_COSH_COSH_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_COSH_COSH_CHECK_H
...
__aicore__ inline void CheckFuncCosh(__gm__ const char* apiName, const LocalTensor<T>& dstTensor,
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_COSH_COSH_CHECK_H
