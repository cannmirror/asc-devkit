 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_LGAMMA_LGAMMA_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_LGAMMA_LGAMMA_CHECK_COMMON_H
...
public:
    ...
    __aicore__ inline CheckFuncClassLgamma(__gm__ const char* apiName) :
        ...
        CalCountCheckFuncBasicClass(apiName), SingleTensorCheckFuncBasicClass(apiName),
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_LGAMMA_LGAMMA_CHECK_COMMON_H
