 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_FLOOR_FLOOR_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_FLOOR_FLOOR_CHECK_COMMON_H
...
public:
        ...
        const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor, const uint32_t calCount)
    {
        ...
        SingleTensorCheckFuncBasicClass::TensorVerifyingParameters(VA_ARGS_TO_MAKE_TUPLE(srcTensor, dstTensor),
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_FLOOR_FLOOR_CHECK_COMMON_H
