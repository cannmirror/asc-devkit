 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_FMOD_FMOD_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_FMOD_FMOD_CHECK_COMMON_H
...
private:
    ...
    {
        KERNEL_LOG(KERNEL_INFO, "[Fmod] src0Tensor size is %u, src1Tensor size is %u. ", src0Tensor.GetSize(),
            src1Tensor.GetSize());
    }
};
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_MATH_FMOD_FMOD_CHECK_COMMON_H
