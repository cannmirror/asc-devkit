 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_ANTIQUANT_ANTIQUANT_CHECK_310_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_ANTIQUANT_ANTIQUANT_CHECK_310_H
...
public:
    __aicore__ inline void VerifyingParameters(const LocalTensor<DstType>& dst, const LocalTensor<SrcType>& src,
        const LocalTensor<DstType>& offset, const LocalTensor<DstType>& scale,
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_ANTIQUANT_ANTIQUANT_CHECK_310_H
