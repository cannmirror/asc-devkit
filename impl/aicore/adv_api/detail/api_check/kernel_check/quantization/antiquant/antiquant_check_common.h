 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_ANTIQUANT_ANTIQUANT_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_ANTIQUANT_ANTIQUANT_CHECK_COMMON_H

#include "../../basic_check/datatype_check.h"
#include "../../basic_check/single_tensor_check.h"
#include "../../basic_check/multiple_tensor_check.h"
#include "quantization/ascend_antiquant_utils.h"
        ...
        if (isTranspose == true) {
            ...
            ASCENDC_ASSERT((ans || HighLevelAPIParametersPrint), {
                KERNEL_LOG(KERNEL_ERROR,
                    "[AscendAntiQuant] The result of K * sizeof(InputDataType) cannot be %u, "
...
public:
    __aicore__ inline void VerifyingParameters(const LocalTensor<OutputDataType>& dst,
...
public:
        ...
        const uint32_t K, const AntiQuantShapeInfo& shapeInfo = {})
    {
        ...
        DataTypeCheckFuncBasicClass::DataTypeVerifyingParameters<OutputDataType, bfloat16_t, half>(
            "second template parameter (OutputDataType) is not half or bfloat16_t");
#endif
        SingleTensorCheckFuncBasicClass::TensorVerifyingParameters(VA_ARGS_TO_MAKE_TUPLE(dst, src, sharedTmpBuffer),
            VA_ARGS_TO_MAKE_TUPLE_STRING(TPosition::VECIN, TPosition::VECOUT, TPosition::VECCALC));
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_ANTIQUANT_ANTIQUANT_CHECK_COMMON_H
