 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_DEQUANT_DEQUANT_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_DEQUANT_DEQUANT_CHECK_COMMON_H
...
private:
    ...
    __aicore__ inline void PrintParameters(const LocalTensor<dstT>& dstTensor, const LocalTensor<int32_t>& srcTensor,
        ...
        uint32_t calCount)
    {
        KERNEL_LOG(KERNEL_INFO, "[AscendDequant] The params.m is %u, params.n is %u, params.calCount is %u.", params.m,
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_QUANTIZATION_DEQUANT_DEQUANT_CHECK_COMMON_H
