 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_BASIC_CHECK_DATATYPE_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_BASIC_CHECK_DATATYPE_CHECK_H
...
private:
    ...
    {
        Std::tuple<int4b_t, int8_t, uint8_t, half, int16_t, uint16_t, int32_t, uint32_t, uint64_t, int64_t, float,
            bfloat16_t, double>
            typeData;

        auto typeString = MakeString2Tuple("int4b_t", "int8_t", "uint8_t", "half", "int16_t", "uint16_t", "int32_t",
            "uint32_t", "uint64_t", "int64_t", "float", "bfloat16_t", "double");
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_BASIC_CHECK_DATATYPE_CHECK_H
