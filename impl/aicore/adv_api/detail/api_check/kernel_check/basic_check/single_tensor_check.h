 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_BASIC_CHECK_SINGLE_TENSOR_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_BASIC_CHECK_SINGLE_TENSOR_CHECK_H
...
private:
    ...
    {
        auto posTuple = MakeParameters2Tuple(TPosition::VECIN, TPosition::VECOUT, TPosition::VECCALC, TPosition::GM,
            TPosition::A1, TPosition::A2, TPosition::B1, TPosition::B2, TPosition::C1, TPosition::C2, TPosition::CO1,
            TPosition::CO2, TPosition::SPM, TPosition::TSCM);

        auto posString = MakeString2Tuple("TPosition::VECIN", "TPosition::VECOUT", "TPosition::VECCALC(LCM)",
            "TPosition::GM", "TPosition::A1", "TPosition::A2", "TPosition::B1", "TPosition::B2", "TPosition::C1",
            "TPosition::C2", "TPosition::CO1", "TPosition::CO2", "TPosition::SPM(SHM)", "TPosition::TSCM");
    ...
    __aicore__ inline void TensorPhyAddrOneTensorCheck(const LocalTensor<T>& checkTensor, __gm__ const char* tensorInfo)
    {
        ...
        ASCENDC_ASSERT((tensorAddr % ONE_BLK_SIZE == 0 || HighLevelAPIParametersPrint), {
            KERNEL_LOG(KERNEL_ERROR,
                ...
                "address must be 32-byte aligned, current physical address is %u.",
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_BASIC_CHECK_SINGLE_TENSOR_CHECK_H
