 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_REDUCE_REDUCE_SUM_REDUCE_SUM_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_REDUCE_REDUCE_SUM_REDUCE_SUM_CHECK_H
...
#include "reduce_sum_check_c310.h"
#endif
...
__aicore__ inline void CheckFuncReduceSum(__gm__ const char* apiName, const LocalTensor<T>& dstTensor,
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_REDUCE_REDUCE_SUM_REDUCE_SUM_CHECK_H
