...
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_SORT_SORT_SORT_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_SORT_SORT_SORT_CHECK_H

#if defined(__NPU_ARCH__) && (__NPU_ARCH__ == 2002 || __NPU_ARCH__ == 2201 || __NPU_ARCH__ == 3002)
#include "sort_check_common.h"
#else
#include "sort_check_310.h"
#endif
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_SORT_SORT_SORT_CHECK_H
