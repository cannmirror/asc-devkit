...
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_SORT_MRGSORT_MRGSORT_CHECK_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_SORT_MRGSORT_MRGSORT_CHECK_H

#if defined(__NPU_ARCH__) && (__NPU_ARCH__ == 2002 || __NPU_ARCH__ == 2201 || __NPU_ARCH__ == 3002)
#include "mrgsort_check_common.h"
#else
#include "mrgsort_check_310.h"
#endif
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_SORT_MRGSORT_MRGSORT_CHECK_H
