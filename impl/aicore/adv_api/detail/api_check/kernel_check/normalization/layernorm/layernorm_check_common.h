 ...
 * \brief
 */
#ifndef AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_NORMALIZATION_LAYERNORM_LAYERNORM_CHECK_COMMON_H
#define AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_NORMALIZATION_LAYERNORM_LAYERNORM_CHECK_COMMON_H
...
private:
        ...
        LayerNormTiling& tiling)
    {
        ASCENDC_ASSERT(((gamma.GetSize() * sizeof(T)) % ONE_BLK_SIZE == 0 || HighLevelAPIParametersPrint), {
            KERNEL_LOG(KERNEL_ERROR, "[LayerNorm] The gamma length is %u, should be 32B aligned.",
...
private:
        ...
        const LayerNormPara& para, const LayerNormSeparateTiling& tiling)
    {
        ...
        ASCENDC_ASSERT((para.rLengthWithPadding * sizeof(T) % ONE_BLK_SIZE == 0 || HighLevelAPIParametersPrint), {
            KERNEL_LOG(KERNEL_ERROR, "[LayerNorm Rtsd] The para.rLengthWithPadding is %u, should be 32B aligned.",
        ...
        const LayerNormPara& para, const LayerNormSeparateTiling& tiling)
    {
        ...
        KERNEL_LOG(KERNEL_INFO,
            "[LayerNorm Rtsd] The para.aLength is %u, para.rLength is %u, para.rLengthWithPadding is %u.", para.aLength,
            para.rLength, para.rLengthWithPadding);
    }
};
...
#endif // AICORE_ADV_API_DETAIL_API_CHECK_KERNEL_CHECK_NORMALIZATION_LAYERNORM_LAYERNORM_CHECK_COMMON_H
