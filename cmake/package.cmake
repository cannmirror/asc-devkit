...
# 更新版本号
function(update_version_info new_version)
    set(version_path "${CMAKE_SOURCE_DIR}/version.info")
    file(READ ${version_path} content)
    string(REPLACE "Version=.*" "Version=${new_version}" content "${content}")
    string(REPLACE "version_dir=.*" "version_dir=${new_version}" content "${content}")
