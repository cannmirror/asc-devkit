...
| 4 | **HiF8(hifloat8_t)数据类型**：Cube计算单元新增支持HiF8数据类型的矩阵乘 | [3510架构规格](guide/编程指南/高级编程/硬件实现/架构规格/NPU架构版本3510.md)中Cube支持的数据类型 | [内置数据类型说明](api/SIMD-API/基础API/数据结构/内置数据类型.md)、[Cast类型转换](api/SIMD-API/基础API/Reg矢量计算/类型转换/Cast.md)、[asc_float2hif8](api/SIMD-API/C-API/reg/reg_vector/asc_float2hif8.md) | 资料开发中 |
