...
| 5 | **UB到L1 Buffer通路**：支持数据直接从UB搬运到L1 Buffer，无需经GM中转 | [3510架构变更-搬运单元](guide/跨代迁移兼容性指南/3510架构迁移指导/2201到3510架构变更.md) | 新增支持[UB到L1 Buffer数据搬运](api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬入/矩阵数据搬入至L1-Buffer/DataCopy_UBToL1_continuous.md) | 资料开发中 |
