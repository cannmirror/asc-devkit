...
<td class="cellrowborder" valign="top" width="70.43%" headers="mcps1.2.4.1.3 "><p id="p13481914175514"><a name="p13481914175514"></a><a name="p13481914175514"></a>Conv3DBackpropFilter对象的Tiling参数，Conv3DBackpropFilterTilingData结构体定义请参见<a href="../Conv3DBackpropFilter-Tiling侧接口/TConv3DBpFilterTiling结构体.md">TConv3DBpFilterTiling结构体</a>。</p>
<p id="p246271553317"><a name="p246271553317"></a><a name="p246271553317"></a>Tiling参数可以通过Host侧<a href="../Conv3DBackpropFilter-Tiling侧接口/GetTiling-128.md">GetTiling</a>接口获取，并传递到Kernel侧使用。</p>
</td>
</tr>
</tbody>
</table>
