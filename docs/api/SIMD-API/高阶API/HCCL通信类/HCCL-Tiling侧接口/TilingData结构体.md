...
<td class="cellrowborder" valign="top" width="78.06%" headers="mcps1.2.3.1.2 "><p id="p179841930161220"><a name="p179841930161220"></a><a name="p179841930161220"></a>初始化通信任务配置。uint8_t *类型，支持最大长度64字节，该结构体仅支持通过接口<a href="GetTiling-100.md">GetTiling</a>获取。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="78.28%" headers="mcps1.2.3.1.2 "><p id="p1678950205618"><a name="p1678950205618"></a><a name="p1678950205618"></a>各通信域中每个通信任务的参数配置。uint8_t *类型，支持最大长度280字节，该结构体仅支持通过接口<a href="GetTiling-100.md">GetTiling</a>获取。注意，最多支持配置8个通信任务。</p>
</td>
</tr>
</tbody>
</table>
