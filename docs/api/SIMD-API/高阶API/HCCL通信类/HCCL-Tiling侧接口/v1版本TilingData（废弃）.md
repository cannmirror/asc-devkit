...
<p id="p1919419451692"><a name="p1919419451692"></a><a name="p1919419451692"></a>1：AI CPU与AI Core通过通信任务机制实现消息传递和任务下发；由AI Core侧通过消息通知时设置为1，即算子中使用<a href="../HCCL-Kernel侧接口/HCCL-Kernel侧接口.md">HCCL</a>时设置为1。</p>
</td>
</tr>
