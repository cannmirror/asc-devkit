...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p125969172719"><a name="p125969172719"></a><a name="p125969172719"></a>softMaxRes的数据类型。支持的数据类型为：half、float。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p1287421219275"><a name="p1287421219275"></a><a name="p1287421219275"></a>maxTensor的数据类型。支持的数据类型为：half、float。</p>
</td>
</tr>
...
<p id="p318727114519"><a name="p318727114519"></a><a name="p318727114519"></a>LocalTensor数据结构的定义请参考<a href="../../../基础数据结构/LocalTensor/LocalTensor.md">LocalTensor</a></p>
...
<td class="cellrowborder" valign="top" width="74.16%" headers="mcps1.2.4.1.3 "><p id="p1573415151214"><a name="p1573415151214"></a><a name="p1573415151214"></a>softMaxRes的shape信息，具体定义如下方代码所示，其中参数的含义为：</p>
