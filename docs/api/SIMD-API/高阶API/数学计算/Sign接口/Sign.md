...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001538537601_p125969172719"><a name="zh-cn_topic_0000001538537601_p125969172719"></a><a name="zh-cn_topic_0000001538537601_p125969172719"></a>操作数的数据类型。不同型号支持的数据类型请参考<a href="#li11479111011360">支持的数据类型</a>。</p>
</td>
</tr>
...
-   <a name="li11479111011360"></a>支持的数据类型
