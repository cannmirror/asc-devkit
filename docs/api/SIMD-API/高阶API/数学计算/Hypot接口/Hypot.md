...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p18431192420215"><a name="p18431192420215"></a><a name="p18431192420215"></a>操作数的数据类型。支持的数据类型为：half、bfloat16_t、float。</p>
</td>
</tr>
