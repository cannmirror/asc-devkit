...
<td class="cellrowborder" valign="top" width="80.63%" headers="mcps1.2.3.1.2 "><p id="p18431192420215"><a name="p18431192420215"></a><a name="p18431192420215"></a>操作数的数据类型。支持的数据类型为：half、float。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80.63%" headers="mcps1.2.3.1.2 "><p id="p2201141412564"><a name="p2201141412564"></a><a name="p2201141412564"></a>该参数仅支持<span id="ph15110105411238"><a name="ph15110105411238"></a><a name="ph15110105411238"></a>Ascend 950PR/Ascend 950DT</span>。</p>
<p id="p1977105611138"><a name="p1977105611138"></a><a name="p1977105611138"></a>Fmod计算的相关配置。此参数可选配，FmodConfig类型，具体定义如下方代码所示，其中参数的含义为：</p>
...
完整的调用样例请参考[fmod算子样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/03_libraries/12_math/fmod)。
