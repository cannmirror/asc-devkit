...
<td class="cellrowborder" valign="top" width="69.92%" headers="mcps1.2.4.1.3 "><p id="p765818345579"><a name="p765818345579"></a><a name="p765818345579"></a>输入的平台信息。PlatformAscendC的定义请参见<a href="../../../../Utils-API/平台信息获取/PlatformAscendC/构造及析构函数.md">构造及析构函数</a>。</p>
</td>
</tr>
