...
<p id="p1742555914555"><a name="p1742555914555"></a><a name="p1742555914555"></a>支持的数据类型为：bool、int8_t、uint8_t、int16_t、uint16_t、half、bfloat16_t、int32_t、uint32_t、float、int64_t、uint64_t。</p>
</td>
</tr>
...
<p id="p17686109115611"><a name="p17686109115611"></a><a name="p17686109115611"></a>支持的数据类型为：bool、int8_t、uint8_t、int16_t、uint16_t、half、bfloat16_t、int32_t、uint32_t、float、int64_t、uint64_t。</p>
</td>
</tr>
</tbody>
</table>
