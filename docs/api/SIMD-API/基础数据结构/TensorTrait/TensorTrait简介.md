...
<p id="p17381434135715"><a name="p17381434135715"></a><a name="p17381434135715"></a><span>通过TensorTrait定义的</span>LocalTensor/GlobalTensor不包含<a href="../../其他数据类型/ShapeInfo.md">ShapeInfo</a>信息。</p>
...
<td class="cellrowborder" valign="top" width="78.2%" headers="mcps1.2.3.1.2 "><p id="p1401735165413"><a name="p1401735165413"></a><a name="p1401735165413"></a>数据存放的逻辑位置，<a href="../../其他数据类型/TPosition.md">Tposition</a>类型，默认为TPosition::GM。</p>
</td>
</tr>
