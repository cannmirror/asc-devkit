...
详细示例请参考[RegionProposalSort样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/01_simd_cpp_api/03_basic_api/01_memory_vector_compute/region_proposal_sort)。
