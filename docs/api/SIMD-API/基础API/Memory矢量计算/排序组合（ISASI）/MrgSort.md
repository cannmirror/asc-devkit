...
<p id="p1695212318817"><a name="p1695212318817"></a><a name="p1695212318817"></a><span id="ph6952183114813"><a name="ph6952183114813"></a><a name="ph6952183114813"></a><term id="zh-cn_topic_0000001312391781_term354143892110_1"><a name="zh-cn_topic_0000001312391781_term354143892110_1"></a><a name="zh-cn_topic_0000001312391781_term354143892110_1"></a>Atlas 200I/500 A2 推理产品</term></span>，支持的数据类型为：half/float</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p8114998103"><a name="p8114998103"></a><a name="p8114998103"></a>源操作数的数据类型与目的操作数保持一致。src1、src2、src3、src4类型为<a href="../../../基础数据结构/LocalTensor/LocalTensor.md">LocalTensor</a>，支持的TPosition为VECIN/VECCALC/VECOUT。<span id="ph441646171420"><a name="ph441646171420"></a><a name="ph441646171420"></a>LocalTensor的起始地址需要8字节对齐。</span></p>
</td>
</tr>
...
完整使用样例请参见[MrgSort样例](https://gitcode.com/cann/asc-devkit/blob/master/examples/01_simd_cpp_api/02_features/03_basic_api/02_memory_vector_compute/mrg_sort)。
