...
| 参数名称 | 输入/输出 | 含义 |
| :------- | :-------- | :--- |
| dst | 输出 | 目的操作数，<br><br>类型为[LocalTensor](../../数据结构/LocalTensor/LocalTensor.md)，支持的TPosition为VECIN/VECCALC/VECOUT(存储位置为Unified Buffer)。<br><br>LocalTensor的起始地址需要按照32字节对齐。 |
