...
在所有的输入数据中找出最小值及最小值对应的索引位置。归约指令的总体介绍请参考[如何使用归约计算API](https://gitcode.com/cann/asc-devkit/blob/master/docs/guide/编程指南/类库API/基础API/常用操作速查指导/如何使用归约计算API.md)。ReduceMin计算原理参考[ReduceMax](ReduceMax.md)。
...
<td class="cellrowborder" valign="top" width="73.74737473747375%" headers="mcps1.2.4.1.3 "><p id="p353564621520"><a name="p353564621520"></a><a name="p353564621520"></a>迭代次数。保证不超过int32_t最大值的范围即可。</p>
</td>
</tr>
...
详细示例请参考[ReduceMin样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/02_features/03_basic_api/02_memory_vector_compute/reduce_computation)。
