...
<td class="cellrowborder" valign="top" width="83.49%" headers="mcps1.2.3.1.2 "><p id="p1159919981317"><a name="p1159919981317"></a><a name="p1159919981317"></a>该参数仅支持<span id="ph1672519264137"><a name="ph1672519264137"></a><a name="ph1672519264137"></a>Ascend 950PR/Ascend 950DT</span>。</p>
<p id="p1592118224464"><a name="p1592118224464"></a><a name="p1592118224464"></a>用于配置精度计算模式，RsqrtConfig类型，定义如下：</p>
