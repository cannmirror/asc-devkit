...
<td class="cellrowborder" valign="top" width="83.72%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001429830437_p168351657155818"><a name="zh-cn_topic_0000001429830437_p168351657155818"></a><a name="zh-cn_topic_0000001429830437_p168351657155818"></a>操作数数据类型。支持的数据类型为：half、float。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="83.72%" headers="mcps1.2.3.1.2 "><p id="p1159919981317"><a name="p1159919981317"></a><a name="p1159919981317"></a>该参数仅支持<span id="ph1672519264137"><a name="ph1672519264137"></a><a name="ph1672519264137"></a>Ascend 950PR/Ascend 950DT</span>。</p>
<p id="p1592118224464"><a name="p1592118224464"></a><a name="p1592118224464"></a>用于配置Subnormal计算模式，ExpConfig类型，定义如下：</p>
...
<td class="cellrowborder" valign="top" width="71.58%" headers="mcps1.2.4.1.3 "><p id="p0554313181312"><a name="p0554313181312"></a><a name="p0554313181312"></a><span id="ph793119540147"><a name="ph793119540147"></a><a name="ph793119540147"></a><span id="ph199431319161515"><a name="ph199431319161515"></a><a name="ph199431319161515"></a><a href="https://gitcode.com/cann/asc-devkit/blob/master/docs/guide/编程指南/C++类库API/基础API/接口分类说明/高维切分API.md" target="_blank" rel="noopener noreferrer">mask</a></span>用于控制每次迭代内参与计算的元素。</span></p>
...
<p id="p9554151321320"><a name="p9554151321320"></a><a name="p9554151321320"></a>关于该参数的具体描述请参考<span id="ph43961850144019"><a name="ph43961850144019"></a><a name="ph43961850144019"></a><a href="https://gitcode.com/cann/asc-devkit/blob/master/docs/guide/编程指南/C++类库API/基础API/接口分类说明/高维切分API.md" target="_blank" rel="noopener noreferrer">高维切分API</a></span>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71.58%" headers="mcps1.2.4.1.3 "><p id="p455461351319"><a name="p455461351319"></a><a name="p455461351319"></a>控制操作数地址步长的参数。<a href="../../../其他数据类型/UnaryRepeatParams.md">UnaryRepeatParams</a>类型，包含操作数相邻迭代间相同<span id="ph1256166185416"><a name="ph1256166185416"></a><a name="ph1256166185416"></a>DataBlock</span>的地址步长，操作数同一迭代内不同<span id="ph131833567170"><a name="ph131833567170"></a><a name="ph131833567170"></a>DataBlock</span>的地址步长等参数。</p>
