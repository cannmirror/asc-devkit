...
**图1**  数据搬出分布模式图示<a id="fig-storealign-dist"></a>
...
- 当RegTensor模板参数RegTrait为RegTraitNumOne和RegTraitNumTwo时，支持情况如下：
    ...
    | RegTraitNumTwo | &bull; 单搬出 普通搬运接口<br>&bull; 单搬出PostUpdate扩展搬运接口 | complex32/b64 |
...
**图2**  regTrait为RegTraitNumOne时的三类搬运模式调用方式<a id="fig-storealign-regtrait"></a>
