...
<tr id="row65148245168"><td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.1 "><p id="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_p871618304717"><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_p871618304717"></a><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_p871618304717"></a><span id="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_ph133919917516"><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_ph133919917516"></a><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_ph133919917516"></a>Kirin X90</span></p>
</td>
...
<tr id="row8830112781619"><td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.1 "><p id="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_p3272112116474"><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_p3272112116474"></a><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_p3272112116474"></a><span id="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_ph1327212213477"><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_ph1327212213477"></a><a name="zh-cn_topic_0000001666431622_zh-cn_topic_0000002055722337_ph1327212213477"></a>Kirin 9030</span></p>
</td>
...
-   GetBlockIdx返回当前核的索引，index的范围为\[0, numBlocks\)。numBlocks由用户使用<<<\>\>\>调用时配置，numBlocks数量可以通过[GetBlockNum](GetBlockNum.md)获取。
-   同时启动AIC和AIV的场景，在AIV、AIC上调用GetBlockIdx的取值范围不同：
    -   当AIC和AIV比例为1:2时，AIC上取值范围为\[0, numBlocks\)，AIV上取值范围为\[0, 2 \* numBlocks\)；
    -   当AIC和AIV比例为1:1时，AIC上取值范围为\[0, numBlocks\)，AIV上取值范围为\[0, numBlocks\)。
    -   分离模式下，可以通过[GetTaskRatio](../工具函数/GetTaskRatio.md)获取AI Core上AIC与AIV的比例。
