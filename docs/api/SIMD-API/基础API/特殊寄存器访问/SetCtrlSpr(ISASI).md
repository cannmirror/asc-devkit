...
| CTRL[60] | 用于控制饱和模式的全局生效方式。<br>&bull; 1'b0：单指令设置饱和；<br>&bull; 1'b1：全局设置饱和。 | 1'b1 | 该控制位可与Reg矢量计算API [Cast](../Reg矢量计算/类型转换/Cast.md)配合使用，或与CTRL[48]、CTRL[59]配合使用，具体配置信息参考[表6](#table231122118201)。 |
