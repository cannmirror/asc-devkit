...
<p id="p757311106394"><a name="p757311106394"></a><a name="p757311106394"></a>数据类型为uint32_t，srcStride不要超出该数据类型的取值范围。</p>
</td>
</tr>
...
<p id="p1857315102399"><a name="p1857315102399"></a><a name="p1857315102399"></a>数据类型为uint32_t，dstStride不要超出该数据类型的取值范围。</p>
</td>
</tr>
