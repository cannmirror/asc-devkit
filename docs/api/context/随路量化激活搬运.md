...
<p id="p058917510285"><a name="p058917510285"></a><a name="p058917510285"></a>如果要使能NZ2ND的功能需要同步调用<a href="SetFixpipeNz2ndFlag(ISASI).md">SetFixpipeNz2ndFlag</a>来设置格式转换的相关配置信息。</p>
