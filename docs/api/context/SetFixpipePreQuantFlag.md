...
```
template<template T>
__aicore__ inline void SetFixpipePreQuantFlag(const uint64_t config)
```
...
<td class="cellrowborder" valign="top" width="72.28722872287229%" headers="mcps1.2.4.1.3 "><p id="p169681538125014"><a name="p169681538125014"></a><a name="p169681538125014"></a>量化过程中使用到的标量量化参数，类型为uint64_t。</p>
</td>
</tr>
</tbody>
</table>
