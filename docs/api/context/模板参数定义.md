...
<tr id="row145181172818"><td class="cellrowborder" valign="top" width="23.75237523752375%" headers="mcps1.2.4.1.1 "><p id="p1851811172817"><a name="p1851811172817"></a><a name="p1851811172817"></a>ASCENDC_TPL_TILING_STRUCT_SEL(args0)</p>
</td>
<td class="cellrowborder" valign="top" width="28.202820282028203%" headers="mcps1.2.4.1.2 "><p id="p12518191112286"><a name="p12518191112286"></a><a name="p12518191112286"></a>用于为当前模板参数组合指定Tiling结构体，该结构体不作为核函数模板参数传入。</p>
</td>
<td class="cellrowborder" valign="top" width="48.04480448044804%" headers="mcps1.2.4.1.3 "><p id="p8518311142818"><a name="p8518311142818"></a><a name="p8518311142818"></a>args0：表示当前模板参数组合使用的Tiling结构体名。该接口只能在ASCENDC_TPL_ARGS_SEL(...)中使用，不参与ASCENDC_TPL_SEL_PARAM(...)或GET_TPL_TILING_KEY(...)的参数顺序，也不参与TilingKey编码。</p>
<p id="p951811162820"><a name="p951811162820"></a><a name="p951811162820"></a>未配置本接口的模板参数组合，将使用REGISTER_TILING_DEFAULT注册的默认Tiling结构体。使用本接口时，必须通过REGISTER_TILING_DEFAULT提供默认Tiling结构体。</p>
</td>
</tr>
