...
- 高维切分搬运
    ...
    __aicore__ inline void asc_copy_l12bt(uint64_t dst, __cbuf__ bfloat16_t* src, uint16_t conv_control, uint16_t burst_num, uint16_t burst_len, uint16_t source_gap, uint16_t dst_gap)
    __aicore__ inline void asc_copy_l12bt(uint64_t dst, __cbuf__ half* src, uint16_t conv_control, uint16_t burst_num, uint16_t burst_len, uint16_t source_gap, uint16_t dst_gap)
    __aicore__ inline void asc_copy_l12bt(uint64_t dst, __cbuf__ float* src, uint16_t conv_control, uint16_t burst_num, uint16_t burst_len, uint16_t source_gap, uint16_t dst_gap)
    __aicore__ inline void asc_copy_l12bt(uint64_t dst, __cbuf__ int32_t* src, uint16_t conv_control, uint16_t burst_num, uint16_t burst_len, uint16_t source_gap, uint16_t dst_gap)
    ```
