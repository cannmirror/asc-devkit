...
- 高维切分搬运
    ```cpp
    __aicore__ inline void asc_copy_l12fb_v2(__fbuf__ void* dst, __cbuf__ void* src, uint16_t burst_num, uint16_t burst_len, uint16_t src_stride, uint16_t dst_stride)
    ```
