...
-   NZ Layout
    ...
    通过[MakeNZLayout](struct/layout/layout_fractal/MakeNZLayout.md)接口可以快速的构造连续的NZ Layout格式，自行设置StrideRow1和StrideColum1可以构造非连续的NZ Layout格式。
    ...
    -   ZN Layout
        ...
        通过[MakeZNLayout](struct/layout/layout_fractal/MakeZNLayout.md)接口可以快速的构造连续的ZN Layout格式，自行设置StrideRow1和StrideColum1可以构造非连续的ZN Layout格式。
...
-   RowMajor Layout，一种使用层次化表述法描述的二维行优先排布格式。
    ...
    通过[MakeRowMajorLayout](struct/layout/layout_fractal/MakeRowMajorLayout.md)接口可以快速的构造连续的RowMajor Layout格式，自行设置StrideRow1可以构造非连续的RowMajor Layout格式。
...
-   ColumnMajor Layout，一种使用层次化表述法描述的二维列优先排布格式。
    ...
    通过[MakeColumnMajorLayout](struct/layout/layout_fractal/MakeColumnMajorLayout.md)接口可以快速的构造连续的ColumnMajor Layout格式，自行设置StrideColumn1值可以构造非连续的ColumnMajor Layout格式。
