...
<td class="cellrowborder" valign="top" width="67.44%" headers="mcps1.1.4.1.3 "><p id="p13692185110277">td::tuple结构类型，用于表示张量在不同维度上的坐标值。</p>
<p id="p1329915004219">输入的数据类型支持size_t和Std::Int。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="67.44%" headers="mcps1.1.4.1.3 "><p id="p14181041623">输入的Layout对象。</p>
<p id="p31813716554">输入的数据类型支持size_t和Std::Int。</p>
</td>
</tr>
...
<p id="p37122225552">输入的数据类型支持size_t和Std:Int。</p>
</td>
</tr>
...
<p id="p4409152415551">输入的数据类型支持size_t和Std::Int。</p>
</td>
</tr>
</tbody>
</table>
