...
<p id="zh-cn_topic_0000001953491746_p134246188318"><a name="zh-cn_topic_0000001953491746_p134246188318"></a><a name="zh-cn_topic_0000001953491746_p134246188318"></a><span id="zh-cn_topic_0000001953491746_ph191185131318"><a name="zh-cn_topic_0000001953491746_ph191185131318"></a><a name="zh-cn_topic_0000001953491746_ph191185131318"></a><term id="zh-cn_topic_0000001953491746_zh-cn_topic_0000001312391781_term1253731311225"><a name="zh-cn_topic_0000001953491746_zh-cn_topic_0000001312391781_term1253731311225"></a><a name="zh-cn_topic_0000001953491746_zh-cn_topic_0000001312391781_term1253731311225"></a>Ascend 910C</term></span>，支持ORDER_VALUE_INDEX、ORDER_INDEX_VALUE、ORDER_ONLY_VALUE、ORDER_ONLY_INDEX。</p>
<p id="zh-cn_topic_0000001953491746_p141148133319"><a name="zh-cn_topic_0000001953491746_p141148133319"></a><a name="zh-cn_topic_0000001953491746_p141148133319"></a><span id="zh-cn_topic_0000001953491746_ph1513611133112"><a name="zh-cn_topic_0000001953491746_ph1513611133112"></a><a name="zh-cn_topic_0000001953491746_ph1513611133112"></a><term id="zh-cn_topic_0000001953491746_zh-cn_topic_0000001312391781_term11962195213215"><a name="zh-cn_topic_0000001953491746_zh-cn_topic_0000001312391781_term11962195213215"></a><a name="zh-cn_topic_0000001953491746_zh-cn_topic_0000001312391781_term11962195213215"></a>Ascend 910B</term></span>，支持ORDER_VALUE_INDEX、ORDER_INDEX_VALUE、ORDER_ONLY_VALUE、ORDER_ONLY_INDEX。</p>
</td>
</tr>
</tbody>
</table>
...
-   dst结果存储顺序由order决定，默认为最值，最值索引。返回结果中索引index数据按照dst的数据类型进行存储，比如dst使用half类型时，index按照half类型进行存储，读取时需要使用reinterpret\_cast方法转换到整数类型。若输入数据类型是half，需要使用reinterpret\_cast<uint16\_t\*\>，若输入是float，需要使用reinterpret\_cast<uint32\_t\*\>。比如[调用示例](#section642mcpsimp)中，前两个计算结果为\[9.980e-01 5.364e-06\]，5.364e-06需要使用reinterpret\_cast方法转换得到索引值90。特别地，针对Ascend 910B、Ascend 910C，ORDER\_ONLY\_INDEX（仅返回最值索引）情况下，读取index时都需要使用reinterpret\_cast<uint32\_t\*\>。
