...
DataCopy接口在Atlas 350 加速卡上支持多维数据的搬运，具体可参考[多维数据搬运（ISASI）](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/ascendcopapi/atlasascendc_api_07_00131.html)。以2D场景的搬运为例，代码如下：
