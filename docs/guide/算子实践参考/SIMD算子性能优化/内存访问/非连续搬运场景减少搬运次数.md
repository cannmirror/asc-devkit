...
DataCopy接口在Ascend 950PR/Ascend 950DT上支持多维数据的搬运，具体可参考[多维数据搬运（ISASI）](https://gitcode.com/cann/asc-devkit/blob/master/docs/api/context/多维数据搬运（ISASI）.md)。以2D场景的搬运为例，代码如下：
