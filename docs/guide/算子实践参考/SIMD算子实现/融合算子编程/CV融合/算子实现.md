...
2.  **设置A、B、Bias的数据类型和格式。**
    ...
    设置示例如下，其中TPosition::LCM是Unified Buffer上的逻辑位置，等同于TPosition::VECCALC，关于TPosition的详细内容请参考[TPosition](https://gitcode.com/cann/asc-devkit/blob/master/docs/api/context/TPosition.md)。
