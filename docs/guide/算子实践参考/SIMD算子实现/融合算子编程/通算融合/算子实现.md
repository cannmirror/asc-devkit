...
3.  **运行**
    ...
    在通算融合场景，单算子API调用的程序中需要调用[《HCCL集合通信库接口》](https://www.hiascend.com/document/redirect/CannCommunityHcclApi)中的接口创建通信域，并在多线程上执行AllGatherMatmul算子。以下给出main函数和线程调用函数中关键步骤的代码示例，仅供参考。
