...
使能K轴错峰访问内存的完整样例请参考[K轴错峰加载数据的算子样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_k_reorder_load)。使能该功能的主要步骤如下：
