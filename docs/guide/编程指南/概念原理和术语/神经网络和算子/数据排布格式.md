...
-   **ND、NHWC和NCHW**
    ...
    **图 1**  NCHW和NHWC存储示例<a name="zh-cn_topic_0000001265237150_zh-cn_topic_0228422146_zh-cn_topic_0187054064_fig146585121118"></a>  
    ![](../../../figures/NCHW和NHWC存储示例.png "NCHW和NHWC存储示例")
...
<a name="li51557161818"></a>[GEMV](../../../算子实践参考/SIMD算子实现/矩阵编程（高阶API）/特性场景/矩阵向量乘.md)（矩阵向量乘，General Matrix-Vector Multiply）场景使用的一种数据格式，配置矩阵为VECTOR数据排布格式即代表输入数据是一个向量。
    ...
    **图 2**  GEMV场景输入Vector格式的A矩阵示意图<a name="fig172015331814"></a>  
    ![](../../../figures/GEMV场景输入Vector格式的A矩阵示意图.png "GEMV场景输入Vector格式的A矩阵示意图")
