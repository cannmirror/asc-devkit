...
>[!NOTE]说明 
>下文仅列出代码片段，完整样例请参考[动态输入算子样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/02_features/03_basic_api/04_resource_management/list_tensor_desc_input)。
