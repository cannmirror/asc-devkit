...
-   kernel直调
    -   参考[ListTensorDesc](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/ascendcopapi/atlasascendc_api_07_0009.html)数据结构自行定义ListTensorDesc和TensorDesc结构体，并将实际的输入数据保存至ListTensorDesc结构中。示例如下:
    ...
    -   kernel侧算子实现，通过ListTensorDesc和[TensorDesc](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/ascendcopapi/atlasascendc_api_07_0010.html)提供的接口解析ListTensorDesc输入信息，并处理。示例如下：
