...
-   kernel直调
    ...
    -   kernel侧算子实现，通过ListTensorDesc和[TensorDesc](https://gitcode.com/cann/asc-devkit/blob/master/docs/api/context/TensorDesc.md)提供的接口解析ListTensorDesc输入信息，并处理。示例如下：
