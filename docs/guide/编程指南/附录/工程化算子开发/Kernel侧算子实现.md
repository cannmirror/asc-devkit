...
核函数中调用[GET\_TILING\_DATA](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/ascendcopapi/atlasascendc_api_07_0214.html)获取TilingData的样例如下：
