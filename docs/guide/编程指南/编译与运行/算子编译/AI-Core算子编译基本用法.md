...
<td class="cellrowborder" valign="top" width="56.686868686868685%" headers="mcps1.1.4.1.3 "><p id="p11492114142717"><a name="p11492114142717"></a><a name="p11492114142717"></a>编译时指定的<span id="ph12176116185918"><a name="ph12176116185918"></a><a name="ph12176116185918"></a>AI处理器</span>型号，npu-soc和npu-arch同时配置时，优先启用npu-arch。</p>
...
<p id="p485717333110"><a name="p485717333110"></a><a name="p485717333110"></a>注意，启用该选项后GlobalTensor默认启用L2 Cache，无法通过AscendC::SetL2CacheHint接口设置不启用L2 Cache的模式。</p>
</td>
</tr>
