...
-   核函数定义方式
    -   SIMT VF函数定义：
        ...
        SIMD与SIMT混合编程中SIMT VF核函数定义的[\_\_simt\_vf\_\_](../../语言扩展层/SIMD-BuiltIn关键字.md#li611618392141)、\_\_gm\_\_修饰符需要单独进行标识。关于SIMT VF函数编程的相关约束请参考[附录](../../附录/C++标准支持/C-C++语法限制/函数.md)。
...
样例中介绍的算子完整代码请参见[SIMD与SIMT混合编程实现gather&adds算子样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/00_introduction/03_matrix_vector_fusion/simt_gather_and_simd_adds)。
