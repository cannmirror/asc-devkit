...
-   [编程指南](编程指南/)
    ...
    -   [编程模型](编程指南/编程模型/)
        ...
        -   [AI Core SIMD编程](编程指南/编程模型/AI-Core-SIMD编程/)
            -   [抽象硬件架构](编程指南/编程模型/AI-Core-SIMD编程/抽象硬件架构.md)
            -   [核函数](编程指南/编程模型/AI-Core-SIMD编程/核函数.md)
            -   [SIMD编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/)
        ...
        -   [AI Core SIMT编程](编程指南/编程模型/AI-Core-SIMT编程/)
    ...
    -   [编译与运行](编程指南/编译与运行/)
        -   [AI Core SIMD编译](编程指南/编译与运行/AI-Core-SIMD编译/)
        ...
        -   [AI Core SIMT编译](编程指南/编译与运行/AI-Core-SIMT编译/)
    ...
    -   [附录](编程指南/附录/)
        ...
        -   [工程化算子开发](编程指南/附录/工程化算子开发/)
            ...
            -   [Host侧Tiling实现](编程指南/附录/工程化算子开发/Host侧Tiling实现/)
        ...
        -   [算子入图（GE图）开发](编程指南/附录/算子入图（GE图）开发/)
...
-   [算子实践参考](算子实践参考/)
    ...
    -   [SIMD算子性能优化](算子实践参考/SIMD算子性能优化/)
        -   [优化建议总览表](算子实践参考/SIMD算子性能优化/优化建议总览表.md)
        -   [Tiling策略](算子实践参考/SIMD算子性能优化/Tiling策略/)
            -   [核间负载均衡](算子实践参考/SIMD算子性能优化/Tiling策略/核间负载均衡.md)

        -   [头尾开销优化](算子实践参考/SIMD算子性能优化/头尾开销优化/)
        ...
        -   [内存访问](算子实践参考/SIMD算子性能优化/内存访问/)
            ...
            -   [避免Unified Buffer的bank冲突](算子实践参考/SIMD算子性能优化/内存访问/避免Unified Buffer的bank冲突/)
                -   [概述](算子实践参考/SIMD算子性能优化/内存访问/避免Unified Buffer的bank冲突/概述.md)
                -   [避免bank冲突（NPU架构版本220x）](算子实践参考/SIMD算子性能优化/内存访问/避免Unified Buffer的bank冲突/避免bank冲突（NPU架构版本220x）.md)
                -   [避免bank冲突（Ascend 950PR/Ascend 950DT）](算子实践参考/SIMD算子性能优化/内存访问/避免Unified Buffer的bank冲突/避免bank冲突（Ascend-950PR-Ascend-950DT）.md)

            -   [L2 Cache切分](算子实践参考/SIMD算子性能优化/内存访问/L2-Cache切分.md)

        -   [矢量计算](算子实践参考/SIMD算子性能优化/矢量计算/)
            ...
            -   [VF性能优化](算子实践参考/SIMD算子性能优化/矢量计算/VF性能优化/)
    ...
    -   [SIMD与SIMT混合算子性能优化](算子实践参考/SIMD与SIMT混合算子性能优化/)
        -   [内存访问](算子实践参考/SIMD与SIMT混合算子性能优化/内存访问/)
            -   [使用Unified Buffer提升内存访问效率](算子实践参考/SIMD与SIMT混合算子性能优化/内存访问/使用Unified-Buffer提升内存访问效率.md)

        -   [计算优化](算子实践参考/SIMD与SIMT混合算子性能优化/计算优化/)
    ...
    -   [优秀实践](算子实践参考/优秀实践/)
        ...
        -   [Matmul性能调优案例](算子实践参考/优秀实践/Matmul性能调优案例/)
...
-   [兼容性迁移指南](兼容性迁移指南/)
    ...
    -   [351x架构迁移指导](兼容性迁移指南/351x架构迁移指导/)
        -   [220x到351x架构变更](兼容性迁移指南/351x架构迁移指导/220x到351x架构变更.md)
        -   [220x迁移351x指导](兼容性迁移指南/351x架构迁移指导/220x迁移351x指导/)
