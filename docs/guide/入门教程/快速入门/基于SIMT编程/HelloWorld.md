...
本示例展示了如何使用Ascend C SIMT编写一个简单的"Hello World"程序，包括核函数（设备侧实现的入口函数）的实现、调用流程以及编译运行的完整步骤。通过本示例，您可以快速了解Ascend C SIMT编程的基本开发流程。完整样例请参考[hello\_world](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/03_simt_api/00_introduction/00_quickstart/hello_world_simt/README.md)。
