# Static Tensor Programming Add Sample

## Overview

This sample implements Add vector addition based on the static Tensor programming model. It uses the LocalMemAllocator interface for memory management, SetFlag and WaitFlag interfaces for synchronization management, and Double Buffer technique for pipeline optimization.
...
│   └── add.asc                 // Ascend C sample implementation using LocalMemAllocator & invocation sample
```
...
- Sample Specifications:
  ...
  <tr><td rowspan="1" align="center">Sample Output</td><td align="center">z</td><td align="center">[72, 4096]</td><td align="center">float</td><td align="center">ND</td></tr>
...
- Sample Implementation:
  ...
  - Kernel Implementation  
    CopyIn transfers input data from Global Memory to Local Memory, Compute performs addition on the input data, and CopyOut transfers the computation results back to Global Memory.
