...
- 样例执行
  ...
  - 编译选项说明
    ...
    | `CMAKE_ASC_ARCHITECTURES` | 指定NPU架构版本号。<br>`dav-2201` 对应 Atlas A2 训练系列产品/Atlas A2 推理系列产品和Atlas A3 训练系列产品/Atlas A3 推理系列产品，`dav-3510` 对应 Ascend 950PR/Ascend 950DT |
  执行结果如下，说明精度对比成功。
  ```bash
  test pass!
  ```
