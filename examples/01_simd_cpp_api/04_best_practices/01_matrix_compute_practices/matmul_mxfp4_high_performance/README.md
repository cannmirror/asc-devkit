...
$$
C = (A \otimes \text{scaleA}) \times (B \otimes \text{scaleB})
$$
...
| `singleCoreN` | `1024` |
| `singleCoreK` | `8192` |
| `baseM=baseN=baseK` | `256` |
| `stepKa=stepKb` | `2 / 2` |
| `scaleFactorKa=scaleFactorKb (case1)` | `1 / 1` |
| `scaleFactorKa=scaleFactorKb (case2)` | `4 / 4` |
| 数据类型 | A/B: `fp4x2` (`0.5 Byte/elem`), scale: `fp8` (`1 Byte/elem`) |
