# optimize_reduce_invalid_datacopy Sample

## Overview
Reduce invalid data copying by setting Compact mode when using the DataCopyPad API.
...
│   └── optimize_reduce_invalid_datacopy.asc         // AscendC operator implementation and sample invocation
```
...
- Operator Specifications:
  ...
  <tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="4" align="center">optimize_reduce_invalid_datacopy</td></tr>
  </table>
