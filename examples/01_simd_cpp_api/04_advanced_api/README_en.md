...
| [04_reduce](./04_reduce) | This sample set introduces typical usage of reduce operations with different operator features and provides corresponding end-to-end implementations |
