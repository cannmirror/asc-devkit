...
VERSION_ASCEND910B_LIST="Ascend910B1 Ascend910B2 Ascend910B3 Ascend910B4"
if [[ " $VERSION_ASCEND910B_LIST " == *" $SOC_VERSION "* ]]; then
    cp -rf $OP_NAME/op_kernel_cube_only/* CustomOp/op_kernel
else
