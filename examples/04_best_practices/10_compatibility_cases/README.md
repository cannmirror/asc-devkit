...
| [init_const_value_910B](./init_const_value_910B) | 本样例直接使用基础API InitConstValue对L0A Buffer和L0B Buffer进行初始化。 |
| [init_const_value_950](./init_const_value_950) | 新架构版本删除L0A Buffer/L0B Buffer初始化的相关硬件指令。用户可以通过先初始化L1 Buffer，再通过LoadData接口将L1 Buffer上的数据搬运到L0A Buffer/L0B Buffer。 |
