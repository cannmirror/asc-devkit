# GetReduceMaxMinCount样例

## 概述

本样例介绍基础api GetReduceMaxMinCount的调用，GetReduceMaxMinCount的功能是获取ReduceMax、ReduceMin连续场景下的最大/最小值以及相应的索引值。
...
```
├── get_reduce_max_min_count
│   ├── CMakeLists.txt                    // 编译工程文件
│   └── get_reduce_max_min_count.asc      // Ascend C算子实现 & 调用样例
```
...
- 算子规格：  
  ...
  <tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">get_reduce_max_min_count</td></tr>  
  </table>
