...
class BlockMmadMultiBlockNaiveWithLayout : public testing::Test {
protected:
    void SetUp() {
...
#define BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(tilingParams, aT, bT, cT, biasT, transA, transB)                   \
    namespace BlockMmadMultiBlockNaiveWithLayout_Case_##tilingParams##_##aT##_##bT##_##cT##_##biasT##_##transA##_##transB   \
    {                                                                                                                  \
        ...
        TEST_F(BlockMmadMultiBlockNaiveWithLayout,                                                                      \
               BlockMmadMultiBlockNaiveWithLayout_Case_##tilingParams##_##aT##_##bT##_##cT##_##biasT##_##transA##_##transB) \
        {                                                                                                              \
...
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params1, half, half, half, half, true, true);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params1, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, true, true);

BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, half, half, half, half, false, false);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, half, half, half, half, false, true);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, half, half, half, half, true, false);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, half, half, half, half, true, true);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, false, false);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, false, true);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, true, false);
BLOCK_MMAD_MULTI_BLOCKNAIVEWITHLAYOUT_TESTCASE(params2, bfloat16_t, bfloat16_t, bfloat16_t, bfloat16_t, true, true);
