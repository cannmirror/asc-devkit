 ...
 * \brief
 */
#ifndef ACT_INCLUDE_MATMUL_TILE_COPY_OUI_COPY_OUT_WITH_PARAMS_H
#define ACT_INCLUDE_MATMUL_TILE_COPY_OUI_COPY_OUT_WITH_PARAMS_H
...
public:
    ...
    __aicore__ inline void operator()(const AscendC::GlobalTensor<DstT>& gm, const AscendC::LocalTensor<SrcT>& co1Local,
                                      int curRow, int curCol, int32_t l0CTileHeight, int32_t l0CTileWidth,
                                      int32_t baseM, int32_t baseN, int orgM, int orgN, int orgKc)
    {
...
public:
    ...
    __aicore__ inline void operator()(const AscendC::GlobalTensor<DstT>& gm, const AscendC::LocalTensor<SrcT>& co1Local,
                                      int curRow, int curCol, int32_t l0CTileHeight, int32_t l0CTileWidth,
                                      int32_t baseM, int32_t baseN, int orgM, int orgN, int orgKc, uint64_t quantScalar)
    {
#if __CCE_AICORE__ == 220
        CopyOutNZ2ND(gm, co1Local, curRow, curCol, l0CTileHeight, l0CTileWidth, baseM, baseN, orgKc != 0 ? orgKc : orgN,
                     quantScalar);
...
public:
    ...
    __aicore__ inline void operator()(const AscendC::LocalTensor<DstT>& co2Local,
                                      const AscendC::LocalTensor<SrcT>& co1Local, int curRow, int curCol,
                                      int32_t l0CTileHeight, int32_t l0CTileWidth, int32_t baseM, int32_t baseN,
                                      int orgM, int orgN, int orgKc, const AscendC::LocalTensor<uint64_t>& quantTensor)
    {
#if defined(__DAV_C310__)
    ...
    __aicore__ inline void operator()(const AscendC::LocalTensor<DstT>& co2Local,
                                      const AscendC::LocalTensor<SrcT>& co1Local, int curRow, int curCol,
                                      int32_t l0CTileHeight, int32_t l0CTileWidth, int32_t baseM, int32_t baseN,
                                      int orgM, int orgN, int orgKc, uint64_t quantScalar)
    {
#if defined(__DAV_C310__)
        CopyOutNZ2ND(co2Local, co1Local, curRow, curCol, l0CTileHeight, l0CTileWidth, baseM, baseN,
