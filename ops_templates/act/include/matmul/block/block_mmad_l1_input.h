 ...
 * \brief
 */
#ifndef MATMUL_BLOCK_BLOCK_MMAD_L1_INPUT_H
#define MATMUL_BLOCK_BLOCK_MMAD_L1_INPUT_H
...
class BlockMmad<MatmulL1Input<>, L1TileShape, L0TileShape, AT, BT, CT, BiasT, TileCopy,
    AscendC::Std::enable_if_t<IsMatmulLayoutTypeV<AT>>>
    : public BlockMmad<MatmulL1Input<>, L1TileShape, L0TileShape,
        ToMatmulTypeT<AT>, ToMatmulTypeT<BT>, ToMatmulTypeT<CT>, ToMatmulTypeT<BiasT>, TileCopy> {
    using Base = BlockMmad<MatmulL1Input<>, L1TileShape, L0TileShape,
                           ToMatmulTypeT<AT>, ToMatmulTypeT<BT>, ToMatmulTypeT<CT>, ToMatmulTypeT<BiasT>, TileCopy>;
    using Base::Base;
};
...
*
* The class is specialized base on MatmulL1Input<> and TileCopy<Ascend910_95, CopyNoGmIn>
*/
template <class L1Shape, class L0Shape, class AType, class BType, class CType, class BiasType>
class BlockMmad<MatmulL1Input<>, L1Shape, L0Shape, AType, BType, CType, BiasType,
    ...
    : public BlockMmadWithParams<
        BlockMmad<MatmulL1Input<>, L1Shape, L0Shape, AType, BType, CType, BiasType,
                  Tile::TileCopy<Arch::Ascend910_95, Tile::CopyNoGmIn>>,
        MatmulL1Input<>, L1Shape, L0Shape, AType, BType, CType, BiasType,
        Tile::TileCopy<Arch::Ascend910_95, Tile::CopyNoGmIn>
    > {
public:
...
public:
    ...
    * @param [in] ubCmatrix: output ub tensor
    * @param [in] enAtomic: whether to enable atomic operations on the output GM
    */
    ...
    * @param [in] gm: global memory address for matmul computation output
