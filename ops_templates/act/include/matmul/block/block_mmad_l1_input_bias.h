 ...
 * \brief
 */
#ifndef ACT_INCLUDE_MATMUL_BLOCK_BLOCK_MMAD_L1_INPUT_BIAS_H
#define ACT_INCLUDE_MATMUL_BLOCK_BLOCK_MMAD_L1_INPUT_BIAS_H
...
class BlockMmad<MatmulL1InputBias<>, L1TileShape_, L0TileShape_, AType_, BType_, CType_, BiasType_,
