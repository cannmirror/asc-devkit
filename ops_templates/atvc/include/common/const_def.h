...
namespace ATVC {
    ...
    constexpr static int64_t CONST63 = 63;

    constexpr int32_t MAX_DIM = 9;

    constexpr static uint64_t WORKSPACE_SIZE = 16 * 1024 * 1024;  // fixed workspace size for ascendc
    constexpr static uint64_t BLOCK_SIZE_32K = 32 * 1024;
    constexpr static uint64_t BLOCK_SIZE_48K = 48 * 1024;
    constexpr static uint64_t BLOCK_SIZE_64K = 64 * 1024;
}
#endif