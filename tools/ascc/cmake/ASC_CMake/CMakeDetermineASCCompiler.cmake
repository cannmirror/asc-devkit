...
if(NOT DEFINED ASCEND_HOME_PATH)
    message(WARNING "ASCEND_HOME_PATH is not set. Set to env variable ASCEND_HOME_PATH.")
    if(NOT EXISTS $ENV{ASCEND_HOME_PATH})
        ...
        set(ASCEND_HOME_PATH ${DEFAULT_ASCEND_PATH} CACHE PATH "Path for CANN package")
    else()
        set(ASCEND_HOME_PATH $ENV{ASCEND_HOME_PATH} CACHE PATH "Path for CANN package")
    endif()
else()
    set(ASCEND_HOME_PATH ${ASCEND_HOME_PATH} CACHE PATH "Path for CANN package")
endif()

message(STATUS "System processer: ${CMAKE_SYSTEM_PROCESSOR}")
if (CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64")
    set(ASCEND_CANN_PACKAGE_LINUX_PATH ${ASCEND_HOME_PATH}/x86_64-linux)
elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|arm64|arm")
    set(ASCEND_CANN_PACKAGE_LINUX_PATH ${ASCEND_HOME_PATH}/aarch64-linux)
else ()
