...
private:
    ...
    void AclnnGenFallBackImplFunc(
        OpDef& opDef, std::ofstream& outfile, std::vector<size_t>& hostInputs,
        const std::vector<size_t>& refIndex) const;
    ...
    void AclnnGenCovertTensor(
        std::vector<OpParamDef>& param, std::ofstream& outfile, std::vector<size_t>& hostInputs,
    ...
    void AclnnGenCallGetWorkspaceSizeFunc(
        OpDef& opDef, const std::vector<size_t> refIndex, std::ofstream& outfile) const;
    void AclnnGenOpapiFuncIoName(
        std::vector<OpParamDef>& param, const std::vector<size_t> refIndex, bool isOutput,
    ...
    void AclnnGenFallBackGetWorkspaceSizeFunc(
        OpDef& opDef, std::ofstream& outfile, std::vector<size_t>& refIndex) const;
    ...
    void AclnnGenDestroyImpl(
        std::vector<OpParamDef>& param, std::ofstream& outfile, const std::vector<size_t>& refIndex,
        bool isInput) const;
