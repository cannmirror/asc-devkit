...
# ----------------------------------------------------------------------------------------------------------
"""
ArchRuntimeConfig ascend910_55
"""
...
class ArchRuntimeConfig(RuntimeConfig):
    def __init__(self):
        ...
        enable_simt = True
        dump_size_multiples = 108
        chip_version = "310r6"
        decode_mode_v310 = True
        ...
        needs_ffts = False
        support_dci = True
        support_raw_aic_only_dump_tensor = True
        support_mix = True
        dci_macro = "defined(__DAV_310R6__)"
        gen_isolation_macro_type = IsolationMacroType.ISOLATION_MACRO_DEFAULT
        cube_core_type_macro = "__DAV_310R6_CUBE__"
        vec_core_type_macro = "__DAV_310R6_VEC__"
