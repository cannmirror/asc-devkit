...
InferChannelParamsFromIFile = namedtuple('InferChannelParamsFromIFile', \
    ...
    'super_kernel_early_start_wait_flag', 'tiling_key_deterministic', 'tiling_key_group_map'])
...
KERNEL_TYPE_STR_TO_TPL = {
    "KERNEL_TYPE_AIV_ONLY": "ASCENDC_TPL_AIV_ONLY",
    "KERNEL_TYPE_AIC_ONLY": "ASCENDC_TPL_AIC_ONLY",
    "KERNEL_TYPE_MIX_AIV_1_0": "ASCENDC_TPL_MIX_AIV_1_0",
    "KERNEL_TYPE_MIX_AIC_1_0": "ASCENDC_TPL_MIX_AIC_1_0",
    "KERNEL_TYPE_MIX_AIC_1_1": "ASCENDC_TPL_MIX_AIC_1_1",
    "KERNEL_TYPE_MIX_AIC_1_2": "ASCENDC_TPL_MIX_AIC_1_2",
    "KERNEL_TYPE_AICORE": "ASCENDC_TPL_AICORE",
    "KERNEL_TYPE_VECTORCORE": "ASCENDC_TPL_VECTORCORE",
    "KERNEL_TYPE_MIX_AICORE": "ASCENDC_TPL_MIX_AICORE",
    "KERNEL_TYPE_MIX_VECTOR_CORE": "ASCENDC_TPL_MIX_VECTOR_CORE",
}
