...
show_help() {
    ...
    echo "  1: Load2DA (A矩阵 L1->L0A)"
    echo "  2: Load2DB (B矩阵 L1->L0B)"
    echo "  3: Load2DAtranspose (A矩阵转置)"
    echo "  4: Load2DBtranspose (B矩阵转置)"
    echo "  5: Load3DA (A矩阵 3D)"
    echo "  6: Load3DB (B矩阵 3D)"
    ...
    echo "  11: Load2DA (Load2Dv2)"
    echo "  12: Load2DB (Load2Dv2)"
    echo "  13: Load2DMxA (带Scale)"
    echo "  14: Load2DMxB (带Scale)"
    echo "  15: Load3DA (Load3Dv2)"
    echo "  16: Load3DB (Load3Dv2)"
    echo "  17: Load2DBtranspose"
    echo "  18: LoadBias"
