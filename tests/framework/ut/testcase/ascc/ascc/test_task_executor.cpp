...
TEST_F(TEST_TASK_EXECUTOR, task_executor_one_group_one_task)
{
    std::string inputFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_1.cpp";
    std::string preprocessFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_1.ii";
    TaskExecutor exec;
    TaskGroup group_1(TaskStep::CODEGEN);
...
TEST_F(TEST_TASK_EXECUTOR, task_executor_one_group_two_task)
{
    std::string inputFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_1.cpp";
    std::string preprocessFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_2.ii";
    std::string objectFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_2.o";
    TaskExecutor exec;
    TaskGroup group_1(TaskStep::CODEGEN);
...
TEST_F(TEST_TASK_EXECUTOR, task_executor_two_group_two_task)
{
    ...
    std::string inputFile_2 =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_2.cpp";
...
TEST_F(TEST_TASK_EXECUTOR, task_executor_two_step_three_group_five_task)
{
    ...
    std::string objectFile_1 =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_1.o";
    TaskExecutor exec;
    ...
    std::string binFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo.bin";
...
{
    std::string inputFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_not_exist.cpp";
    std::string preprocessFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_1.ii";
    std::string objectFile =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_1.o";
...
TEST_F(TEST_TASK_EXECUTOR, task_executor_one_group_two_task_exit_failed)
{
    ...
    std::string inputFile_3 =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_3.cpp";
    std::string objectFile_3 =
        "../../../test/ut/testcase/ascc/hello_world/input_demo_3.o";
