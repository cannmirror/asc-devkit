...
TEST_F(TEST_ASCC_HOST_STUB, ascc_GenHostStubFileAic)
{
    ...
    storage.AddInfo("../../../test/ut/testcase/ascc/hello_world/hello_world.cpp",
        Ascc::AscCursorTypes::ASC_CURSOR_TEMPLATE_FUCNTION, funcTemplates);
    Ascc::AsccGlobalEnvManager::GetInstance().asccTmpAutoGenPath = "../../../test/ut/testcase/ascc/hello_world/";

    Ascc::AsccHostStub hostStubGenerator(Ascc::PreTaskType::NONE);
    EXPECT_NO_THROW(hostStubGenerator.GenHostStubFile());
    system("rm ../../../test/ut/testcase/ascc/hello_world/host_stub.h");
}
...
{
    Ascc::AsccGlobalEnvManager::GetInstance().asccTmpAutoGenPath = absPath("../../../test/ut/testcase/ascc/hello_world/");
    Ascc::AsccHostStub hostStubGenerator(Ascc::PreTaskType::NONE);
    EXPECT_NO_THROW(hostStubGenerator.GenHostStubFile());
...
TEST_F(TEST_ASCC_HOST_STUB, ascc_GenHostStubHeadCode)
{
    std::ofstream codeStream(
        "../../../test/ut/testcase/ascc/hello_world/hello_world_host_head.txt", std::ios::out);
    Ascc::AsccGlobalEnvManager::GetInstance().asccTmpAutoGenPath = "../../../test/ut/testcase/ascc/hello_world/";
    Ascc::AsccHostStub hostStubGenerator(Ascc::PreTaskType::NONE);
    ...
    system("rm ../../../test/ut/testcase/ascc/hello_world/hello_world_host_head.txt");
}
...
{
    std::string hostStubFilePath = "../../../test/ut/testcase/ascc/hello_world/hello_world_empty.cpp";
    std::string objectFilePath = "../../../test/ut/testcase/ascc/hello_world/hello_world_empty.o";
    system(("touch ../../../test/ut/testcase/ascc/hello_world/host_stub.h"));
    Ascc::AsccGlobalEnvManager::GetInstance().asccTmpAutoGenPath = "../../../test/ut/testcase/ascc/hello_world";
    Ascc::AsccHostStub hostStubGenerator(Ascc::PreTaskType::NONE);
...
TEST_F(TEST_ASCC_HOST_STUB, ascc_GenAclrtLaunchNormal)
{
    ...
    std::string tmpFile = "../../../test/ut/testcase/ascc/hello_world/generate_aclrt_launch_normal.txt";
