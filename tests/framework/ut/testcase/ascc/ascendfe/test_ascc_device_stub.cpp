...
{
    std::string inputFile = "../../../test/ut/testcase/ascc/hello_world/hello_world.cpp";
    std::string outputFile = "../../../test/ut/testcase/ascc/hello_world/hello_world_device.txt";
    Ascc::AsccDeviceStub generator(Ascc::ShortSoCVersion::ASCEND910B, "./");
    std::unordered_map<std::string, std::unordered_set<std::string>> kernelCallLines;
    
    std::string parent = absolutePath("../../../test/ut/testcase/ascc/hello_world/");
    ...
    system("rm ../../../test/ut/testcase/ascc/hello_world/hello_world_device.txt");
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_GenTemplateStubFuncDefinition)
{
    ...
    std::ofstream stubCode(
        "../../../test/ut/testcase/ascc/hello_world/stub_func_definition.txt", std::ios::out);
    ...
    system("rm ../../../test/ut/testcase/ascc/hello_world/stub_func_definition.txt");
}
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_GetManglingList)
{
    ...
    MOCKER(&Ascc::CheckAndGetFullPath, std::string(const std::string &))
        .stubs().will(returnValue(std::string("../../../test/ut/testcase/ascc/hello_world")));
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_StubFuncKtypeSectionImpl)
{
    Ascc::AsccDeviceStub generator(Ascc::ShortSoCVersion::ASCEND910B, "./");
    std::ofstream stubCode(
        "../../../test/ut/testcase/ascc/hello_world/stub_func_ktype.txt", std::ios::out);
    Ascc::AsccInfoFunction::FunctionInfo newFuncInfo;
    ...
    EXPECT_EQ(result, Ascc::AsccStatus::SUCCESS);
    system("rm ../../../test/ut/testcase/ascc/hello_world/stub_func_ktype.txt");
}
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_GenStubFunc)
{
    ...
    info.returnType = "void";
    std::ofstream stubCode(
        "../../../test/ut/testcase/ascc/hello_world/get_stub_func.txt", std::ios::out);
    Ascc::AsccStatus result =
    ...
    EXPECT_EQ(result, Ascc::AsccStatus::FAILURE);
    system("rm ../../../test/ut/testcase/ascc/hello_world/get_stub_func.txt");
}
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_StubFuncWorkSpaceImpl)
{
    Ascc::AsccDeviceStub generator(Ascc::ShortSoCVersion::ASCEND910B, "./");
    std::ofstream stubCode(
        "../../../test/ut/testcase/ascc/hello_world/stub_func_workspace.txt", std::ios::out);
    ...
    stubCode.close();
    system("rm ../../../test/ut/testcase/ascc/hello_world/stub_func_workspace.txt");
}
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_UpdateNewWorkflowFlag)
{
    ...
    static std::unordered_map<std::string, std::unordered_set<std::string>> mocker_map{
        {"../../../test/ut/testcase/ascc/hello_world/hello_world_empty.cpp", {"0:1"}}
    };
    std::string inputFile("../../../test/ut/testcase/ascc/hello_world/hello_world_empty.cpp");
    ...
    std::string filePath = "../../../test/ut/testcase/ascc/hello_world/hello_world_empty.cpp";
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_StubFuncDumpAndHardSyncImpl)
{
    Ascc::AsccDeviceStub generator(Ascc::ShortSoCVersion::ASCEND910B, "./");
    std::ofstream stubCode(
        "../../../test/ut/testcase/ascc/hello_world/stub_func_dump.txt", std::ios::out);
    MOCKER(&Ascc::AsccDeviceStub::IsMix).stubs().will(returnValue(true));
    generator.StubFuncDumpAndHardSyncImpl(stubCode, true, true, true);
    stubCode.close();
    system("rm ../../../test/ut/testcase/ascc/hello_world/stub_func_dump.txt");
}
...
TEST_F(TEST_ASCC_DEVICE_STUB, ascc_StubFuncCallImpl)
{
    Ascc::AsccDeviceStub generator(Ascc::ShortSoCVersion::ASCEND910B, "./");
    std::ofstream stubCode(
        "../../../test/ut/testcase/ascc/hello_world/stub_func_call.txt", std::ios::out);
    Ascc::AsccInfoFunction::FunctionInfo funcInfo;
    generator.StubFuncCallImpl(stubCode, funcInfo, "add");
    stubCode.close();
    system("rm ../../../test/ut/testcase/ascc/hello_world/stub_func_call.txt");
}
