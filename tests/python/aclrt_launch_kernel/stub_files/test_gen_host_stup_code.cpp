...
extern "C" uint32_t aclrtlaunch_add_custom(uint32_t blockDim, void* stream, bool bool_1, bool bool_2, uint32_t uint32_1, A* tmpStruct, uint16_t uint16_1, void* x, void* y, void* z, AddCustomTilingData* tiling)
{
    struct {
