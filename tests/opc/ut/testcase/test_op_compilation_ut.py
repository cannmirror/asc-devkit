...
from fusion_op_utils import (get_extra_params, set_l1_fusion_type, get_fusion_pattern, get_classify_info,
                             get_op_inputs_args, get_fusion_build_cfg, get_output_attrs_for_all_args)
...
class TestOpCompilationUt(unittest.TestCase):
    ...
    def test_00_op_compilation_ut(self):
        """test op_compilation"""
    ...
    def test_01_op_compilation_st(self):
        """test op_compilation"""
    ...
    def test_03_op_compilation_ut(self):
    ...
    def test_compile_cann_ub_search_ut(self):
        """test test_compile_cann_ub_search_ut"""
        logger.debug("Start to execute ============ test_compile_cann_ub_search_ut ============")
        ...
        logger.debug("Testcase delete files in output dir")
        self.del_files(test_root_dir + "/output")
        logger.debug("End to execute ============ test_compile_cann_ub_search_ut ============")
    ...
    def test_01_op_compilation_json_file_error_ut(self):
    ...
    def test_02_op_compilation_mode64_ut(self):
    ...
    def test_op_compilation_input_options_ut(self):
    ...
    def test_04_create_kernel_meta_dir_ut(self):
        """test op_compilation"""
    ...
    def test_05_verify_kernel_meta_lock_ut(self):
        """test op_compilation"""
    ...
    def test_generate_supportinfo_01_ut(self):
        logger.debug("Start to execute ============ test_generate_supportinfo_01_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        l2_mode_flag = "0"
        post_compilation = FusionOpPostCompile(opc_compile_args, l1_fusion_flag, l2_fusion_flag, l2_mode_flag, fusion_impl_mode)
        single_post_compilation = SingleOpPostCompile(opc_compile_args, l1_fusion_flag, l2_fusion_flag, l2_mode_flag, fusion_impl_mode)
        post_compilation.update_supportinfo_to_json_file(json_info,  test_debug_dir)
        op_info = {
            "op_type": "Add",
        ...
        post_compilation.update_supportinfo_to_json_file(op, test_debug_dir)
        dyn_op = {
            "op_type": "Add",
            "kernel_name": "add12343",
            "kernel_meta_path":test_debug_dir,
        ...
        single_post_compilation.update_info_to_json_file(dyn_op, dyn_op, test_debug_dir)
        logger.debug("End to execute ============ test_generate_supportinfo_01_ut ============")
    ...
    def test_generate_supportinfo_03_ut(self):
        logger.debug("Start to execute ============ test_generate_supportinfo_03_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        json_dict_path = test_root_dir + "/stub/files/json_dict.json"
        test_debug_dir = test_root_dir + "/debug_dir/kernel_meta/testSupportInfo.json"
        ...
        single_post_compilation.update_info_to_json_file(op_info, op_info, test_debug_dir)
        logger.debug("End to execute ============ test_generate_supportinfo_03_ut ============")

    def test_generate_supportinfo_04_ut(self):
        logger.debug("Start to execute ============ test_generate_supportinfo_04_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        json_dict_path = test_root_dir + "/stub/files/json_dict.json"
        test_debug_dir = test_root_dir + "/debug_dir/kernel_meta/testSupportInfo.json"
        ...
        single_post_compilation.update_info_to_json_file(op_info, op_info, test_debug_dir)
        logger.debug("End to execute ============ test_generate_supportinfo_04_ut ============")
    ...
    def test_get_extra_params_ut(self):
        logger.debug("Start to execute ============ test_get_extra_params_ut ============")
        extra_params = {"op_type": "matmul",
                   "kernel_name": "kernel_namexxx"}
        get_extra_params(extra_params)
        logger.debug("End to execute ============ test_get_extra_params_ut ============")

    def test_set_l1_fusion_type_ut(self):
        logger.debug("Start to execute ============ test_set_l1_fusion_type_ut ============")
        op_node = {
            "output_desc": [{
                "L1_fusion_type": 123
            }],
        ...
        logger.debug("End to execute ============ test_set_l1_fusion_type_ut ============")

    def test_compress_node_ut(self):
        logger.debug("Start to execute ============ test_compress_node_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        logger.debug("End to execute ============ test_compress_node_ut ============")

    def test_trans_matmulcompress_bias_shape_ut(self):
        logger.debug("Start to execute ============ test_trans_matmulcompress_bias_shape_ut ============")
        node = {
        "name": "Conv2D/weight",
		"type": "Const",
		"id": 3,
        ...
        logger.debug("End to execute ============ test_trans_matmulcompress_bias_shape_ut ============")

    def test_trans_biasadd_shape_ut(self):
        logger.debug("Start to execute ============ test_trans_biasadd_shape_ut ============")
        node = {
        "name": "Conv2D/weight",
		"type": "Const",
		"id": 3,
        ...
        trans_biasadd_shape(data_node, node)
        logger.debug("End to execute ============ test_trans_biasadd_shape_ut ============")

    def test_trans_mul_shape_ut(self):
        logger.debug("Start to execute ============ test_trans_mul_shape_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        logger.debug("Start to execute ============ test_calculate_real_group_ut ============")

    def test_trans_elemwise_shape_ut(self):
        logger.debug("Start to execute ============ test_trans_elemwise_shape_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        json_path = test_root_dir + "/stub/files/json_test_2.json"
        with open(json_path, "r") as file_in:
        ...
        trans_elemwise_shape(data_node, node, op_list)
        logger.debug("End to execute ============ test_trans_elemwise_shape_ut ============")

    def test_trans_batch_matmul_shape_ut(self):
        logger.debug("Start to execute ============ test_trans_batch_matmul_shape_ut ============")
        node = {
        "name": "Conv2D/weight",
		"type": "Const",
		"id": 3,
        ...
        ret = trans_batch_matmul_shape(data_node, node)
        self.assertEqual(ret, None)
        logger.debug("End to execute ============ test_trans_batch_matmul_shape_ut ============")

    def test_trans_shape_fullycompress_ut(self):
        logger.debug("Start to execute ============ test_trans_shape_fullycompress_ut ============")
        node = {
        "name": "Conv2D/weight",
		"type": "Const",
		"id": 3,
        ...
        trans_shape_fullycompress(data_node, node)
        logger.debug("End to execute ============ test_trans_shape_fullycompress_ut ============")

    def test_get_fusion_pattern_ut(self):
        logger.debug("Start to execute ============ test_get_fusion_pattern_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        logger.debug("End to execute ============ test_get_fusion_pattern_ut ============")

    def test_get_compute_op_func_ut(self):
        logger.debug("Start to excute ============ test_get_compute_op_func_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        logger.debug("End to excute ============ test_get_compute_op_func_ut ============")
    ...
    def test_get_custom_op_operator_ut(self):
    ...
    def test_get_vendor_and_custom_path_ut(self):
    ...
    def test_get_classify_info_01__ut(self):
        logger.debug("Start to execute ============ test_get_classify_info_01__ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        logger.debug("End to execute ============ test_get_classify_info_01__ut ============")

    def test_get_classify_info_02__ut(self):
        logger.debug("Start to execute ============ test_get_classify_info_02__ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        ...
        get_classify_info(fusion_pattern, "reduce", op_list)
        logger.debug("End to execute ============ test_get_classify_info_02__ut ============")

    def test_get_fusion_build_cfg_ut(self):
        logger.debug("Start to execute ============ test_get_fusion_build_cfg_ut ============")
        ...
        logger.debug("End to execute ============ test_get_fusion_build_cfg_ut ============")

    def test_get_classify_output_attrs__ut(self):
        logger.debug("Start to execute ============ test_get_classify_output_attrs__ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        json_path = test_root_dir + "/stub/files/reduce_classify_fusion.json"
        with open(json_path, "r") as file_in:
        ...
        op_list = json_data.get("op_list")
        all_args = []
        ins_attrs_options = [None, [{'name': 'Conv2d', 'val': [1, False]}]]
        for op_node in op_list:
            if op_node["type"] == "Conv2D":
                get_output_attrs_for_all_args(all_args, op_node, True, ins_attrs_options)
                break
        res_all_args = [{'name': 'Conv2d_2', 'format': 'NCHW', 'dtype': 'float16', 'input_pattern': '', 'input_op_type': '', 'shape': [], 'origin_format': 'ND', 'origin_shape_initialized': False, 'placement': 0, 'range': [[1, -1], [1, -1]]}, 1, False]
        self.assertEqual(res_all_args, all_args)
        logger.debug("End to execute ============ test_get_classify_output_attrs__ut ============")

    def test_replace_cube_tvm_shapes_st(self):
        logger.debug("Start to execute ============ test_replace_cube_tvm_shapes_ut ============")
        test_file_dir = os.path.abspath(os.path.dirname(__file__))
        test_root_dir =  os.path.abspath(os.path.join(test_file_dir, "../.."))
        json_path = test_root_dir + "/stub/files/cube_classify_fusion.json"
        with open(json_path, "r") as file_in:
        ...
        for op in op_list:
            if op["type"] == "Conv2D":
                op["type"] = "TransData"
                inputs = op["input_desc"]

        with patch('tbe.common.utils.op_util.op_util_conv2d.is_conv2d_binary', return_value=True):
            replace_cube_tvm_shapes(inputs, vector_info, op_list, None)
            logger.debug("End to execute ============ test_replace_cube_tvm_shapes_st ============")

        with patch('tbe.common.utils.op_util.op_util_conv2d.is_conv2d_binary', return_value=False):
            replace_cube_tvm_shapes(inputs, vector_info, op_list, None)
            logger.debug("End to execute ============ test_replace_cube_tvm_shapes_st ============")

    def test_inner_replace_cube_tvm_shapes_conv2d_transdata_ut(self):
        logger.debug("Start to execute ============ test_inner_replace_cube_tvm_shapes_conv2d_transdata_ut ============")
        ...
        logger.debug("End to execute ============ test_inner_replace_cube_tvm_shapes_conv2d_transdata_ut ============")
    ...
    def test_replace_cube_tvm_shapes_cov(self):
        import tbe
        ...
        with op_context.OpContext():
            context = get_context()
            op_info = operator_info.OpInfo("Conv2D", "Conv2D")
            tbe.common.context.op_context.get_context().add_op_info(op_info)
            try:
                inputs = [{"test": 1}]
                replace_cube_tvm_shapes(list(inputs), [], [])
            except:
                pass
    ...
    def test_implmode_op_compilation_ut_01(self):
        """test op_compilation"""
    ...
    def test_implmode_op_compilation_ut_02(self):
        """test op_compilation"""
    ...
    def test_implmode_op_compilation_ut_04(self):
        """test op_compilation"""
