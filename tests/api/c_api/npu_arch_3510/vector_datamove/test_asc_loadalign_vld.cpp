...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void c_api_name##_##dst_type##_##dst_type##_##src_type##_Stub(vector_fp4x2_e1m2_t &dst,                    \
    __ubuf__ float4_e1m2x2_t *src, iter_reg offset, Literal load_dist) {}                              \
}                                                                                               \
                                                                                                \
TEST_F(TestVectorDatamove##class_name##dst_type##dst_type##src_type##CApi, c_api_name##_##dst_type##_##src_type##_Succ)   \
{                                                                                               \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void c_api_name##_##dst_type##_##dst_type##_##src_type##_Stub(vector_fp4x2_e1m2_t &dst0, vector_fp4x2_e1m2_t &dst1,   \
    __ubuf__ float4_e1m2x2_t *src, iter_reg offset, Literal load_dist) {}                                   \
}                                                                                               \
                                                                                                \
TEST_F(TestVectorDatamove##class_name##dst_type##dst_type##src_type##CApi, c_api_name##_##dst_type##_##src_type##_Succ)   \
{                                                                                               \
    ...
    iter_reg offset;                                                                             \
                                                                                                \
    MOCKER_CPP(cce_name, void(vector_fp4x2_e1m2_t &, vector_fp4x2_e1m2_t &, __ubuf__ float4_e1m2x2_t *, iter_reg, Literal))       \
        .times(1)                                                                               \
        .will(invoke(c_api_name##_##dst_type##_##dst_type##_##src_type##_Stub));                \
                                                                                                \
    c_api_name(dst0, dst1, src, offset);                                                        \
...
TEST_VECTOR_DATAMOVE_LOADALIGN_INSTR_INT4(LoadAlignVldDownSample, asc_loadalign_downsample, vld, vector_int4x2_t, int4b_t);
...
TEST_VECTOR_DATAMOVE_LOADALIGN_DEINTLV_INSTR_INT4(LoadAlignVldDintlv, asc_loadalign_deintlv, vld, vector_int4x2_t, int4b_t);
