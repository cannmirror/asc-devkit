...
TEST_VECTOR_DATAMOVE_LOADALIGN_INSTR_INT4(LoadAlignDownsample, asc_loadalign_downsample, vlds, vector_int4x2_t, int4b_t);
...
TEST_VECTOR_DATAMOVE_LOADALIGN_DEINTLV_INSTR_INT4(LoadAlignDeintlv, asc_loadalign_deintlv, vlds, vector_int4x2_t, int4b_t);