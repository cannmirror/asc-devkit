...
{                                                                                               \
    ...
    uint16_t channel_size = static_cast<uint16_t>(15);                                          \
                                                                                                    \
    asc_copy_l12l0b(dst, src, k_extension, m_extension, k_start_pt, m_start_pt, stride_w, stride_h, filter_w, filter_h, \
...
{                                                                                               \
    ...
    uint16_t channel_size = static_cast<uint16_t>(15);                                          \
                                                                                                    \
    asc_copy_l12l0b_sync(dst, src, k_extension, m_extension, k_start_pt, m_start_pt, stride_w, stride_h, filter_w, filter_h, \
                        dilation_filter_w, dilation_filter_h, filter_size_w, filter_size_h, transpose, fmatrix_ctrl, channel_size);                                          \
    GlobalMockObject::verify();                                                                 \
}    
