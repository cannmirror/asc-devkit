...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, uint32_t offset, vector_##data_type src1,  \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, uint32_t offset, vector_uint8_t src1,  \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, uint32_t offset, vector_fp4x2_e1m2_t src1,  \
    __ubuf__ float4_e1m2x2_t *&dst, Literal dist) {}                                                  \
}                                                                                               \
                                                                                                \
TEST_F(TestVectorDataMove##class_name##_##data_type##_CApi, c_api_name##_##data_type##_Succ)    \
{                                                                                               \
    ...
    uint32_t count;                                                                             \
                                                                                                \
    MOCKER_CPP(cce_name, void(vector_store_unalign&, uint32_t, vector_fp4x2_e1m2_t, __ubuf__ float4_e1m2x2_t *&, Literal)) \
        .times(1)                                                                               \
        .will(invoke(cce_name##_##data_type##_Stub));                                           \
                                                                                                \
    c_api_name(dst, src0, src1, count);                                                         \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, iter_reg& offset, vector_##data_type src1, \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, iter_reg& offset, vector_uint8_t src1, \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, iter_reg& offset, vector_fp4x2_e1m2_t src1, \
    __ubuf__ float4_e1m2x2_t *dst, int dist) {}                                                       \
}                                                                                               \
                                                                                                \
TEST_F(TestVectorDataMove##class_name##_##data_type##_CApi, c_api_name##_##data_type##_Succ)    \
{                                                                                               \
    ...
    iter_reg count;                                                                             \
                                                                                                \
    MOCKER_CPP(cce_name, void(vector_store_unalign&, iter_reg&, vector_fp4x2_e1m2_t, __ubuf__ float4_e1m2x2_t *, int))   \
        .times(1)                                                                               \
        .will(invoke(cce_name##_##data_type##_Stub));                                           \
                                                                                                \
    c_api_name(dst, src0, src1, count);                                                         \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub0(vector_store_unalign& src0, uint32_t offset, vector_##data_type src1,          \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub0(vector_store_unalign& src0, uint32_t offset, vector_uint8_t src1,          \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub0(vector_store_unalign& src0, uint32_t offset, vector_fp4x2_e1m2_t src1,          \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, vector_##data_type src1, \
    __ubuf__ data_type *dst, Literal dist) {}                                                       \
}                                                                                               \
                                                                                                \
TEST_F(TestVectorDataMove##class_name##_##data_type##_CApi, c_api_name##_##data_type##_Succ)    \
...
protected:                                                                                      \
    ...
    void TearDown() {}                                                                          \
                                                                                                ...
                                                                                                \
namespace {                                                                                     \
void cce_name##_##data_type##_Stub(vector_store_unalign& src0, vector_fp4x2_e1m2_t src1, \
    __ubuf__ float4_e1m2x2_t *dst, Literal dist) {}                                                       \
}                                                                                               \
                                                                                                \
TEST_F(TestVectorDataMove##class_name##_##data_type##_CApi, c_api_name##_##data_type##_Succ)    \
