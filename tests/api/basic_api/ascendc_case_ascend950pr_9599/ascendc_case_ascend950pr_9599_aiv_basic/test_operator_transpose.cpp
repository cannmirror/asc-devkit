...
INSTANTIATE_TEST_CASE_P(TEST_OPEARATION_TRANSPOSE, Transpose4dTestsuite,
    ...
    Transpose4dTestParams { 4, Transpose4D<TensorTrait<float>>, 3, 2, 4, 2, TransposeType::TRANSPOSE_NHWC2NCHW, 32, false, 55}, // 不满足N*c*h*w 预期要48个元素
    Transpose4dTestParams { 4, Transpose4D<TensorTrait<float>>, 3, 2, 4, 2, TransposeType::TRANSPOSE_NHWC2NCHW, 48, true },
    Transpose4dTestParams { 1, Transpose4D<TensorTrait<int8_t>>, 8, 4, 8, 4, TransposeType::TRANSPOSE_NCHW2NHWC, 960, false, 6}, // 预期要1024个元素
