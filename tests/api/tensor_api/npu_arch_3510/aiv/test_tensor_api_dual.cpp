...
__aicore__ inline void TestTransformDual(__gm__ T* z0, __gm__ T* z1, __gm__ T* x, __gm__ T* y,
    __ubuf__ T z0UB[2048], __ubuf__ T z1UB[2048], __ubuf__ T xUB[2048], __ubuf__ T yUB[2048])
{
    ...
    asc_copy_ub2gm_align(z0Gm.Data().Get(), z0Local.Data().Get(), BLK_NUM, burstLength, cacheMode, srcStride, dstStride);
    asc_copy_ub2gm_align(z1Gm.Data().Get(), z1Local.Data().Get(), BLK_NUM, burstLength, cacheMode, srcStride, dstStride);
}
