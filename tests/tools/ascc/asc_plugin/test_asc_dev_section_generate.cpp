...
extern "C" __global__ __aicore__ void __device_stub__add_mangling_int_float(int i, __attribute__((annotate("kfc_workspace"))) uint8_t* workspace)
{
    GM_ADDR ascendc_workspace_param = workspace;
    AscendC::SetSysWorkspaceForce(ascendc_workspace_param);
    GM_ADDR ascendc_workspace_usr = AscendC::GetUserWorkspace(ascendc_workspace_param);
    ...
    info.kernelParameters = {
        {"int", "i", false, "", ""},
        {"uint8_t*", "workspace", false, "", "__attribute__((\"cce_kfc_workspace\"))"}
    };
...
TEST_F(TEST_ASC_DEV_SECTION_GENERATE, asc_dev_stub_workspace_arg)
{
    ...
    info.kernelParameters = {
        {"uint8_t*", "workspace", false, "", "__attribute__((\"cce_kfc_workspace\"))"},
        {"uint8_t*", "workspace_bak", false, "", "__attribute__((\"cce_kfc_workspace\"))"}
    };
    AscPlugin::AscDevStubGenerator devStubGen = AscPlugin::AscDevStubGenerator(
...
TEST_DEV_META_GEN(
    ...
    "static const struct BinaryMetaAscFeature __ascendc_feature_ffts__0 __attribute__ ((used, section (\".ascend."
    "meta\"))) = {4, 4, 2};\n",
...
TEST_DEV_META_GEN(
    ...
    "static const struct BinaryMetaAscFeature __ascendc_feature_ffts__1 __attribute__ ((used, section (\".ascend."
    "meta\"))) = {4, 4, 2};\n",
...
TEST_DEV_META_GEN(
    ...
    "static const struct BinaryMetaAscFeature __ascendc_feature_ffts__2 __attribute__ ((used, section (\".ascend."
    "meta\"))) = {4, 4, 2};\n",
...
TEST_DEV_META_GEN(
    ...
    "static const struct BinaryMetaAscFeature __ascendc_feature_ffts__3 __attribute__ ((used, section (\".ascend."
    "meta\"))) = {4, 4, 2};\n",
